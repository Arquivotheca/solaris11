...
#ifndef _SYS_USB_USBSER_EDGE_16654_H
#define	_SYS_USB_USBSER_EDGE_16654_H


/*
 * definitions for 16C654 UART used on EdgePorts
 *
 ...
 *
 * Numbers 0-7 are passed to the Edgeport directly. Numbers 8 and above
 * indicate that we must enable access to them via LCR most-significant bit.
...
typedef uint8_t regs_16654_t[NUM_16654_REGS];
...
#define	LCR_PAR_EN		0x08	/* Enable parity */
#define	LCR_PAR_EVEN		0x10	/* Even parity */
...
#define	MCR_LOOPBACK		0x10	/* Set internal loopback mode */
#define	MCR_XON_ANY		0x20	/* Enable any char to exit XOFF mode */
#define	MCR_IR_ENABLE		0x40	/* Enable IrDA functions */
#define	MCR_BRG_DIV_4		0x80	/* Divide baud rate clk by /4 */
...
#define	LSR_FIFO_ERR		0x80	/* Rx Fifo contains erred chars */
...
#define	EFR_SWFC_MASK		0x0F	/* Software flow control field mask */
#define	EFR_ENABLE_16654	0x10	/* Enable 16C654 features */
#define	EFR_SPEC_DETECT		0x20	/* Enable special char detect intr */
...
#endif	/* _SYS_USB_USBSER_EDGE_16654_H */
