...
typedef NcsiControlPktHeader_t* pNcsiControlPktHeader_t;

#define NCSI_DEFS_SIZE_OF_NCSI_FRAME_HEADER  (sizeof (NcsiControlPktHeader_t))
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DELL_OEM_VERSION_NUM            1

typedef struct DellDfltCmd
{
#if defined (BIG_ENDIAN)
    u32_t                            ManufacturerId;         // IANA    
            #define NCSI_DELL_IANA                                      (674)
    u8_t     PayloadVersion;
    u8_t     CommandType;
            // Dell specified OEM command ID
    u16_t   Pad;
    ...
    u8_t     CommandType;
            ...
            #define DELL_OEM_SET_ADDRESS_CMD                                                 0x07
            #define DELL_OEM_GET_ADDRESS_CMD                                                 0x08
...
typedef struct DellDfltCmdRspData
{
    ...
    u32_t                            ManufacturerId;         // IANA    
            #define NCSI_BROADCOM_IANA                                  (4413)
            #define NCSI_DELL_IANA                                      (674)
    u8_t     PayloadVersion;
    u8_t     CommandType;
            // Dell specified OEM command ID
...
typedef DellGetVirtualLinkCmd_t DellGetLanStatisticsCmd_t;
...
typedef struct DellGetLanStatisticsCmdRspData
{
    ...
    u8_t  CountersClearedFromLastRead;                            // Counters Cleared from Last Read
        ...
        #define    FCS_ERRORS_CLEARED                         0x04 //     2   FCS Receive Errors  0b =    Not Cleared 1b = Cleared
                                                                  //     7:3 Reserved    
    u32_t TotalUnicastPktsRcvd;                                   // Total Unicast Packets Received
    u32_t TotalUnicastPktsXmit;                                   // Total Unicast Packets Transmitted
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef DellGetVirtualLinkCmd_t DellGetFcoeStatisticsCmd_t;
...
typedef struct DellGetFcoeStatisticsCmdRspData
{
    ...
    u8_t  CountersClearedFromLastRead;                            // Counters Cleared from Last Read
        ...
        #define    FIP_LOGIN_FAILURE_CNT_CLEARED             0x10 // 4  FIP Login Failure Count 0b =    Not Cleared 1b = Cleared
                                                                  // 7:5    Reserved    
    u32_t TotalFcoePktsRcvd;                                      // Total FCoE Packets Received
    u32_t TotalFcoePktsXmit;                                      // Total FCoE Packets Transmitted
    u32_t FCS_Errors;                                             // FCS Receive Errors
...
typedef struct DellSetAddrCmd
{
    ...
    u8_t     AddrType;
        ...
        #define          MAC_ADDR_TYPE_FCOE_PORT_WWN              0x6 
        #define          MAC_ADDR_TYPE_FCOE_NODE_WWN              0x7 
        #define          MAC_ADDR_TYPE_MAX                        0x8
...
typedef struct DellSetAddrCmdRspData
{
#if defined (BIG_ENDIAN)
    u16_t                            ResponseCode;          /* ids outcome of cmd   */
    u16_t                            ReasonCode;            /* ids reasons for rsp  */                                           
...
typedef struct DellSetPassthruCtrlCmdRspData
{
#if defined (BIG_ENDIAN)
    u16_t                            ResponseCode;          /* ids outcome of cmd   */
    u16_t                            ReasonCode;            /* ids reasons for rsp  */                                           
    ...
    u8_t     PayloadVersion;
#endif // endian                                                                                                                
} DellSetPassthruCtrlCmdRspData_t;
...
typedef DellSetAddrCmdRspData_t DellSetPartitionTxBandwidthCmdRspData_t;

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  0x0E    Get Partition TX Bandwidth  Used to read bandwidth of a partition enabled on a specific channel.    0x0E    (Conditional)
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef DellGetVirtualLinkCmd_t DellGetPartitionTxBandwidthCmd_t;
...
typedef DellSetPassthruCtrlCmdRspData_t DellSetMcIpAddrCmdRspData_t;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef DellGetVirtualLinkCmd_t DellGetTeamingInfoCmd_t;
...
typedef DellSetPassthruCtrlCmdRspData_t DellEnablePortsCmdRspData_t;
...
typedef DellSetPassthruCtrlCmdRspData_t DellDisablePortsCmdRspData_t;
...
typedef DellSetPassthruCtrlCmdRspData_t DellSetLinkTuningCmdRspData_t;
...
typedef DellSetPassthruCtrlCmdRspData_t DellEnableDisableOutOfBoxWolCmdRspData_t;
...
{
    NcsiControlPktHeader_t   Header;
    NcsiCmdPayload_t         Payload;
    
} NcsiCmdPkt_t;

typedef NcsiCmdPkt_t * pNcsiCmdPkt_t;            

#define UC_MAX_CMD_FRAME_SIZE sizeof(NcsiCmdPkt_t) 
...
typedef NcsiCmdRspPkt_t * pNcsiCmdRspPkt_t;
