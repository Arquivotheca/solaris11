...
/*
 *
 * Copyright(c) 2001-2011 Broadcom Corporation, all rights reserved
 ...
 *
 * Generated On Date:  11/09/2010 12:41
 *
 */
...
typedef struct mcp_fio
{
    ...
    u32_t mcpf_mcpq_bits_status3;
        #define MCPF_MCPQ_BITS_STATUS3_MAC4                 (1L<<0)
        #define MCPF_MCPQ_BITS_STATUS3_MAC5                 (1L<<1)
        #define MCPF_MCPQ_BITS_STATUS3_ETYPE0               (1L<<2)
        #define MCPF_MCPQ_BITS_STATUS3_ETYPE1               (1L<<3)
        #define MCPF_MCPQ_BITS_STATUS3_ARP                  (1L<<4)
        #define MCPF_MCPQ_BITS_STATUS3_ICMPV4               (1L<<5)
        #define MCPF_MCPQ_BITS_STATUS3_ICMPV6               (1L<<6)
        #define MCPF_MCPQ_BITS_STATUS3_LLDP                 (1L<<7)
        #define MCPF_MCPQ_BITS_STATUS3_PF_OVLAN             (1L<<8)
        #define MCPF_MCPQ_BITS_STATUS3_RULE_MATCH_GRPC      (1L<<29)
        #define MCPF_MCPQ_BITS_STATUS3_RULE_MATCH_GRPB      (1L<<30)
        #define MCPF_MCPQ_BITS_STATUS3_RULE_MATCH_GRPA      (1L<<31)
    ...
    u32_t mcpf_hmcpq_bits_status3;
        #define MCPF_HMCPQ_BITS_STATUS3_MAC4                (1L<<0)
        #define MCPF_HMCPQ_BITS_STATUS3_MAC5                (1L<<1)
        #define MCPF_HMCPQ_BITS_STATUS3_ETYPE0              (1L<<2)
        #define MCPF_HMCPQ_BITS_STATUS3_ETYPE1              (1L<<3)
        #define MCPF_HMCPQ_BITS_STATUS3_ARP                 (1L<<4)
        #define MCPF_HMCPQ_BITS_STATUS3_ICMPV4              (1L<<5)
        #define MCPF_HMCPQ_BITS_STATUS3_ICMPV6              (1L<<6)
        #define MCPF_HMCPQ_BITS_STATUS3_LLDP                (1L<<7)
        #define MCPF_HMCPQ_BITS_STATUS3_PF_OVLAN            (1L<<8)
        #define MCPF_HMCPQ_BITS_STATUS3_RULE_MATCH_GRPC     (1L<<29)
        #define MCPF_HMCPQ_BITS_STATUS3_RULE_MATCH_GRPB     (1L<<30)
        #define MCPF_HMCPQ_BITS_STATUS3_RULE_MATCH_GRPA     (1L<<31)
    ...
    u32_t mcpf_nvm_cfg4;
        ...
        #define MCPF_NVM_CFG4_RESERVED                      (0x3fffffL<<10)
