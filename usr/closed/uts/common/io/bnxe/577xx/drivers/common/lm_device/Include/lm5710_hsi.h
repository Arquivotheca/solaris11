...
#if 0
#define DYNAMIC_HC_TOE_INDEX                0
#define DYNAMIC_HC_ETH_INDEX                1
#define DYNAMIC_HC_ISCSI_INDEX              2
#define DYNAMIC_HC_FCOE_INDEX               3
#endif
...
#define HC_INDEX_ISCSI_OOO_CONS		      4
#define HC_INDEX_ETH_TX_CQ_CONS		      5
