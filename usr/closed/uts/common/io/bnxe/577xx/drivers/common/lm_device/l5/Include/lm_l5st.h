...
/* size of physical memory needed iscsi connection, for query and update sp calls */
#define SC_SP_PHYS_DATA_SIZE        ((sizeof(lm_iscsi_slow_path_phys_data_t) + CACHE_LINE_SIZE_MASK) & ~CACHE_LINE_SIZE_MASK)

/* size of physical memory needed fcoe connection, for sp calls */
#define FC_SP_PHYS_DATA_SIZE        ((sizeof(lm_fcoe_slow_path_phys_data_t) + CACHE_LINE_SIZE_MASK) & ~CACHE_LINE_SIZE_MASK)
