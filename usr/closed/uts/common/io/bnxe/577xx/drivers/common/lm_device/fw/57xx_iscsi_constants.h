...
/* current iSCSI HSI version number (8 bit) */
#define ISCSI_HSI_VERSION (2)
...
/*Sqn_to_notify special values */
#define ISCSI_SQN_TO_NOTIFY_NOT_VALID							(0xFFFF)
#define ISCSI_SQN_TO_NOTIFY_EVENT_COALESCING_DISABLED			(0x0)
...
#define ISCSI_KWQE_OPCODE_OFFLOAD_CONN3 (6)
...
#define ISCSI_KCQE_OPCODE_FW_CLEAN_TASK (0x15) // for internal FW processing
...
#define ISCSI_KCQE_OPCODE_DESTROY_CTX 	(0x22)
...
#define ISCSI_KCQE_COMPLETION_STATUS_WRONG_HSI_VERSION                  (0x8)
...
#define ISCI_KCQE_COMPLETION_STATUS_TCP_ERROR_MAX_OPTIONS_LENGTH        (0x44)
