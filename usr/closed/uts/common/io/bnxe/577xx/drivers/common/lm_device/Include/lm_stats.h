...
void        lm_stats_get_l2_chip_stats  ( IN struct _lm_device_t* pdev, OUT b10_l2_chip_statistics_t *stats ) ;
...
typedef struct _lm_stats_hw_collect_t
{
    ...
    void*                                  dmae_sgl_context_emac ;
    void*                                  dmae_sgl_context_non_emac ;
