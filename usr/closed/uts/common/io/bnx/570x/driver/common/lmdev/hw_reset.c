    ...
    lm_device_t *pdev)
{
    ...
    REG_WR(pdev, context.ctx_command, 0x43001);
    ...
    lm_reason_t reason)
{
    ...
    fw_reset_sync(pdev, reason, DRV_MSG_DATA_WAIT0, FW_ACK_TIME_OUT_MS*1000);
    ...
    fw_reset_sync(pdev, reason, DRV_MSG_DATA_WAIT1, FW_ACK_TIME_OUT_MS*1000);
...
#if 0   /* this workaround cause IBM minnow to reboot randomly */ 
    ...
    lm_set_mac_addr(pdev, 0x0, pdev->params.mac_addr);
