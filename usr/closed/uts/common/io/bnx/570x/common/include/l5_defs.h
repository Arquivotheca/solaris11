 ...
 * Name:        l5_defs.h
 *
 * Description: Header file containing definitions specific to the L5
 *              data path firmware.
 *
 * Author:      Mike Penna
 *
 ...
 *
 * $Log: l5_defs.h,v $
 * Revision 1.6  2007/07/15 15:03:24  edreayc
 * No CRC calculation will be done in SW in case header is splitted over multiple TCP segments
 *
 * Revision 1.5  2007/05/24 12:49:34  edreayc
 * Update Xinan code
 *
 * Revision 1.4  2007/05/17 13:00:19  erang
 * first compiling cp version
 *
 * Revision 1.3  2007/05/16 09:37:28  erang
 * initial txp compiling version
 *
 * Revision 1.2  2007/05/14 16:16:40  erang
 * initial merge iscsi teton -> xinan
 *
 * Revision 1.1  2007/05/10 08:54:42  vitalyo
 * Adding files
 *
 * 
 * 1     7/07/06 10:36a Mpenna
 * moved from $/Source/bcm5709/firmware
 * 
 * 2     5/23/06 2:42p Mpenna
 * Initial "compile only" port of Teton firmware baseline to
 * Xinan.
 * 
 * 5     8/29/05 4:13p Mpenna
 * added new error code for DDP "no untagged msg buff posted"
 * condition.
 * 
 * 4     10/13/04 2:47p Mpenna
 * Support for WSD Phase 3.0
 * 
 * 3     6/03/04 11:42a Mpenna
 * changes to support window deallocate while bound and COM
 * failure work-around
 * 
 * 2     1/29/04 2:40p Mpenna
 * L5 data path integration
 * 
 * 1     9/18/03 9:51a Mpenna
 * Converted "txp_l5.h" to global header file for use in TxP and
 * RxP
 * 
 ****************************************************************************/
