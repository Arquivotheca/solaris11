 ...
 *	This file contains definitions and declaration for certain BMIC
 *	and SCSI commands.
 */

#ifndef	CPQARY3_SCSI_H
#define	CPQARY3_SCSI_H
...
#define	CPQARY3_EINTR			2
#define	CPQARY3_RESET 			4
#define	CPQARY3_SYNC_SUBMITTED		8
#define	CPQARY3_NOECMD_SUBMITTED	8
#define	CPQARY3_SYNC_TIMEOUT		16
#define	CPQARY3_QUIESCECMD		32
...
typedef struct Identify_Ld_Status {
	...
	uint8_t 	cache_failure;	/* volume failed for cache fail */
	...
	uint8_t		big_drive_rebuild; /* Drive Rebuilding - Drive number */
	uint8_t		reserved[36];
} SenseLdStatus;
/* FORMAT */
