          ...
          switch (token)
            ...
            case SSH_PSYSTEM_READ_USE_RECOGNIZE:
              ...
              if ((*env->handler)(SSH_PSYSTEM_OBJECT,
                                  ...
                                  list_level,
                                  /* in = temp, out = boolean */
                                  env_tmp_context, (void **)&object_taken)
                  == FALSE)
                {
...
{
  SshPSystemStatus status;
  SshPSystemNode cur_node = ssh_psystem_alloc_node(parent, st->token_line,
                                                   st->token_col);
  ...
  switch (st->token)
    ...
    case SSH_PSYSTEM_TOK_OTHER:
      ...
      return ssh_psystem_read_token(st);
                            ...
                            SshPSystemNode* root)
{
  ...
  SshPSystemStatus status;
  SshPSystemParseState parse_state;
