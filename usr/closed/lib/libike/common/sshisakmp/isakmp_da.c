...
/*
 *        Program: sshisakmp
 *        $Source: /project/cvs/src/ipsec/lib/sshisakmp/isakmp_da.c,v $
 *        $Author: irwin $
 *
 *        Creation          : 14:48 Jul 30 1997 kivinen
 *        Last Modification : 17:23 Feb 26 2002 kivinen
 ...
 *        
 *
 *        Description       : Isakmp data attribute module
 *
 *
 *        $Log: isakmp_da.c,v $ *        
 *        
  ...
  else
    {
      ...
      *type_return = type;
      ...
      SSH_DEBUG(10, ("decode_int V: "
                     ...
                     "len = %d (0x%04x)",
                     type, type, *value_return, *value_return,
                     len, len));
    }
  return TRUE;
}
                                       ...
                                       SshUInt32 flags)
{
  ...
  SSH_DEBUG(10, ("get_int: "
                 "type = %d (0x%04x), value = %d (0x%08x), len = %d (0x%04x)",
  ...
  if (attribute->attribute_length == 0)
  ...
  else
    {
      ...
      SSH_DEBUG(10, ("encode V: "
                     "type = %d (0x%04x), len = %d (0x%04x), value = %08x ...",
                    type, type, attribute->attribute_length,
