...
/*
 *        Program: sshisakmp
 *        $Source: /project/cvs/src/ipsec/lib/sshisakmp/isakmp_linearize.c,v $
 *        $Author: irwin $
 *
 *        Creation          : 02:17 Mar  4 2002 kivinen
 *        Last Modification : 09:35 Jan 15 2003 kivinen
 ...
 *        
 *
 *        Description       : Isakmp library linearize (import / export) code.
 *
 *
 *        $Log: isakmp_linearize.c,v $ *        
 *        
 *        
 *        
 *        
...
size_t ssh_ike_sa_export_id(SshBuffer buffer, SshIkePayloadID id)
{
  ...
  item_len = ssh_encode_buffer
    (buffer,
     SSH_FORMAT_UINT32, (SshUInt32) id->id_type,
     SSH_FORMAT_UINT32, (SshUInt32) id->protocol_id,
     SSH_FORMAT_UINT32, (SshUInt32) id->port_number,
     SSH_FORMAT_UINT32, (SshUInt32) id->port_range_end,
     SSH_FORMAT_END);
  if (item_len == 0)
    goto error;
  len += item_len;
  switch (id->id_type)
    ...
    case IPSEC_ID_IPV4_ADDR:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_DATA, id->identification.ipv4_addr, 4,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_FQDN:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, id->identification.fqdn,
    ...
    case IPSEC_ID_USER_FQDN:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, id->identification.user_fqdn,
         id->identification_len,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_IPV4_ADDR_SUBNET:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_DATA, id->identification.ipv4_addr_subnet, 4,
         SSH_FORMAT_DATA, id->identification.ipv4_addr_netmask, 4,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_IPV6_ADDR:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_DATA, id->identification.ipv6_addr, 16,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_IPV6_ADDR_SUBNET:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_DATA, id->identification.ipv6_addr_subnet, 16,
         SSH_FORMAT_DATA, id->identification.ipv6_addr_netmask, 16,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_IPV4_ADDR_RANGE:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_DATA, id->identification.ipv4_addr_range1, 4,
         SSH_FORMAT_DATA, id->identification.ipv4_addr_range2, 4,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_IPV6_ADDR_RANGE:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_DATA, id->identification.ipv6_addr_range1, 16,
         SSH_FORMAT_DATA, id->identification.ipv6_addr_range2, 16,
         SSH_FORMAT_END);
      break;
    ...
    case IPSEC_ID_DER_ASN1_GN:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, id->identification.asn1_data,
         id->identification_len,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_KEY_ID:
      item_len = ssh_encode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, id->identification.key_id,
         id->identification_len,
         SSH_FORMAT_END);
      break;
...
size_t ssh_ike_sa_export(SshBuffer buffer, SshIkeNegotiation negotiation)
{
  ...
  item_len = ssh_encode_buffer
    (buffer,
     /* Magic number */
     SSH_FORMAT_UINT32, (SshUInt32) SSH_IKE_EXPORT_MAGIC1,
     /* Version number */
     SSH_FORMAT_UINT32, (SshUInt32) SSH_IKE_EXPORT_VERSION,
     /* Cookies, initiator, responder */
     SSH_FORMAT_DATA, sa->cookies.initiator_cookie, SSH_IKE_COOKIE_LENGTH,
     SSH_FORMAT_DATA, sa->cookies.responder_cookie, SSH_IKE_COOKIE_LENGTH,
     /* Local ip, port. */
     SSH_FORMAT_UINT32_STR,
       pm_info->local_ip, strlen(ssh_csstr(pm_info->local_ip)),
     SSH_FORMAT_UINT32_STR,
       pm_info->local_port, strlen(ssh_csstr(pm_info->local_port)),
     /* Remote ip, port. */
     SSH_FORMAT_UINT32_STR,
       pm_info->remote_ip, strlen(ssh_csstr(pm_info->remote_ip)),
     SSH_FORMAT_UINT32_STR,
       pm_info->remote_port, strlen(ssh_csstr(pm_info->remote_port)),
     /* IKE exchange version. */
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->major_version,
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->minor_version,
     /* IKE exchange type. */
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->exchange_type,
     /* Was this the initiator for the original exchange? */
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->this_end_is_initiator,
     /* Byte count and byte limit. */
     SSH_FORMAT_UINT64, (SshUInt64) sa->byte_count,
     SSH_FORMAT_UINT64, (SshUInt64) sa->kbyte_limit,
     /* Created time and laste use time */
     SSH_FORMAT_UINT64, (SshUInt64) sa->created_time,
     SSH_FORMAT_UINT64, (SshUInt64) sa->last_use_time,
     /* Encryption, hash, prf algorithm names. */
     SSH_FORMAT_UINT32_STR, sa->encryption_algorithm_name,
     strlen(ssh_csstr(sa->encryption_algorithm_name)),
     SSH_FORMAT_UINT32_STR, sa->hash_algorithm_name,
     strlen(ssh_csstr(sa->hash_algorithm_name)),
     SSH_FORMAT_UINT32_STR, sa->prf_algorithm_name,
     strlen(ssh_csstr(sa->prf_algorithm_name)),
     /* Cipher key. */
     SSH_FORMAT_UINT32_STR, sa->cipher_key, sa->cipher_key_len,
     /* Cipher IV. */
     SSH_FORMAT_UINT32_STR, sa->cipher_iv, sa->cipher_iv_len,
     /* Keying material, Diffie-Hellman. */
     SSH_FORMAT_UINT32_STR, sa->skeyid.dh, sa->skeyid.dh_size,
     /* Keying material, SKEYID mac. */
     SSH_FORMAT_UINT32_STR, sa->skeyid.skeyid, sa->skeyid.skeyid_size,
     /* Keying material, SKEYID_d mac. */
     SSH_FORMAT_UINT32_STR, sa->skeyid.skeyid_d, sa->skeyid.skeyid_d_size,
     /* Keying material, SKEYID_a mac. */
     SSH_FORMAT_UINT32_STR, sa->skeyid.skeyid_a, sa->skeyid.skeyid_a_size,
     /* Keying material, SKEYID_e mac. */
     SSH_FORMAT_UINT32_STR, sa->skeyid.skeyid_e, sa->skeyid.skeyid_e_size,
     /* Retry defaults. */
     SSH_FORMAT_UINT32, sa->retry_limit,
     SSH_FORMAT_UINT32, sa->retry_timer,
     SSH_FORMAT_UINT32, sa->retry_timer_usec,
     SSH_FORMAT_UINT32, sa->retry_timer_max,
     SSH_FORMAT_UINT32, sa->retry_timer_max_usec,
     SSH_FORMAT_UINT32, sa->expire_timer,
     SSH_FORMAT_UINT32, sa->expire_timer_usec,
     /* Statistics. */
     SSH_FORMAT_UINT32, sa->statistics.packets_in,
     SSH_FORMAT_UINT32, sa->statistics.packets_out,
     SSH_FORMAT_UINT32, sa->statistics.octects_in,
     SSH_FORMAT_UINT32, sa->statistics.octects_out,
     SSH_FORMAT_UINT32, sa->statistics.created_suites,
     SSH_FORMAT_UINT32, sa->statistics.deleted_suites,
     /* IKE SA negotiation information. */
     SSH_FORMAT_UINT32, (SshUInt32) ike_negotiation->exchange_type,
     ...
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->auth_method_type,
     /* XXX Number of private groups, fixed to 0, this is left here for
        expansion, so later we do not need to change the format of the
        payload. */
     SSH_FORMAT_UINT32, (SshUInt32) 0,
     /* Private groups as UINT32_STRING. XXX, now this is empty. */
     SSH_FORMAT_UINT32_STR, "", 0,
     SSH_FORMAT_END);
  if (item_len == 0)
    goto error;
  len += item_len;
  ...
  item_len = ssh_encode_buffer
    (buffer,
     /* Authentication type. */
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->auth_method_type,
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->auth_method,
     /* Start and expire times. */
     SSH_FORMAT_UINT64, (SshUInt64) pm_info->sa_start_time,
     SSH_FORMAT_UINT64, (SshUInt64) pm_info->sa_expire_time,
     ...
     SSH_FORMAT_UINT32, (SshUInt32) pm_info->doi,
     /* Magic number */
     SSH_FORMAT_UINT32, (SshUInt32) SSH_IKE_EXPORT_MAGIC2,
     SSH_FORMAT_END);
  if (item_len == 0)
    goto error;
  len += item_len;
                             ...
                             char **id_txt)
{
  ...
  if (ssh_decode_buffer
      (buffer,
       SSH_FORMAT_UINT32, &a32,
       SSH_FORMAT_UINT32, &b32,
       SSH_FORMAT_UINT32, &c32,
       SSH_FORMAT_END) == 0)
    goto error;
  ...
  switch (newp->id_type)
    ...
    case IPSEC_ID_IPV4_ADDR:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_DATA, newp->identification.ipv4_addr, 4,
         SSH_FORMAT_END);
    ...
    case IPSEC_ID_FQDN:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, &newp->identification.fqdn,
    ...
    case IPSEC_ID_USER_FQDN:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, &newp->identification.user_fqdn,
         &newp->identification_len,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_IPV4_ADDR_SUBNET:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_DATA, newp->identification.ipv4_addr_subnet, 4,
         SSH_FORMAT_DATA, newp->identification.ipv4_addr_netmask, 4,
         SSH_FORMAT_END);
    ...
    case IPSEC_ID_IPV6_ADDR:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_DATA, newp->identification.ipv6_addr, 16,
         SSH_FORMAT_END);
    ...
    case IPSEC_ID_IPV6_ADDR_SUBNET:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_DATA, newp->identification.ipv6_addr_subnet, 16,
         SSH_FORMAT_DATA, newp->identification.ipv6_addr_netmask, 16,
         SSH_FORMAT_END);
    ...
    case IPSEC_ID_IPV4_ADDR_RANGE:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_DATA, newp->identification.ipv4_addr_range1, 4,
         SSH_FORMAT_DATA, newp->identification.ipv4_addr_range2, 4,
         SSH_FORMAT_END);
      newp->identification_len = 8;
      break;
    case IPSEC_ID_IPV6_ADDR_RANGE:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_DATA, newp->identification.ipv6_addr_range1, 16,
         SSH_FORMAT_DATA, newp->identification.ipv6_addr_range2, 16,
         SSH_FORMAT_END);
      newp->identification_len = 32;
      break;
    case IPSEC_ID_DER_ASN1_DN:
    case IPSEC_ID_DER_ASN1_GN:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, &newp->identification.asn1_data,
         &newp->identification_len,
         SSH_FORMAT_END);
      break;
    case IPSEC_ID_KEY_ID:
      ret = ssh_decode_buffer
        (buffer,
         SSH_FORMAT_UINT32_STR, &newp->identification.key_id,
         &newp->identification_len,
         SSH_FORMAT_END);
      break;
#ifdef SSHDIST_IKE_ID_LIST
    case IPSEC_ID_LIST:
      {
        ...
        ret = ssh_decode_buffer
          (buffer,
           SSH_FORMAT_UINT32, &newp->identification.id_list_number_of_items,
           SSH_FORMAT_END);
        if (ret == 0)
          goto error;
                                    ...
                                    SshIkeServerContext server)
{
  ...
  len = ssh_decode_buffer
    (buffer,
     ...
     SSH_FORMAT_UINT32, &b32,
     /* Cookies, initiator, responder */
     SSH_FORMAT_DATA, initiator_cookie, SSH_IKE_COOKIE_LENGTH,
     SSH_FORMAT_DATA, responder_cookie, SSH_IKE_COOKIE_LENGTH,
     SSH_FORMAT_END);
  if (len == 0)
    {
  ...
  if (a32 != SSH_IKE_EXPORT_MAGIC1)
    {
      SSH_DEBUG(3, ("Invalid magic 0x%08x vs 0x%08x", a32,
                    SSH_IKE_EXPORT_MAGIC1));
      goto error;
    }
  if (b32 != SSH_IKE_EXPORT_VERSION)
    {
      SSH_DEBUG(3, ("Invalid version 0x%08x vs 0x%08x", b32,
  ...
  len = ssh_decode_buffer
    (buffer,
     /* Local ip, port. */
     SSH_FORMAT_UINT32_STR, &auc, NULL,
     SSH_FORMAT_UINT32_STR, &buc, NULL,
     /* Remote ip, port. */
     SSH_FORMAT_UINT32_STR, &cuc, NULL,
     SSH_FORMAT_UINT32_STR, &duc, NULL,
     /* IKE exchange version. */
     SSH_FORMAT_UINT32, &a32,
     SSH_FORMAT_UINT32, &b32,
     /* IKE exchange type. */
  ...
  if (!ike_init_isakmp_sa(sa,
    ...
    NULL,
#endif /* SUNWIPSEC */
    auc, buc, cuc, duc, a32, b32, c32, d32, FALSE))
    {
  ...
  len = ssh_decode_buffer
    (buffer,
     /* Byte count and byte limit. */
     SSH_FORMAT_UINT64, &a64,
     SSH_FORMAT_UINT64, &b64,
     /* Created time and laste use time */
     SSH_FORMAT_UINT64, &c64,
     SSH_FORMAT_UINT64, &d64,
     /* Encryption, hash, prf algorithm names. */
     SSH_FORMAT_UINT32_STR, &auc, NULL,
     SSH_FORMAT_UINT32_STR, &buc, NULL,
     SSH_FORMAT_UINT32_STR, &cuc, NULL,
  ...
  if (l == -1)
    {
      if (strcmp(ssh_csstr(auc), "cast128-12-cbc") == 0)
  ...
  if (c32 != 0)
    {
      ssh_warning("Remote end sent packet including private groups. "
                  "This end does not support transfering of them. "
  ...
  if (d32 != SSH_IKE_EXPORT_MAGIC2)
    {
      SSH_DEBUG(3, ("Invalid magic2 0x%08x vs 0x%08x", d32,
...
/* XXX Need to separate cookies from host */
/* XXX We do not yet support private groups (ngm) in the export. */
