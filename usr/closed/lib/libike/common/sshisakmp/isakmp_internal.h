...
/*
 *        Program: sshisakmp
 *        $Source: /project/cvs/src/ipsec/lib/sshisakmp/isakmp_internal.h,v $
 *        $Author: irwin $
 *
 *        Creation          : 14:48 Jul 30 1997 kivinen
 *        Last Modification : 13:52 Oct 31 2002 kivinen
 ...
 *        
 *
 *        Description       : Isakmp library internal prototypes and variables.
 *
 *        $Log: isakmp_internal.h,v $ *        
 *        
 *        
 *        
 *        
...
#ifdef SUNWIPSEC
  SshIkePayload first_natd_payload;
  SshIkePayload first_natoa_payload;
#endif	
...
struct SshIkeContextRec {
...
#ifdef SUNWIPSEC
  unsigned char *default_natt_port;
#endif	
  ...
  SshExternalKey external_key;          /* External key handle, or NULL if not
                                           available. */
  const unsigned char *accelerator_short_name; /* Short name of the hardware
...
extern SshIkeGroupMap *ssh_ike_groups;
extern int ssh_ike_groups_count;
...
#ifdef SUNWIPSEC
	/* maybe not the right place, but the easiest */
  Boolean use_natt_port;
  void *packet_context;
#endif
};
...
#define SSH_IKE_ISAKMP_LOCK_FLAG_KEEP_THIS              0x0004
  ...
  Boolean phase_1_done;         /* Phase 1 done */
  Boolean wired;
...
#define NATT_STATE_NEVER -1
#define NATT_STATE_INIT 0
#define NATT_STATE_VID 1
#define NATT_STATE_NATD 2
#define NATT_STATE_PORT 3
#define NATT_STATE_GOT_PORT 4

  int sa_natt_state;
  char *sa_other_port;
  unsigned int natt_init_ip;
  unsigned int natt_resp_ip;
  SshUdpListener listener_natt;
#endif	
...
struct SshIkeServerContextRec {
  ...
  SshUdpListener listener;
  SshIkeGlobalStatisticsStruct statistics;
#ifdef SUNWIPSEC
  char *server_natt_port;
  SshUdpListener listener_natt;
#endif	
};
...
#define SSH_IKE_GET24(b) \
     ((((SshUInt32) *((SshUInt8 *) (b) + 0)) << 16) | \
      (((SshUInt32) *((SshUInt8 *) (b) + 1)) << 8) | \
      ((SshUInt32) *((SshUInt8 *)(b) + 2)))
...
#ifdef DEBUG_LIGHT
extern int ssh_ike_logging_level;
...
#define ssh_policy_get_certificate_authories(pm_info,cb,cb_ctx) \
