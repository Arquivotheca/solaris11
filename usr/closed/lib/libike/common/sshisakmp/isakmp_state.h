...
/*
 *        Program: sshisakmp
 *        $Source: /project/cvs/src/ipsec/lib/sshisakmp/isakmp_state.h,v $
 *        $Author: irwin $
 *
 *        Creation          : 14:48 Jul 30 1997 kivinen
 *        Last Modification : 16:09 Feb 18 2002 kivinen
 ...
 *        
 *
 *        Description       : Isakmp state machine function prototypes
 *
 *
 *        $Log: isakmp_state.h,v $ *        
 *        
 *        
 *        
 *        
...
#ifdef SUNWIPSEC
  SSH_IKE_FIELDS_NATD			= 0x0701,
  SSH_IKE_FIELDS_NATOA			= 0x0702,
#endif
