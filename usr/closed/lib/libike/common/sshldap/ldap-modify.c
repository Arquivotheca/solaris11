                       ...
                       void *callback_context)
{
  ...
  SSH_DEBUG(SSH_D_HIGHSTART,
            ("modify(0x%x) base=%s", client, object_name));
                    ...
                    void *callback_context)
{
  ...
  SSH_DEBUG(SSH_D_HIGHSTART,
            ("add(0x%x) object=%s", client, object->object_name));
                       ...
                       void *callback_context)
{
  ...
  SSH_DEBUG(SSH_D_HIGHSTART,
            ("delete(0x%x) object=%s", client, object_name));
                           ...
                           void *callback_context)
{
  ...
  SSH_DEBUG(SSH_D_HIGHSTART,
            ("modify/rdn(0x%x) object=%s new=%s",
                        ...
                        void *callback_context)
{
  ...
  SSH_DEBUG(SSH_D_HIGHSTART,
            ("compare(0x%x) object=%s", client, object_name));
