/*
  ...
  Created Wed Nov 27 10:00:53 2002.
                       ...
                       void *context)
{
  ...
  return (int)(timeout1->identifier - timeout2->identifier);
}
                  ...
                  void *context)
{
  ...
  return (int) ((unsigned long) timeout1->context -
                (unsigned long) timeout2->context);
}
  ...
  if (tp->tv_sec < toc->reference_time.tv_sec)
    {
      ...
      SSH_DEBUG(SSH_D_NICETOKNOW,
                ("Time moved backwards. "
                 "Adjusting timeouts by %d seconds.",
                 diff));
