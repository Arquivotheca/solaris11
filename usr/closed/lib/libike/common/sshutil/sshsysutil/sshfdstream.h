/*
  ...
  Author: Tatu Ylonen <ylo@ssh.fi>
          Jussi Kukkonen <kukkonen@ssh.fi>
...
typedef unsigned int (*SshLowLevelIo)(SshHandle handle,
                                      unsigned char *addr,
                                      size_t len,
...
typedef void (*SshCancelIo)(SshHandle handle);
...
SshStream ssh_stream_fd_wrap_with_callbacks(SshHandle read_handle,
                                            SshHandle write_handle,
                                            Boolean close_on_destroy,
