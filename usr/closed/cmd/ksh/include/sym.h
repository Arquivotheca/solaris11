...
#define IN_CASE		0x0001
#define CAN_ALIAS	0x0002
#define IN_TEST		0x0004
#define TEST_OP1	0x0008
#define TEST_OP2	0x0010
#define	IN_MPAREN	0x0020
/* #define	KEYFLG		0x0100 */
