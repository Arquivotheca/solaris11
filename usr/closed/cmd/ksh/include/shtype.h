...
#ifndef		___KSH_SHTYPE_H
#define		___KSH_SHTYPE_H
#include	"sh_config.h"
...
/*
 * macro name conflicts with system's ctype macro
 * has prefix "sh_".
 */

/* these args are not call by value !!!! */
#define	sh_isblank(c)	(_ctype1[c]&(T_SPC))
#define	sh_isspace(c)	(_ctype1[c]&(T_SPC|T_EOR))
...
#define	sh_isprint(c)	(((c)&0340) && ((c)!=0177))
#define	sh_isdigit(c)	(_ctype2[c]&(T_DIG))
...
#define	sh_isalpha(c)	(_ctype2[c]&(T_UPC|T_LPC|T_ALP))
#define	isidtop(c)	sh_isalpha(c)
#define sh_isalnum(c)	(_ctype2[c]&(_IDCH))
#define	isident(c)	sh_isalnum(c)
#define sh_isupper(c)	(_ctype2[c]&(T_UPC))
#define sh_islower(c)	(_ctype2[c]&(T_LPC))

#define astchar(c)	((c)=='*'||(c)=='@')
#define toupper(c)	((c) + 'A' - 'a')
#define tolower(c)	((c) + 'a' - 'A')

#endif		/* !___KSH_SHTYPE_H */
