...
typedef struct {
	...
	boolean_t pd_size;		/* can we us K/M/G.. for size units? */
...
const char **zfs_prop_get_quota_prefixes(void);
...
void zprop_register_size(int, const char *, uint64_t, zprop_attr_t, int,
    const char *, const char *);
...
void zprop_register_hidden(int, const char *, zprop_type_t, zprop_attr_t,
    int, const char *);
void zprop_register_hidden_index(int, const char *, zprop_attr_t, int,
...
boolean_t zprop_is_size(int, zfs_type_t);
const char *zprop_to_name(int, zfs_type_t);
zprop_type_t zprop_get_type(int, zfs_type_t);
int zprop_get_numprops(zfs_type_t);
