...
#
# 2. Renamed sha1_block_data_order to sha1_block_data_order_amd64.
#
# 3. Added Solaris ENTRY_NP/SET_SIZE macros from
...
#
# void sha1_block_data_order_amd64(SHA1_CTX *ctx, const void *inpp,
#	size_t blocks);
#
...
/* ARGSUSED */
void
sha1_block_data_order_amd64(SHA1_CTX *ctx, const void *inpp, size_t blocks)
{
}
...
&PROLOGUE("sha1_block_data_order_amd64");
$code.=".align	4\n.Lloop:\n";
...
$code.=<<___;
	...
	jnz	.Lloop
___
&EPILOGUE("sha1_block_data_order_amd64");
$code.=<<___;
