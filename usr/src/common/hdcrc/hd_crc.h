...
#define	INTEL_CRC_ALIGN_MASK 0x7
#define	INTEL_CRC_SIZE 8
#define	INTEL_CRC_DATA_TYPE uint64_t
#define	INTEL_CRC_FUNC mm_crc32_u64
...
#define	INTEL_CRC_ALIGN_MASK 0x3
#define	INTEL_CRC_SIZE 4
#define	INTEL_CRC_DATA_TYPE uint32_t
#define	INTEL_CRC_FUNC mm_crc32_u32

#endif /* defined(__amd64) || defined(__x86_64) */
...
extern uint32_t intel_crc32_pcl64(uint8_t *buf, unsigned long len,
    uint32_t crc_init);
...
#define	PARA_CRC32(buffer, length, crc) (intel_crc32_pcl64((buffer), (length), \
	(crc)))
#define	PARA_CRC32_CONT(buffer, length, crc) \
	(intel_crc32_pcl64((buffer), (length), (crc) ^ 0xFFFFFFFF))
...
#if defined(_KERNEL)
/* ARGSUSED */
hd_crc32_avail(uint32_t *crc32_table)
#else
/* ARGSUSED */
hd_crc32_avail(uint32_t *crc32_table)
#endif /* _KERNEL */
{
	int i;
	/* poly = 0x1EDC6F41 */
	static const uint32_t _intel_crc32_hd_table[256] = {
...
#endif /* defined(__i386) || defined(__amd_64) || defined(__x86_64) */
