 ...
 * not use autoconf.h which is really here just to define HAVE_STDLIB_H
 */
/* #include "autoconf.h" */
/* #ifdef HAVE_STDLIB_H */
#ifndef _KERNEL
...
/*
 * Solaris Kerberos: XXX really this header should be reorganized so krb
 * specific headers aren't included.
 */
#include "k5-thread.h"

#include "gssapi_generic.h"
#include <gssapi/gssapi_ext.h> /* Solaris Kerberos */
...
#if 0 /* Solaris Kerberos: on Solaris g_OID_equal is in gssapi_ext.h */
