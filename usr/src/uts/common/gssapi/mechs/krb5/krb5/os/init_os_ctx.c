...
#include "k5-int.h"
/*
 * Solaris Kerberos: kernel support which is scattered throughout including
 * lint directives
 */
#ifndef _KERNEL
#include "os-proto.h"
#if 0 /* Solaris Kerberos gross */
...
os_init_paths(krb5_context ctx, krb5_boolean kdc)
{
    ...
    /*
     * Solaris Kerberos: deleting this to allow more specific errors
     */
