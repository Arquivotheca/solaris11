...
/* Solaris Kerberos: XXX find new home for this func */
    ...
    OM_uint32           *max_input_size;
{
    ...
    /*
     * Solaris Kerberos check to make sure we aren't writing to a NULL pointer
     */
    if (!max_input_size)
    ...
    if ((qop_req & GSS_KRB5_CONF_C_QOP_MASK) != GSS_C_QOP_DEFAULT) {
        *minor_status = (OM_uint32) G_UNKNOWN_QOP;
        /*
         * Solaris Kerberos: RFC 2743 is clear here but this is still
