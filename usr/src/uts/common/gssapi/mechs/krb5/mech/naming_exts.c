...
/*
 * Solaris Kerberos: support for kernel throughout.  Note kernel doesn't
 * support the krb5_authdata_context.
 */
             ...
             krb5_gss_name_t *ret_name)
{
    ...
    *ret_name = NULL;
    ...
    (void) memset(name, 0, sizeof(krb5_gss_name_rec));
