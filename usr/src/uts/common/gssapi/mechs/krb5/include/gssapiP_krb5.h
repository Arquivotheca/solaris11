...
/* Solaris Kerberos adding krb5_context */
krb5_error_code
...
/* Solaris Kerberos: allowing this to be called directly */
OM_uint32
...
/* Solaris Kerberos keeping these interfaces around */
#ifndef	_KERNEL
...
(OM_uint32 *,           /* minor_status */
 gss_buffer_t,               /* interprocess_token */
 gss_ctx_id_t *              /* context_handle */
 /* Solaris Kerberos: Note no _KERNEL context verifier */
);
#endif /* LEAN_CLIENT */
...
/* Solaris Kerberos: Solaris specific interfaces start */
OM_uint32 krb5_pname_to_uid(OM_uint32 *,      /* minor status */
                            const gss_name_t, /* pname */
                            uid_t *);         /* uidOUt */

OM_uint32 krb5_gss_userok(OM_uint32 *,      /* minor status */
                          const gss_name_t, /* remote user principal name */
                          const char *,     /* local unix user name */
                          int *);       /* remote user ok to login w/out pw? */
/* Solaris Kerberos: Solaris specific interfaces end */
