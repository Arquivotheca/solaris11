...
/* Solaris Kerberos */
#define KRB5_CONF_IPROP_ENABLE                "sunw_dbprop_enable"
#define KRB5_CONF_IPROP_MASTER_ULOGSIZE       "sunw_dbprop_master_ulogsize"
#define KRB5_CONF_IPROP_PORT                  "iprop_port"
#define KRB5_CONF_IPROP_SLAVE_POLL            "sunw_dbprop_slave_poll"
...
/* Solaris Kerberos */
#define KRB5_CONF_LDAP_ROOT_CERTIFICATE_FILE  "ldap_cert_path"
...
krb5_error_code krb5_sendto_kdc (krb5_context, const krb5_data *,
                                 const krb5_kdc_req *, const krb5_data *,
                                 krb5_data *, int *, int, char **);
...
krb5_error_code krb5_klog_list_logs (const char *);
...
#if 0 /* Solaris Kerberos - 183resync */
...
/* Solaris Kerberos */
#ifdef _KERNEL
# define zap(ptr, len) bzero(ptr, len)
#else
...
#define krb_ctx_hSession(ctx) \
    ((ctx) != NULL ? \
    ((ctx)->pid == __krb5_current_pid) ? (ctx)->hSession : \
    krb5_reinit_ef_handle((ctx)) : NULL)
...
/* Solaris Kerberos */
krb5_error_code krb5_copy_tickets(krb5_context, krb5_ticket * const *,
                                     krb5_ticket ***);

/* Solaris Kerberos */
krb5_error_code krb5_copy_pa_data(krb5_context, const krb5_pa_data *,
                                     krb5_pa_data **);

/* Solaris Kerberos */
krb5_error_code krb5_copy_pa_datas(krb5_context, krb5_pa_data * const *,
                                     krb5_pa_data ***);

/* Solaris Kerberos */
krb5_error_code krb5_copy_kdc_req(krb5_context, const krb5_kdc_req *,
                                     krb5_kdc_req **);
...
/* Solaris Kerberos */
void cleanup_dk_list(krb5_context, krb5_keyblock *);
...
void krb5_free_pa_data_no_ctx(krb5_pa_data **);
...
/* Solaris Kerberos */
krb5_error_code krb5_rd_req_decoded_ext(krb5_context, krb5_auth_context *,
                                        const krb5_ap_req *, const krb5_data *,
                                        krb5_const_principal, krb5_keytab,
                                        krb5_flags *, krb5_ticket **);


/* Solaris Kerberos */
krb5_error_code krb5_rd_req_decoded_anyflag_ext(krb5_context, krb5_auth_context *,
                                            const krb5_ap_req *, const krb5_data *,
                                            krb5_const_principal, krb5_keytab,
                                            krb5_flags *, krb5_ticket **);
...
/* Solaris Kerberos XXX hack to get things to compile */
#ifndef _KERNEL
void rem_default_com_err_hook(void);
void add_com_err_hook(et_old_error_hook_func);
#endif
#endif /* _KRB5_INT_H */
