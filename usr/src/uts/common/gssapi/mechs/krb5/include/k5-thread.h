...
/* Empty inline functions avoid the "statement with no effect"
   ...
   their arguments.  */
/*
 * Solaris Kerberos: added various lint directives below to keep the kernel krb
 * mech and other krb code from causing lint to complain.
 */

static inline int
/* LINTED */
k5_os_nothread_mutex_finish_init(k5_os_nothread_mutex *m) {
    return 0;
}
static inline int
/* LINTED */
k5_os_nothread_mutex_init(k5_os_nothread_mutex *m) {
    return 0;
}
static inline int
/* LINTED */
k5_os_nothread_mutex_destroy(k5_os_nothread_mutex *m) {
    return 0;
}
static inline int
/* LINTED */
k5_os_nothread_mutex_lock(k5_os_nothread_mutex *m) {
    return 0;
}
static inline int
/* LINTED */
k5_os_nothread_mutex_unlock(k5_os_nothread_mutex *m) {
    return 0;
}
...
typedef enum {
    ...
    K5_KEY_GSS_SPNEGO_ERROR_MESSAGE, /* Solaris Kerberos */
