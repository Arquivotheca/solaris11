...
#define	_GSSAPIP_GENERIC_H_ /* XXX avoid including gssapiP_generic.h */
#include <mglueP.h>
#include "gssd_prot.h"
#include <rpc/rpc.h>
...
static OM_uint32 kgss_sign_wrapped(OM_uint32 *, gss_ctx_id_t, int,
	gss_buffer_t, gss_buffer_t,  OM_uint32);

static OM_uint32 kgss_verify_wrapped(OM_uint32 *, gss_ctx_id_t,
	gss_buffer_t, gss_buffer_t, int *qop_state, OM_uint32);

/* EXPORT DELETE START */
static OM_uint32 kgss_seal_wrapped(OM_uint32 *, gss_ctx_id_t,
	int, int, gss_buffer_t, int *, gss_buffer_t,  OM_uint32);

static OM_uint32 kgss_unseal_wrapped(OM_uint32 *, gss_ctx_id_t,
	gss_buffer_t, gss_buffer_t, int *conf_state, int *qop_state,
	OM_uint32);
/* EXPORT DELETE END */

static OM_uint32 kgss_delete_sec_context_wrapped(OM_uint32 *,
...
/*ARGSUSED*/
static OM_uint32
kgss_delete_sec_context_wrapped(OM_uint32 *minor_status,
			gssd_ctx_id_t *context_handle,
			gss_buffer_t output_token,
			OM_uint32 gssd_context_verifier)
...
OM_uint32
kgss_delete_sec_context(OM_uint32 *minor_status,
		gss_ctx_id_t *context_handle,
		gss_buffer_t output_token)
{
	OM_uint32 err;
...
/*ARGSUSED*/
static OM_uint32
kgss_sign_wrapped(OM_uint32 *minor_status,
...
/*ARGSUSED*/
static OM_uint32
kgss_verify_wrapped(OM_uint32 *minor_status,
	const gss_ctx_id_t ctx_handle,
	const gss_buffer_t message_buffer,
...
/*ARGSUSED*/
static OM_uint32
kgss_seal_wrapped(OM_uint32 *minor_status,
	const gss_ctx_id_t ctx_handle,
	int conf_req_flag,
	int qop_req,
...
/*ARGSUSED*/
static OM_uint32
kgss_unseal_wrapped(OM_uint32 *minor_status,
	const gss_ctx_id_t ctx_handle,
	const gss_buffer_t input_message_buffer,
	gss_buffer_t output_message_buffer,
	int *conf_state,
