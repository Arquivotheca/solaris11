...
/*
 * The following flags are included for compatibility with other versions of
 ...
 */
#define	IO_SHARED		0x00010000	/* for compatibility only */
#define	IO_FIRST_SHARED		0x00020000	/* for compatibility only */
#define	IO_FORCE_ALIAS_ACCESS	0x00040000	/* for compatibility only */
 ...
 */
#define	WIN_PAGED		0x00010000	/* for compatibility only */
#define	WIN_SHARED		0x00020000	/* for compatibility only */
#define	WIN_FIRST_SHARED	0x00040000	/* for compatibility only */
#define	WIN_BINDING_SPECIFIC	0x00080000	/* for compatibility only */
...
/*
 * The following two are for backwards-compatibility with the PCMCIA spec.
