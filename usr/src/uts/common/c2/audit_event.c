...
aui_null,	AUE_WRITE,	aus_null,	/* 4 write */
		auf_write,	0,
aui_null,	AUE_NULL,	aus_null,	/* 5 (loadable) was open */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 8 (loadable) was creat */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 9 (loadable) was link */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 10 (loadable) was unlink */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 13 time */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 14 (loadable) was mknod */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 15 (loadable) was chmod */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 16 (loadable) was chown */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 17 brk */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 18 (loadable) was stat */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 27 alarm */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 28 (loadable) was fstat */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 32 gtty */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 33 (loadable) was access */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 58 fsync */
		auf_null,	0,
aui_null,	AUE_EXECVE,	aus_null,	/* 59 exece */
		auf_null,	S2E_MLD,
...
aui_null,	AUE_RENAME,	aus_null,	/* 64 renameat */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 65 (loadable) unused */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 75 sidsys */
		auf_null,	0,
aui_unlinkat,	AUE_NULL,	aus_null,	/* 76 unlinkat */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 77 syslwp_park */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 78 sendfilev */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 79 (loadable) was rmdir */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 80 (loadable) was mkdir */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 87 (loadable) was poll */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 88 (loadable) was lstat */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 89 (loadable) was symlink */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 90 (loadable) was readlink */
		auf_null,	0,
aui_null,	AUE_SETGROUPS,	aus_setgroups,	/* 91 setgroups */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 92 getgroups */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 93 (loadable) was fchmod */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 94 (loadable) was fchown */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 109 (loadable) */
		auf_null,	0,
#endif /* __x86 */
aui_null,	AUE_UTIMES,	aus_null,	/* 110 utimensat */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 129 getrlimit */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 130 (loadable) was lchown */
		auf_null,	0,
aui_null,	AUE_MEMCNTL,	aus_memcntl,	/* 131 memcntl */
		auf_null,	0,
aui_null,	AUE_GETPMSG,	aus_getpmsg,	/* 132 getpmsg */
		auf_null,	0,
aui_null,	AUE_PUTPMSG,	aus_putpmsg,	/* 133 putpmsg */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 134 (loadable) was rename */
		auf_null,	0,
...
aui_null,	AUE_P_ONLINE,	aus_p_online,	/* 189 p_online */
		auf_null,	0,
aui_null,	AUE_SIGQUEUE,	aus_sigqueue,	/* 190 sigqueue */
		auf_null,	0,
...
aui_null,	AUE_MMAP,	aus_mmap,	/* 214 mmap64 */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 215 (loadable) was stat64 */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 216 (loadable) was lstat64 */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 217 (loadable) was fstat64 */
		auf_null,	0,
...
aui_null,	AUE_NULL,	aus_null,	/* 224 (loadable) was creat64 */
		auf_null,	0,
aui_null,	AUE_NULL,	aus_null,	/* 225 (loadable) was open64 */
		auf_null,	0,
...
aus_fchownat(struct t_audit_data *tad)
{
	...
	if (fd == AT_FDCWD || uap->fname != NULL)	/* same as chown() */
		return;
...
aui_openat(au_event_t e)
{
	 ...
	 *
	 * openat(), openat64() do two pathname lookups when called with O_CREAT
	 * and without O_EXCL flag. One to see if the file exists, the second
	 * one when creating the file.
	 */
	if (((fm & (O_CREAT|O_EXCL)) != (O_CREAT|O_EXCL)) ||
	    (fm & FXATTRDIROPEN)) {
...
aus_kill(struct t_audit_data *tad)
{
	...
	if (pid > 0) {
		...
		if ((p = prfind(pid)) == NULL || p->p_stat == SIDL) {
			mutex_exit(&pidlock);
			au_uwrite(au_to_arg32(1, "pid", (uint32_t)pid));
			return;
		}
...
static void
audit_auditinfo_addr(uintptr_t datap, model_t model, char argno)
{
	STRUCT_DECL(auditinfo_addr, ainfo_addr);

	/* copy data from the user space */
	STRUCT_INIT(ainfo_addr, model);
	if (copyin((caddr_t)datap, STRUCT_BUF(ainfo_addr),
	    STRUCT_SIZE(ainfo_addr))) {
		return;
	}

	/* fill the audit record with copied data */
	au_uwrite(au_to_arg32(argno, "auid",
	    (uint32_t)STRUCT_FGET(ainfo_addr, ai_auid)));
#ifdef _LP64
	au_uwrite(au_to_arg64(argno, "port",
	    (uint64_t)STRUCT_FGET(ainfo_addr, ai_termid.at_port)));
#else
	au_uwrite(au_to_arg32(argno, "port",
	    (uint32_t)STRUCT_FGET(ainfo_addr, ai_termid.at_port)));
#endif
	au_uwrite(au_to_arg32(argno, "type",
	    (uint32_t)STRUCT_FGET(ainfo_addr, ai_termid.at_type)));

	if ((uint32_t)STRUCT_FGET(ainfo_addr, ai_termid.at_type) == AU_IPv4) {
		au_uwrite(au_to_in_addr(
		    (struct in_addr *)STRUCT_FGETP(ainfo_addr,
		    ai_termid.at_addr)));
	} else {
		au_uwrite(au_to_in_addr_ex((int32_t *)STRUCT_FGETP(ainfo_addr,
		    ai_termid.at_addr)));
	}
	au_uwrite(au_to_arg64(argno, "as_success",
	    (uint64_t)STRUCT_FGET(ainfo_addr, ai_mask.as_success)));
	au_uwrite(au_to_arg64(argno, "as_failure",
	    (uint64_t)STRUCT_FGET(ainfo_addr, ai_mask.as_failure)));
	au_uwrite(au_to_arg32(argno, "asid",
...
aus_auditsys(struct t_audit_data *tad)
{
	...
	case AUE_SETAUID:
		if (copyin((caddr_t)a1, &auid, sizeof (au_id_t)))
			return;
		au_uwrite(au_to_arg32(2, "auid", auid));
		break;
	case AUE_SETAUDIT:
		STRUCT_INIT(ainfo, model);
		if (copyin((caddr_t)a1, STRUCT_BUF(ainfo),
		    STRUCT_SIZE(ainfo))) {
			return;
		}
		au_uwrite(au_to_arg32(1, "auid",
		    (uint32_t)STRUCT_FGET(ainfo, ai_auid)));
#ifdef _LP64
		au_uwrite(au_to_arg64(1, "port",
		    (uint64_t)STRUCT_FGET(ainfo, ai_termid.port)));
#else
		au_uwrite(au_to_arg32(1, "port",
		    (uint32_t)STRUCT_FGET(ainfo, ai_termid.port)));
#endif
		au_uwrite(au_to_arg32(1, "machine",
		    (uint32_t)STRUCT_FGET(ainfo, ai_termid.machine)));
		au_uwrite(au_to_arg64(1, "as_success",
		    (uint64_t)STRUCT_FGET(ainfo, ai_mask.as_success)));
		au_uwrite(au_to_arg64(1, "as_failure",
		    (uint64_t)STRUCT_FGET(ainfo, ai_mask.as_failure)));
		au_uwrite(au_to_arg32(1, "asid",
		    (uint32_t)STRUCT_FGET(ainfo, ai_asid)));
		break;
	case AUE_SETAUDIT_ADDR:
		audit_auditinfo_addr(a1, model, 1);
		break;
	case AUE_AUDITON_SETKAUDIT:
		audit_auditinfo_addr(a2, model, 3);
		break;
	case AUE_AUDITON_SETAMASK:
		if (copyin((caddr_t)a2, &mask, sizeof (au_mask_t)))
			return;
		au_uwrite(au_to_arg64(2, "as_success", mask.as_success));
		au_uwrite(au_to_arg64(2, "as_failure", mask.as_failure));
		break;
	...
	case AUE_AUDITON_SQCTRL: {
		...
		if (model == DATAMODEL_ILP32) {
			au_uwrite(au_to_arg32(3, "aq_hiwater",
			    (uint32_t)STRUCT_FGET(qctrl, aq_hiwater)));
			au_uwrite(au_to_arg32(3, "aq_lowater",
			    (uint32_t)STRUCT_FGET(qctrl, aq_lowater)));
			au_uwrite(au_to_arg32(3, "aq_bufsz",
			    (uint32_t)STRUCT_FGET(qctrl, aq_bufsz)));
			au_uwrite(au_to_arg32(3, "aq_delay",
			    (uint32_t)STRUCT_FGET(qctrl, aq_delay)));
		} else {
			au_uwrite(au_to_arg64(3, "aq_hiwater",
			    (uint64_t)STRUCT_FGET(qctrl, aq_hiwater)));
			au_uwrite(au_to_arg64(3, "aq_lowater",
			    (uint64_t)STRUCT_FGET(qctrl, aq_lowater)));
			au_uwrite(au_to_arg64(3, "aq_bufsz",
			    (uint64_t)STRUCT_FGET(qctrl, aq_bufsz)));
			au_uwrite(au_to_arg64(3, "aq_delay",
	...
	case AUE_AUDITON_SETUMASK:
		...
		au_uwrite(au_to_arg32(3, "auid",
		    (uint32_t)STRUCT_FGET(ainfo, ai_auid)));
		au_uwrite(au_to_arg64(3, "as_success",
		    (uint64_t)STRUCT_FGET(ainfo, ai_mask.as_success)));
		au_uwrite(au_to_arg64(3, "as_failure",
		    (uint64_t)STRUCT_FGET(ainfo, ai_mask.as_failure)));
		break;
	...
	case AUE_AUDITON_SETPMASK:
		...
		/* audit termid and audit masks */
		au_uwrite(au_to_arg64(3, "as_success",
		    (uint64_t)STRUCT_FGET(apinfo, ap_mask.as_success)));
		au_uwrite(au_to_arg64(3, "as_failure",
		    (uint64_t)STRUCT_FGET(apinfo, ap_mask.as_failure)));

		/* audit process id */
		pid = (pid_t)STRUCT_FGET(apinfo, ap_pid);
		mutex_enter(&pidlock);
		if ((p = prfind(pid)) == NULL) {
			mutex_exit(&pidlock);
			au_uwrite(au_to_arg32(3, "pid", (uint32_t)pid));
			return;
		}
		...
		if ((ai = crgetauinfo(cr)) == NULL) {
			au_uwrite(au_to_arg32(3, "pid", (uint32_t)pid));
			crfree(cr);
			return;
		}
		au_uwrite(au_to_process(crgetuid(cr), crgetgid(cr),
		    crgetruid(cr), crgetrgid(cr), pid, ai->ai_auid,
		    ai->ai_asid, &ai->ai_termid));
		crfree(cr);
		break;
	...
	case AUE_AUDITON_SETCLASS:
		if (copyin((caddr_t)a2, &event, sizeof (au_evclass_map_t)))
			return;
		au_uwrite(au_to_arg32(2, "ec_event",
		    (uint32_t)event.ec_number));
		au_uwrite(au_to_arg64(3, "ec_class",
		    (uint64_t)event.ec_class));
		break;
	case AUE_GETAUID:
	case AUE_GETAUDIT:
	...
	case AUE_AUDITON_GETPINFO_ADDR:
