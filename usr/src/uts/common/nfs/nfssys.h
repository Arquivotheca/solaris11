...
enum nfssys_op	{ OLD_NFS_SVC, OLD_ASYNC_DAEMON, EXPORTFS, OLD_NFS_GETFH,
    ...
    NFSCMD_ARGS, NFS4_MIG_FREEZE, NFS4_MIG_GRACE, NFS4_MIG_THAW,
    NFS4_MIG_HARVEST, NFS4_MIG_HYDRATE, NFS4_MIG_CONVERT, NFS4_MIG_UNCONVERT,
    NFS4_MIG_STATUS, NFS_NODEID };

#define	NFS4_MIG_FIRST	NFS4_MIG_FREEZE
#define	NFS4_MIG_LAST	NFS4_MIG_STATUS
...
#define	EXPORTFS_DEPENDENT	1
#define	EXPORTFS_INDEPENDENT	2

struct exp_share {
	char	*name;		/* share name */
	size_t	name_len;
	char	*opt_str;	/* share option string */
	size_t	opt_len;
	char	*shr_buf;	/* ptr to packed nvlist */
	size_t	shr_len;	/* size of packed buffer */
};
...
struct exportfs_args {
	...
	struct exp_share	*shareinfo;
	int			*ea_statusp;
	struct exportfs_args	*next_eargs;
};
...
struct exportfs_args32 {
	...
	caddr32_t	uex;
	caddr32_t	shareinfo;
	caddr32_t	ea_statusp;
	caddr32_t	next_eargs;
};
#endif
...
/*
 * Arguments for the various NFS4_MIG commands, one of the arguments is the
 * pathname for the root of the file system being migrated.
 */
struct nfs4mig_args {
	void		*root_name;
	uint32_t	*migerr;
...
#ifdef _SYSCALL32
struct nfs4mig_args32 {
	caddr32_t	root_name;
	caddr32_t	migerr;
	caddr32_t	mig_fsstat;
};
#endif
...
/* Error codes returned from the migration related system calls */
enum migerr {
	MIG_OK = 0,
	MIGERR_FSNOENT,
	MIGERR_FSINVAL,
...
typedef enum migerr migerr_t;

/* The state of the file system during the migration event */
#define	FS_FROZEN	0x00000001
#define	FS_CONVERTED	0x00000002
...
extern int	exportfs(struct exportfs_args *, model_t, cred_t *,
    sharefs_op_t);
extern int	nfs_export(sharefs_op_t, void *, size_t);
...
extern migerr_t	(*nfs4_mig_tab[]) (vnode_t *, void *);
extern migerr_t	rfs4_migop_freeze(vnode_t *, void *);
extern migerr_t	rfs4_migop_grace(vnode_t *, void *);
extern migerr_t	rfs4_migop_thaw(vnode_t *, void *);
extern migerr_t	rfs4_migop_harvest(vnode_t *, void *);
extern migerr_t	rfs4_migop_hydrate(vnode_t *, void *);
extern migerr_t	rfs4_migop_convert(vnode_t *, void *);
extern migerr_t	rfs4_migop_reset(vnode_t *, void *);
extern migerr_t	rfs4_migop_unconvert(vnode_t *, void *);
extern migerr_t	rfs4_migop_status(vnode_t *, void *);
