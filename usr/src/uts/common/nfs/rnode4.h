...
extern void	recov_rnode4(struct vfs *);
...
extern int	nfs4_get_stateid(cred_t *, rnode4_t *, pid_t, nfs_opnum4,
			nfs4_stateid_types_t *, stateid4 *, bool_t);
...
extern void	nfs4_migrate_mi(mntinfo4_t *, nfs4_server_t *, nfs4_server_t *);
