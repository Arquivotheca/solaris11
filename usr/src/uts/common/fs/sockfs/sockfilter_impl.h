...
#define	SOFIF_BYPASS		0x01	/* filter does not want any callbacks */
#define	SOFIF_DEFER		0x02	/* defer notification of socket */
#define	SOFIF_RCV_FLOWCTRL	0x04	/* flow control recv path */
#define	SOFIF_SND_FLOWCTRL	0x08	/* flow control send path */
#define	SOFIF_CLOSE		0x10	/* requested to close socket */
...
extern void	sof_sonode_wait_async_ops(struct sonode *);
