 ...
 * It is maintained (at some expense) for compatibility.
...
dnlc_init()
{
	...
	/*
	 * Initialize the head of the cached directory structures
	 */
	...
	/*
	 * Initialize the reference count of the negative cache vnode to 1
	...
	/*
	 * Initialize kstats - both the old compatibility raw kind and
