...
uint64_t dsl_scan_errors(struct dsl_pool *dp);
uint64_t dsl_scan_maxtxg(struct dsl_pool *dp);
void dsl_scan_update_processed(struct dsl_pool *dp, uint64_t psize);
boolean_t dsl_scan_logs_only(struct dsl_pool *dp);
