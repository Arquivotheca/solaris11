...
extern int zvol_check_volblocksize(spa_t *spa, uint64_t volblocksize);
extern int zvol_get_stats(objset_t *os, nvlist_t *nv);
extern int zvol_check_cb(spa_t *spa, void *arg);
...
extern int zvol_get_volume_readonly(void *minor_hdl);
