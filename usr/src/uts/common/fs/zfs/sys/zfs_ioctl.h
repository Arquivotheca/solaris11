...
typedef struct zfs_cmd {
	...
	uint64_t	zc_cred;		/* internal to zfs(7fs) */
	uint64_t	zc_stat_buf;		/* really (zfs_stat_t *) */
	uint32_t	zc_stat_buflen;
	boolean_t	zc_needname;
} zfs_cmd_t;
...
extern int zfs_pool_status(const char *name, zfs_ioc_poolcheck_t check);
