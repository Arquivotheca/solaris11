...
typedef struct spa_space {
	uint64_t	sc_dspace;		/* deflated space */
	uint64_t	sc_adjfree;		/* adjusted free */
	uint64_t	sc_deferred;		/* deferred free */
} spa_space_t;
...
struct spa {
	...
	uint64_t	spa_condense_txg;	/* txg to condense metaslabs */
	...
	spa_space_t	spa_space;		/* space in normal class */
	kmutex_t	spa_vdev_top_lock;	/* dueling offline/remove */
	kmutex_t	spa_proc_lock;		/* protects spa_proc* */
	kcondvar_t	spa_proc_cv;		/* spa_proc_state transitions */
	int		spa_maxblksize;		/* maximum supported */
	int		spa_maxblkshift;	/* maximum supported */
