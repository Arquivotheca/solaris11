...
int zap_count_write(objset_t *os, uint64_t zapobj, const char *name,
    int add, uint64_t *towrite, uint64_t *tooverwrite, uint64_t *tounref);
...
#define	ZA_INTEGER_SIZE	(sizeof (uint64_t))
#define	ZA_STRING_SIZE	(sizeof (char))

#define	ZA_PROP_IS_INT(za) ((za).za_integer_length == ZA_INTEGER_SIZE)
#define	ZA_PROP_IS_STR(za) ((za).za_integer_length == ZA_STRING_SIZE)
