...
typedef uint64_t vdev_asize_func_t(vdev_t *vd, uint64_t psize,
    dva_layout_t layout, int copies);
typedef uint64_t vdev_layout_func_t(vdev_t *vd, uint64_t psize,
    int ndvas, int msflag, dva_t *dva);
...
struct vdev_ops {
	...
	vdev_layout_func_t		*vdev_op_layout;
...
struct vdev {
	...
	boolean_t	vdev_timing_out; /* vdev is timing out I/O	*/
 ...
 */
extern vdev_asize_func_t vdev_default_asize;
extern vdev_asize_func_t vdev_psize_to_asize;
extern vdev_layout_func_t vdev_default_layout;
extern vdev_layout_func_t vdev_layout;
