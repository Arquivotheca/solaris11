...
#define	FILE_OPFILTER				0x00100000
#define	FILE_FREE_SPACE_QUERY			0x00200000
#define	FILE_NO_RECALL				0x00400000
#define	FILE_REPARSE_POINT			0x00800000
...
/*
 * NT compatible access control masks and values.
 *
 ...
 */
#define	STANDARD_DELETE			(0x00010000L)
