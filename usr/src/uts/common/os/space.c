...
/*
 * Used by MAC layer buffer management. Enabled on sun4v platforms
 * and disabled on others. For more details, please see mac_buffermgmt.c
 */
boolean_t	mac_bm_single_block_per_ring = B_FALSE;
