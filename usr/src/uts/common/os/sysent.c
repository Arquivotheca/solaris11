...
int	close(int);
int	exece(uintptr_t, const char **, const char **, int);
...
void	rexit(int);
int	semsys(int, uintptr_t, uintptr_t, uintptr_t, uintptr_t);
int	setgid(gid_t);
int	setpgrp(int, int, int);
int	setuid(uid_t);
uintptr_t	shmsys(int, uintptr_t, uintptr_t, uintptr_t);
...
int	s10_stat(char *, struct stat *);
int	s10_fstat(int, struct stat *);
int	stime(time_t);
...
int	sharefs(sharefs_proto_t, sharefs_op_t, void *, size_t);
int	setegid(gid_t);
int	seteuid(uid_t);

int	setreuid(uid_t, uid_t);
int	setregid(gid_t, gid_t);
int	install_utrap(utrap_entry_t, utrap_handler_t, utrap_handler_t *);
#ifdef __sparc
int	sparc_utrap_install(utrap_entry_t, utrap_handler_t, utrap_handler_t,
	utrap_handler_t *, utrap_handler_t *);
#endif
...
int	timer_gettime(clockid_t, timespec_t *);
...
int	s10_stat64(char *, struct stat64 *);
int	s10_fstat64(int, struct stat64 *);
...
int64_t loadable_syscall(long, long, long, long, long, long, long, long);
#if defined(__sparc)
int64_t indir(int, long, long, long, long, long);
#else
int64_t indir();
#endif
...
long	zone(int, void *, void *, void *, void *);

int	so_socket(int, int, int, char *, int);
int	so_socketpair(int);
...
/* ONC_PLUS EXTRACT END */
	...
	/*  5 */ SYSENT_CI("s10_open",		s10_open,	3),
	...
	/* 18 */ SYSENT_CI("s10_stat", 		s10_stat, 	2),
	/* 19 */ IF_LP64(
	...
	/* 28 */ SYSENT_CI("s10_fstat", 	s10_fstat, 	2),
	...
	/* 76 */ SYSENT_CI("unlinkat",		unlinkat,	3),
...
/* ONC_PLUS EXTRACT END */
	...
	/* 109 */ IF_x86(
			...
			SYSENT_LOADABLE()),
	/* 110 */ SYSENT_CI("utimensat",	utimensat,	4),
	...
	/* 140 */ SYSENT_CI("sharefs",		sharefs,	4),
	...
	/* 215 */ IF_LP64(
			SYSENT_NOSYS(),
			SYSENT_CI("s10_stat64", s10_stat64, 	2)),
	/* 216 */ SYSENT_LOADABLE(),			/* (was lstat64) */
	/* 217 */ IF_LP64(
			SYSENT_NOSYS(),
			SYSENT_CI("s10_fstat64", s10_fstat64, 	2)),
	/* 218 */ IF_LP64(
			SYSENT_NOSYS(),
	...
	/* 225 */ IF_LP64(
			SYSENT_NOSYS(),
			SYSENT_CI("s10_open64",	s10_open64,	3)),
...
extern int s10_open32(char *, int, int);
extern int fstatat32(int, char *, struct stat32 *, int);
extern int s10_stat32(char *, struct stat32 *);
extern int s10_fstat32(int, struct stat32 *);
extern int fstatat64_32(int, char *, struct stat64_32 *, int);
extern int s10_stat64_32(char *, struct stat64_32 *);
extern int s10_fstat64_32(int, struct stat64_32 *);
...
/* ONC_PLUS EXTRACT END */
	...
	/*  5 */ SYSENT_CI("s10_open",		s10_open32,	3),
	/*  6 */ SYSENT_CI("close",		close,		1),
	/*  7 */ SYSENT_CI("linkat",		linkat,		5),
	...
	/* 17 */ SYSENT_CI("brk",		brk,		1),
	/* 18 */ SYSENT_CI("s10_stat", 		s10_stat32, 	2),
	...
	/* 27 */ SYSENT_CI("alarm",		alarm,		1),
	/* 28 */ SYSENT_CI("s10_fstat", 	s10_fstat32, 	2),
	/* 29 */ SYSENT_CI("pause",		pause,		0),
	...
	/* 88 */ SYSENT_LOADABLE32(),			/* (was lstat32) */
	/* 89 */ SYSENT_LOADABLE32(),			/* (was symlink) */
	/* 90 */ SYSENT_LOADABLE32(),			/* (was readlink32) */
	/* 91 */ SYSENT_CI("setgroups",		setgroups,	2),
	/* 92 */ SYSENT_CI("getgroups",		getgroups,	2),
...
/* ONC_PLUS EXTRACT END */
	...
	/* 215 */ SYSENT_CI("s10_stat64",	s10_stat64_32,	2),
	/* 216 */ SYSENT_LOADABLE32(),			/* (was lstat64_32) */
	/* 217 */ SYSENT_CI("s10_fstat64",	s10_fstat64_32,	2),
	...
	/* 225 */ SYSENT_CI("s10_open64",	s10_open64,	3),
