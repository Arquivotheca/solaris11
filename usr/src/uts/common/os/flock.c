...
/*
 * Interface to get lock list for a sysid-pid pair and for a specific vp.
 */
locklist_t *
flk_active_locks_for_vp_sysid_pid(const vnode_t *vp, int sysid, pid_t pid)
{
	return (get_lock_list(FLK_ACTIVE_STATE, 0, sysid, B_TRUE, pid, vp,
	    ALL_ZONES));
}
