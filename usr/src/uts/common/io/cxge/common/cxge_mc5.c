 ...
 */
static int mc5_cmd_write(p_adapter_t adapter, u32 cmd)
{
...
/* Currently unused */
void
dbgi_wr_addr3(p_adapter_t adapter, u32 v1, u32 v2, u32 v3)
{
...
static inline void dbgi_wr_data3(p_adapter_t adapter, u32 v1, u32 v2, u32 v3)
{
...
static inline void dbgi_rd_rsp3(p_adapter_t adapter, u32 *v1, u32 *v2, u32 *v3)
{
 ...
 */
static int mc5_write(p_adapter_t adapter, u32 addr_lo, u32 cmd)
{
 ...
 */
void __devinit
t3_mc5_prep(p_adapter_t adapter, struct mc5 *mc5, int mode)
{
#define	K * 1024
