...
#define	G_CONTEXT_CMD_OPCODE(x) \
	(((x) >> S_CONTEXT_CMD_OPCODE) & M_CONTEXT_CMD_OPCODE)
...
#define	G_T3A_DLLPTIMEOUTLMT(x) \
	(((x) >> S_T3A_DLLPTIMEOUTLMT) & M_T3A_DLLPTIMEOUTLMT)
...
#define	G_L1ASPMTXRXL0STIME(x) \
	(((x) >> S_L1ASPMTXRXL0STIME) & M_L1ASPMTXRXL0STIME)
...
#define	G_PCIE_BISTCYCLETHRESH(x) \
	(((x) >> S_PCIE_BISTCYCLETHRESH) & M_PCIE_BISTCYCLETHRESH)
...
#define	G_PE_REFCLK_TERMADJ(x) \
	(((x) >> S_PE_REFCLK_TERMADJ) & M_PE_REFCLK_TERMADJ)
...
#define	G_TX_RESOURCE_LIMIT_CH1_PC(x) \
	(((x) >> S_TX_RESOURCE_LIMIT_CH1_PC) & M_TX_RESOURCE_LIMIT_CH1_PC)

#define	S_TX_RESOURCE_LIMIT_CH1_NON_PC    16
#define	M_TX_RESOURCE_LIMIT_CH1_NON_PC    0xff
#define	V_TX_RESOURCE_LIMIT_CH1_NON_PC(x) \
	((x) << S_TX_RESOURCE_LIMIT_CH1_NON_PC)
#define	G_TX_RESOURCE_LIMIT_CH1_NON_PC(x) \
	(((x) >> S_TX_RESOURCE_LIMIT_CH1_NON_PC) & \
...
#define	G_TX_RESOURCE_LIMIT_CH0_PC(x) \
	(((x) >> S_TX_RESOURCE_LIMIT_CH0_PC) & M_TX_RESOURCE_LIMIT_CH0_PC)

#define	S_TX_RESOURCE_LIMIT_CH0_NON_PC    0
#define	M_TX_RESOURCE_LIMIT_CH0_NON_PC    0xff
#define	V_TX_RESOURCE_LIMIT_CH0_NON_PC(x) \
	((x) << S_TX_RESOURCE_LIMIT_CH0_NON_PC)
#define	G_TX_RESOURCE_LIMIT_CH0_NON_PC(x) \
	(((x) >> S_TX_RESOURCE_LIMIT_CH0_NON_PC) & \
...
#define	G_TX_MOD_TIMER_MODE(x) \
	(((x) >> S_TX_MOD_TIMER_MODE) & M_TX_MOD_TIMER_MODE)
...
#define	G_RX_MOD_CHANNEL_WEIGHT1(x) \
	(((x) >> S_RX_MOD_CHANNEL_WEIGHT1) & M_RX_MOD_CHANNEL_WEIGHT1)
...
#define	G_RX_MOD_CHANNEL_WEIGHT0(x) \
	(((x) >> S_RX_MOD_CHANNEL_WEIGHT0) & M_RX_MOD_CHANNEL_WEIGHT0)
...
#define	G_TX_MOD_CHANNEL_WEIGHT1(x) \
	(((x) >> S_TX_MOD_CHANNEL_WEIGHT1) & M_TX_MOD_CHANNEL_WEIGHT1)
...
#define	G_TX_MOD_CHANNEL_WEIGHT0(x) \
	(((x) >> S_TX_MOD_CHANNEL_WEIGHT0) & M_TX_MOD_CHANNEL_WEIGHT0)
...
#define	F_OCSPI0_OFIFO2X_TX_FRAMING_ERROR    \
	V_OCSPI0_OFIFO2X_TX_FRAMING_ERROR(1U)
...
#define	F_OCSPI1_OFIFO2X_TX_FRAMING_ERROR    \
	V_OCSPI1_OFIFO2X_TX_FRAMING_ERROR(1U)
...
#define	F_OESPI0_OFIFO2X_TX_FRAMING_ERROR    \
	V_OESPI0_OFIFO2X_TX_FRAMING_ERROR(1U)
...
#define	F_OESPI1_OFIFO2X_TX_FRAMING_ERROR    \
	V_OESPI1_OFIFO2X_TX_FRAMING_ERROR(1U)
...
#define	G_LIP_CMP_UNAVAILABLE(x) \
	(((x) >> S_LIP_CMP_UNAVAILABLE) & M_LIP_CMP_UNAVAILABLE)
...
#define	G_PHALIGNFIFOTHRESH(x) \
	(((x) >> S_PHALIGNFIFOTHRESH) & M_PHALIGNFIFOTHRESH)
...
#define	G_SERDESLOWSIGCHANGE(x) \
	(((x) >> S_SERDESLOWSIGCHANGE) & M_SERDESLOWSIGCHANGE)
...
#define	G_EXTBISTCHKERRCNT0(x) \
	(((x) >> S_EXTBISTCHKERRCNT0) & M_EXTBISTCHKERRCNT0)
...
#define	G_EXTBISTCHKERRCNT1(x) \
	(((x) >> S_EXTBISTCHKERRCNT1) & M_EXTBISTCHKERRCNT1)
...
#define	G_EXTBISTCHKERRCNT2(x) \
	(((x) >> S_EXTBISTCHKERRCNT2) & M_EXTBISTCHKERRCNT2)
...
#define	G_EXTBISTCHKERRCNT3(x) \
	(((x) >> S_EXTBISTCHKERRCNT3) & M_EXTBISTCHKERRCNT3)
