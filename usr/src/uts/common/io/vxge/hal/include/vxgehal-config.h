 ...
 * All right Reserved.
 *
 * FileName :   vxgehal-config.h
 *
 * Description:  HAL configuration. (Note: do not confuse HAL layer with
 *              (possibly multiple) HAL devices.)
 *               Note: Valid (min, max) range for each attribute is specified
 *              in the body of the structures.
 *
 ...
 * @ufca_intr_thres: (TODO)
 * @ufca_lo_lim: (TODO)
 * @ufca_hi_lim: (TODO)
 * @ufca_lbolt_period: (TODO)
 *
...
#define	VXGE_HAL_DEF_RING_INDICATE_MAX_PKTS			65536
	...
	int				sw_lro_sessions;
#define	VXGE_HAL_SW_LRO_MIN_SESSIONS				1
#define	VXGE_HAL_SW_LRO_MAX_SESSIONS				64
#define	VXGE_HAL_SW_LRO_DEFAULT_SESSIONS			32

	int				sw_lro_sg_size;
#define	VXGE_HAL_SW_LRO_MIN_SG_SIZE				1
#define	VXGE_HAL_SW_LRO_MAX_SG_SIZE				64
#define	VXGE_HAL_SW_LRO_DEFAULT_SG_SIZE				10

	int				sw_lro_frm_len;
#define	VXGE_HAL_SW_LRO_MIN_FRM_LEN				4096
#define	VXGE_HAL_SW_LRO_MAX_FRM_LEN				65536
#define	VXGE_HAL_SW_LRO_DEFAULT_FRM_LEN				65536
...
#define	VXGE_HAL_VPATH_USE_BOTH			VXGE_HAL_FIFO_HOST_STEER_BOTH
	...
	u32				bandwidth_limit;
#define	VXGE_HAL_VPATH_BANDWIDTH_LIMIT_MIN				0
#define	VXGE_HAL_VPATH_BANDWIDTH_LIMIT_MAX				152588
#define	VXGE_HAL_VPATH_BANDWIDTH_LIMIT_USE_FLASH_DEFAULT		\
						    VXGE_HAL_USE_FLASH_DEFAULT

	u32				no_snoop;
#define	VXGE_HAL_VPATH_NO_SNOOP_ENABLE					1
#define	VXGE_HAL_VPATH_NO_SNOOP_DISABLE					0
#define	VXGE_HAL_VPATH_NO_SNOOP_USE_FLASH_DEFAULT   VXGE_HAL_USE_FLASH_DEFAULT
 ...
 * Specify either zero or VXGE_HAL_USE_FLASH_DEFAULT to use BIOS default.
...
#define	VXGE_HAL_DEF_ISR_POLLING_CNT			1
	...
	u32				latency_timer;
#define	VXGE_HAL_USE_BIOS_DEFAULT_LATENCY	    VXGE_HAL_USE_FLASH_DEFAULT
#define	VXGE_HAL_MIN_LATENCY_TIMER			8
#define	VXGE_HAL_MAX_LATENCY_TIMER			255
...
#define	VXGE_HAL_USE_FLASH_DEFAULT_STATS_REFRESH_TIME	\
						    VXGE_HAL_USE_FLASH_DEFAULT
...
#if defined(VXGE_HAL_USE_SW_LRO)
	u32				lro_enable;
#define	VXGE_HAL_LRO_DONOT_AGGREGATE		   0
#define	VXGE_HAL_LRO_ALWAYS_AGGREGATE		  1
#define	VXGE_HAL_LRO_DONT_AGGR_FWD_PKTS		2
#endif
