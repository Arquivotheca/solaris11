 ...
 * All right Reserved.
 *
 * FileName :   vxgehal-status.h
 *
 * Description:  Status codes returned by HAL
 *
 ...
 * @VXGE_HAL_EVENT_RESET_START: Privileged entity is starting device reset
 * @VXGE_HAL_EVENT_RESET_COMPLETE: Device reset has been completed
...
typedef enum vxge_hal_event_e {
	...
	VXGE_HAL_EVENT_RESET_START	= VXGE_HAL_EVENT_BASE + 8,
	VXGE_HAL_EVENT_RESET_COMPLETE	= VXGE_HAL_EVENT_BASE + 9,
	VXGE_HAL_EVENT_SLOT_FREEZE	= VXGE_HAL_EVENT_BASE + 10,
} vxge_hal_event_e;
 ...
 * @VXGE_HAL_BADCFG_LATENCY_TIMER: Invalid latency timer setting in config
...
typedef enum vxge_hal_status_e {
	...
	VXGE_HAL_BADCFG_LATENCY_TIMER		 = VXGE_HAL_BASE_BADCFG + 311,
