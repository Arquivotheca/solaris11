...
typedef struct  vxge_hal_vpath_stats_sw_ring_info_t {
	...
	u64 lro_clubbed_frms_cnt;
	u64 lro_sending_both;
	u64 lro_outof_sequence_pkts;
	u64 lro_flush_max_pkts;
	u64 lro_sum_avg_pkts_aggregated;
	u64 lro_num_aggregations;
	u64 lro_max_pkts_aggr;
	u64 lro_avg_agr_pkts;
#endif
} vxge_hal_vpath_stats_sw_ring_info_t;
 ...
 */
vxge_hal_status_e vxge_hal_mrpcim_stats_disable(
			vxge_hal_device_h devh);
