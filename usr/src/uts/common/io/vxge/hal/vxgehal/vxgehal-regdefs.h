 ...
 * All right Reserved.
 *
 * FileName :   vxgehal-regdefs.h
 *
 * Description:  Defines that are supposed to be in auto generated
 *              register map header files.
 *
 *
...
#define	VXGE_HAL_HOST_TYPE_ASSIGNMENTS_GET_HOST_TYPE_ASSIGNMENTS(bits)\
							    bVAL3(bits, 5)
#define	VXGE_HAL_VPLANE_ASSIGNMENTS_GET_VPLANE_ASSIGNMENTS(bits) bVAL5(bits, 3)
...
#define	VXGE_HAL_FW_API_FUNC_MODE_COMMIT		    21
...
#define	VXGE_HAL_RTS_ACCESS_STR_DATA0_FW_UPGRD_GET_RET_CODE_DONE	1
#define	VXGE_HAL_RTS_ACCESS_STR_DATA0_FW_UPGRD_GET_RET_CODE_ERROR	2
#define	VXGE_HAL_RTS_ACCESS_STR_DATA0_FW_UPGRD_GET_RET_CODE_SKIP	3
...
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_FW_UPGRADE_GET_SUB_SUB_CODE(bits) \
							    bVAL8(bits, 40)
#define	VXGE_HAL_RTS_ACCESS_STR_DATA0_FW_UPGRD_GET_SKIP_BYT(bits) \
							    bVAL32(bits, 24)
...
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_GET_MSG_TYPE(bits)  bVAL8(bits, 0)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_MSG_TYPE(val)	    vBIT(val, 0, 8)
#define	VXGE_HAL_RTS_ACCESS_STEER_MSG_TYPE_RESET_REQ			1
#define	VXGE_HAL_RTS_ACCESS_STEER_MSG_TYPE_RESET_PENDING		2
#define	VXGE_HAL_RTS_ACCESS_STEER_MSG_TYPE_RESET_ACK			3
...
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_GET_MSG_DATA(bits)  bVAL32(bits, 32)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_MSG_DATA(val)	    vBIT(val, 32, 32)

#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_MSG_ERROR_PENDING		0
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_MSG_ERROR_NOT_IN_SVC		1

#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_GET_MSG_TYPE(bits)  bVAL8(bits, 0)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_MSG_TYPE(val)	    vBIT(val, 0, 8)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_GET_MSG_DEST(bits)  bVAL8(bits, 8)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_MSG_DEST(val)	    vBIT(val, 8, 8)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_GET_MSG_SRC(bits)   bVAL8(bits, 16)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_MSG_SRC(val)	    vBIT(val, 16, 8)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_GET_MSG_DATA(bits)  bVAL32(bits, 32)
#define	VXGE_HAL_RTS_ACCESS_STEER_DATA1_MSG_DATA(val)	    vBIT(val, 32, 32)

#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_UDP_RTH_ENABLE	    mBIT(63)

#define	VXGE_HAL_RTS_ACCESS_STEER_DATA0_GET_FUNC_MODE	    bVAL8(bits, 56)
