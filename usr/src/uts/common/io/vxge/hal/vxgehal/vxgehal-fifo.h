 ...
 *		per-TxDL HAL private space (__vxge_hal_fifo_txdl_priv_t).
 ...
 */
typedef struct __vxge_hal_fifo_t {
...
} __vxge_os_attr_cacheline_aligned __vxge_hal_fifo_t;

/*
 * struct __vxge_hal_fifo_txdl_priv_t - Transmit descriptor HAL-private data.
 ...
 */
typedef struct __vxge_hal_fifo_txdl_priv_t {
	dma_addr_t			dma_addr;
	...
	struct __vxge_hal_fifo_txdl_priv_t	*next_txdl_priv;
...
#define	VXGE_HAL_FIFO_HAL_PRIV(fifo, txdh)				\
	((__vxge_hal_fifo_txdl_priv_t *)(fifo->channel.dtr_arr[		\
...
void
__vxge_hal_fifo_txdl_free_many(
