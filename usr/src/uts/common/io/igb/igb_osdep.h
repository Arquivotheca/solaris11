...
#ifdef IGB_DEBUG
#define	DEBUGOUT(S)		igb_log(NULL, S)
#define	DEBUGOUT1(S, A)		igb_log(NULL, S, A)
#define	DEBUGOUT2(S, A, B)	igb_log(NULL, S, A, B)
#define	DEBUGOUT3(S, A, B, C)	igb_log(NULL, S, A, B, C)
#else
#define	DEBUGOUT(S)
...
#define	E1000_WRITE_REG(hw, reg, value)	igb_write_reg(hw, reg, value)
#define	E1000_READ_REG(hw, reg)		igb_read_reg(hw, reg)
#define	E1000_WRITE_REG_ARRAY(hw, reg, offset, value)	\
	igb_write_reg_array(hw, reg, offset, value)
