...
/* IntelVersion: 1.11 scm_120210_003723 */
 ...
 */
s32
e1000_read_mbx(struct e1000_hw *hw, u32 *msg, u16 size, u16 mbx_id)
{
 ...
 */
s32
e1000_write_mbx(struct e1000_hw *hw, u32 *msg, u16 size, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
 ...
 */
s32
e1000_check_for_msg(struct e1000_hw *hw, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
s32
e1000_check_for_ack(struct e1000_hw *hw, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
s32
e1000_check_for_rst(struct e1000_hw *hw, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
static s32
e1000_poll_for_msg(struct e1000_hw *hw, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
 ...
 */
static s32
e1000_poll_for_ack(struct e1000_hw *hw, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
	int countdown = mbx->timeout;
 ...
 */
s32
e1000_read_posted_mbx(struct e1000_hw *hw, u32 *msg, u16 size, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
s32
e1000_write_posted_mbx(struct e1000_hw *hw, u32 *msg, u16 size, u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
void
e1000_init_mbx_ops_generic(struct e1000_hw *hw)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
...
static s32
e1000_check_for_bit_pf(struct e1000_hw *hw, u32 mask)
{
 ...
 */
static s32
e1000_check_for_msg_pf(struct e1000_hw *hw, u16 vf_number)
{
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
static s32
e1000_check_for_ack_pf(struct e1000_hw *hw, u16 vf_number)
{
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
static s32
e1000_check_for_rst_pf(struct e1000_hw *hw, u16 vf_number)
{
 ...
 */
static s32
e1000_obtain_mbx_lock_pf(struct e1000_hw *hw, u16 vf_number)
{
	s32 ret_val = -E1000_ERR_MBX;
	u32 p2v_mailbox;
 ...
 */
static s32
e1000_write_mbx_pf(struct e1000_hw *hw, u32 *msg, u16 size,
    u16 vf_number)
{
	s32 ret_val;
	u16 i;
	...
	(void) e1000_check_for_ack_pf(hw, vf_number);
 ...
 */
static s32
e1000_read_mbx_pf(struct e1000_hw *hw, u32 *msg, u16 size,
    u16 vf_number)
{
	s32 ret_val;
	u16 i;
 ...
 */
s32
e1000_init_mbx_params_pf(struct e1000_hw *hw)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
