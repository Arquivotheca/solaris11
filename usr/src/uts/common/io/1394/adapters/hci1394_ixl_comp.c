 ...
 *    host memory.
 *
 *    General rules for cache flush preceding a descriptor block in dma memory:
 ...
 *	    command (i.e. immediately preceding it), is flagged updateable.
 ...
 *	    immediately preceding the generation of the dma descriptor block
 *	    for the packet xfer.
