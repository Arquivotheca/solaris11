...
/* IntelVersion: 1.244 scm_011511_003853 */
    ...
    ixgbe_link_speed speed, bool autoneg, bool autoneg_wait_to_complete)
{
	...
	if (speed & IXGBE_LINK_SPEED_10GB_FULL) {
		...
		status = ixgbe_setup_mac_link_82599(hw,
		    IXGBE_LINK_SPEED_10GB_FULL, autoneg,
	...
	if (speed & IXGBE_LINK_SPEED_1GB_FULL) {
		...
		status = ixgbe_setup_mac_link_82599(hw,
		    IXGBE_LINK_SPEED_1GB_FULL, autoneg,
		    autoneg_wait_to_complete);
		if (status != IXGBE_SUCCESS)
			return (status);
 ...
 */
u32
ixgbe_atr_compute_hash_82599(union ixgbe_atr_input *atr_input, u32 key)
{
	/*
 ...
 */
static u32
ixgbe_get_fdirtcpm_82599(struct ixgbe_atr_input_masks *input_masks)
{
...
ixgbe_fdir_add_perfect_filter_82599(struct ixgbe_hw *hw,
    union ixgbe_atr_input *input, struct ixgbe_atr_input_masks *input_masks,
    u16 soft_id, u8 queue)
{
	...
	IXGBE_WRITE_REG_BE32(hw, IXGBE_FDIRSIP4M, ~input_masks->src_ip_mask[0]);
	IXGBE_WRITE_REG_BE32(hw, IXGBE_FDIRDIP4M, ~input_masks->dst_ip_mask[0]);
 ...
 */
bool
ixgbe_verify_lesm_fw_enabled_82599(struct ixgbe_hw *hw)
{
