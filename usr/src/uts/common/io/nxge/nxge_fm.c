...
static nxge_fm_ereport_attr_t *nxge_fm_get_ereport_attr(nxge_fm_ereport_id_t);
static int nxge_fm_error_cb(dev_info_t *dip, ddi_fm_error_t *err,
    const void *impl_data);

nxge_fm_ereport_attr_t	nxge_fm_ereport_pcs[] = {
	{NXGE_FM_EREPORT_XPCS_LINK_DOWN, "10g_link_down",
		DDI_FM_DEVICE_INVAL_STATE, DDI_SERVICE_LOST},
	{NXGE_FM_EREPORT_XPCS_TX_LINK_FAULT, "10g_tx_link_fault",
		DDI_FM_DEVICE_INVAL_STATE, DDI_SERVICE_DEGRADED},
...
nxge_fm_ereport_attr_t nxge_fm_ereport_fflp[] = {
	{NXGE_FM_EREPORT_FFLP_TCAM_ERR, "classifier_tcam_err",
		DDI_FM_DEVICE_INTERN_UNCORR, DDI_SERVICE_UNAFFECTED},
	...
	{NXGE_FM_EREPORT_FFLP_ACCESS_FAIL, "classifier_access_fail",
		DDI_FM_DEVICE_NO_RESPONSE, DDI_SERVICE_DEGRADED}
};
...
nxge_fm_ereport_attr_t nxge_fm_ereport_ipp[] = {
	...
	{NXGE_FM_EREPORT_IPP_DFIFO_UE, "rx_dfifo_ucorr_err",
		DDI_FM_DEVICE_INTERN_UNCORR, DDI_SERVICE_LOST},
	{NXGE_FM_EREPORT_IPP_DFIFO_CE, "rx_dfifo_corr_err",
		DDI_FM_DEVICE_INTERN_CORR, DDI_SERVICE_UNAFFECTED},
	...
	{NXGE_FM_EREPORT_IPP_RESET_FAIL, "rx_reset_fail",
		DDI_FM_DEVICE_NO_RESPONSE, DDI_SERVICE_LOST}
};
...
nxge_fm_ereport_attr_t nxge_fm_ereport_rdmc[] = {
	...
	{NXGE_FM_EREPORT_RDMC_RCR_ACK_ERR, "rxdma_rcr_ack_err",
		DDI_FM_DEVICE_INTERN_UNCORR, DDI_SERVICE_DEGRADED},
...
nxge_fm_ereport_attr_t nxge_fm_ereport_zcp[] = {
	...
	{NXGE_FM_EREPORT_ZCP_RSPFIFO_UNCORR_ERR, "rxzcopy_rspfifo_uncorr_err",
		DDI_FM_DEVICE_INTERN_UNCORR, DDI_SERVICE_UNAFFECTED},
    ...
    nxge_fm_ereport_attr_t *ereport)
{
	...
	case NXGE_FM_EREPORT_PCS_REMOTE_FAULT:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena,
		    DDI_NOSLEEP, FM_VERSION, DATA_TYPE_UINT8, FM_EREPORT_VERS0,
		    ERNAME_DETAILED_ERR_TYPE, DATA_TYPE_STRING, err_str,
		    ERNAME_ERR_PORTN, DATA_TYPE_UINT8, err_portn, NULL);
		break;
	...
	case NXGE_FM_EREPORT_IPP_SOP_MISS:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena,
		    ...
		    statsp->ipp_stats.errlog.state_mach, NULL);
		break;

	case NXGE_FM_EREPORT_IPP_DFIFO_UE:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    statsp->ipp_stats.errlog.ecc_syndrome, NULL);
		break;
	...
	case NXGE_FM_EREPORT_IPP_PFIFO_PERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    nxgep->ipp.status.bits.w0.pre_fifo_perr_idx, NULL);
		break;
	...
	case NXGE_FM_EREPORT_FFLP_TCAM_ERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    statsp->fflp_stats.errlog.tcam, NULL);
		break;
	...
	case NXGE_FM_EREPORT_FFLP_VLAN_PAR_ERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    statsp->fflp_stats.errlog.vlan, NULL);
		break;

	case NXGE_FM_EREPORT_FFLP_HASHT_DATA_ERR: {
		int			rdc_grp;
		hash_tbl_data_log_t	hash_log;
		nxge_fflp_stats_t	*fflp_stats;

		fflp_stats = nxgep->classifier.fflp_stats;
	...
	case NXGE_FM_EREPORT_FFLP_HASHT_LOOKUP_ERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    statsp->fflp_stats.errlog.hash_lookup2, NULL);
		break;
	...
	case NXGE_FM_EREPORT_RDMC_IPP_EOP_ERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    ERNAME_DETAILED_ERR_TYPE, DATA_TYPE_STRING, err_str,
		    ERNAME_ERR_PORTN, DATA_TYPE_UINT8, err_portn,
		    ERNAME_ERR_DCHAN, DATA_TYPE_UINT8, err_chan, NULL);
		break;
	...
	case NXGE_FM_EREPORT_RDMC_RCR_SHA_PAR: {
		...
		if (ereport->index == NXGE_FM_EREPORT_RDMC_RBR_PRE_PAR)
			err_log = (uint32_t)statsp->rdc_stats[
			    err_chan].errlog.pre_par.value;
		else
			err_log = (uint32_t)statsp->rdc_stats[
			    err_chan].errlog.sha_par.value;
		...
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    ERNAME_RDMC_PAR_ERR_LOG, DATA_TYPE_UINT8, err_log, NULL);
	}
	break;
	...
	case NXGE_FM_EREPORT_RDMC_RCR_ERR: {
		...
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    ERNAME_ERR_PORTN, DATA_TYPE_UINT8, err_portn,
		    ERNAME_ERR_DCHAN, DATA_TYPE_UINT8, err_chan,
		    ERNAME_RDC_ERR_TYPE, DATA_TYPE_UINT8, err_type, NULL);
	}
	break;
	...
	case NXGE_FM_EREPORT_ZCP_BUFFER_OVERFLOW: {
		...
		sm = statsp->zcp_stats.errlog.state_mach.bits.ldw.state;
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    FM_VERSION, DATA_TYPE_UINT8, FM_EREPORT_VERS0,
		    ERNAME_DETAILED_ERR_TYPE, DATA_TYPE_STRING, err_str,
		    sm, DATA_TYPE_UINT32, NULL);
	}
	break;
	...
	case NXGE_FM_EREPORT_TXC_RO_UNCORRECT_ERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    statsp->txc_stats.errlog.ro_st.d1.bits.ldw.ro_ecc_data1,
		    ERNAME_TXC_ROECC_DATA2, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.ro_st.d2.bits.ldw.ro_ecc_data2,
		    ERNAME_TXC_ROECC_DATA3, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.ro_st.d3.bits.ldw.ro_ecc_data3,
		    ERNAME_TXC_ROECC_DATA4, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.ro_st.d4.bits.ldw.ro_ecc_data4,
		    NULL);
		break;
	...
	case NXGE_FM_EREPORT_TXC_REORDER_ERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    (uint32_t)statsp->txc_stats.errlog.ro_st.tids.value, NULL);
		break;
	...
	case NXGE_FM_EREPORT_TXC_SF_UNCORRECT_ERR:
		ddi_fm_ereport_post(nxgep->dip, eclass, ena, DDI_NOSLEEP,
		    ...
		    statsp->txc_stats.errlog.sf_st.sfecc.bits.ldw.ecc_address,
		    ERNAME_TXC_SFECC_DATA0, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.sf_st.d0.bits.ldw.sf_ecc_data0,
		    ERNAME_TXC_SFECC_DATA0, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.sf_st.d1.bits.ldw.sf_ecc_data1,
		    ERNAME_TXC_SFECC_DATA0, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.sf_st.d2.bits.ldw.sf_ecc_data2,
		    ERNAME_TXC_SFECC_DATA0, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.sf_st.d3.bits.ldw.sf_ecc_data3,
		    ERNAME_TXC_SFECC_DATA0, DATA_TYPE_UINT32,
		    statsp->txc_stats.errlog.sf_st.d4.bits.ldw.sf_ecc_data4,
		    NULL);
		break;
