...
typedef	enum _fflp_event_mask_cfg_e {
	...
	CFG_FFLP_MASK_ALL = (FFLP_ERR_VLAN_MASK | FFLP_ERR_TCAM_MASK |
		FFLP_ERR_HASH_TBL_LKUP_MASK | FFLP_ERR_HASH_TBL_DAT_MASK)
...
npi_status_t npi_fflp_fcram_entry_write(npi_handle_t, part_id_t,
	uint32_t, fcram_entry_t *, fcram_entry_format_t);
 ...
 *	NPI_SW_ERR
 */
npi_status_t npi_fflp_fcram_entry_invalidate(npi_handle_t, part_id_t, uint32_t);
 ...
 *	pointed by last 20 bits of H1. Effectively, this accesses specific
 *	8 bytes within the hash table bucket.
 *
 *  H1-->  |-----------------|
 *	   |	subarea 0    |
 *	   |_________________|
 ...
 *	NPI_SW_ERR
 */
npi_status_t npi_fflp_fcram_subarea_read  (npi_handle_t, part_id_t,
    uint32_t, uint64_t *);
 ...
 */
npi_status_t npi_fflp_cfg_fcram_partition_enable(npi_handle_t, part_id_t);
 ...
 *	NPI_SW_ERR
 */
npi_status_t npi_fflp_cfg_fcram_partition_disable(npi_handle_t, part_id_t);
 ...
 *	NPI_SW_ERR
 */
npi_status_t npi_fflp_cfg_fcram_reset(npi_handle_t, fflp_fcram_output_drive_t,
    fflp_fcram_qs_t);

/*
 * npi_fflp_cfg_tcam_reset
 *	Initializes the FFLP reset sequence. Doesn't configure the
 *	FCRAM params.
 * Return:
 *	NPI_SUCCESS
 *	NPI_FAILURE
 ...
 *	NPI_SW_ERR
 */
npi_status_t npi_fflp_cfg_fcram_refresh_time(npi_handle_t, uint32_t,
    uint32_t, uint32_t);
 ...
 */
npi_status_t npi_fflp_cfg_fcram_access(npi_handle_t, uint8_t);
 ...
 *	NPI_SUCCESS	Success
 */
npi_status_t npi_fflp_fcram_clr_pio_err_log(npi_handle_t, part_id_t);
...
npi_status_t npi_fflp_cfg_enet_vlan_table_assoc(npi_handle_t,
    uint8_t, vlan_id_t, uint8_t, uint8_t);
 ...
 *	NPI_SW_ERR
 */
npi_status_t npi_fflp_cfg_ip_usr_cls_set(npi_handle_t, tcam_class_t,
 ...
 *	  NPI_HW_ERR
 */
npi_status_t npi_fflp_fcram_reset(npi_handle_t, fflp_fcram_output_drive_t,
    fflp_fcram_qs_t);
 ...
 *	NPI_HW_ERR
 */
npi_status_t npi_fflp_tcam_entry_write(npi_handle_t, tcam_location_t,
    tcam_entry_t *);
 ...
 *	NPI_SW_ERR
 */
npi_status_t npi_fflp_tcam_entry_read(npi_handle_t, tcam_location_t,
    tcam_entry_t *);
 ...
 *
 */
npi_status_t npi_fflp_event_mask_config(npi_handle_t, io_op_t,
    fflp_event_mask_cfg_t *);
 ...
 */
void npi_fflp_vlan_error_get(npi_handle_t, p_vlan_par_err_t);
void npi_fflp_vlan_error_clear(npi_handle_t);
void npi_fflp_tcam_error_get(npi_handle_t, p_tcam_err_t);
void npi_fflp_tcam_error_clear(npi_handle_t);
void npi_fflp_fcram_error_get(npi_handle_t, p_hash_tbl_data_log_t, uint8_t);
void npi_fflp_fcram_error_clear(npi_handle_t, uint8_t);
void npi_fflp_fcram_error_log1_get(npi_handle_t, p_hash_lookup_err_log1_t);
void npi_fflp_fcram_error_log2_get(npi_handle_t, p_hash_lookup_err_log2_t);
