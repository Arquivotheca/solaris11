...
mblk_t *
xgell_rx_poll(void *arg, int bytes_to_pickup, int pkts_to_pickup)
{
...
static int
xgell_addmac(void *arg, const uint8_t *mac_addr, uint64_t flags)
{
 ...
 */
int
xgell_rx_ring_intr_enable(mac_ring_driver_t rh)
{
	xgell_rx_ring_t *ring = (xgell_rx_ring_t *)rh;
...
int
xgell_rx_ring_intr_disable(mac_ring_driver_t rh)
{
	xgell_rx_ring_t *ring = (xgell_rx_ring_t *)rh;
