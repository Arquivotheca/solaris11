...
static int	pcishpc_set_slot_state(pcie_hp_slot_t *slot_p,
		    ddi_hp_cn_state_code_t new_slot_state);
...
static char	*pcishpc_slot_textslotstate(ddi_hp_cn_state_code_t state);
...
static int	pcishpc_slot_poweron(pcie_hp_slot_t *slot_p,
		    ddi_hp_cn_state_code_t *result_state);
...
/*ARGSUSED*/
static int
pcishpc_slot_poweron(pcie_hp_slot_t *slot_p,
    ddi_hp_cn_state_code_t *result_state)
{
	uint32_t	status;
...
/*ARGSUSED*/
static int
pcishpc_slot_poweroff(pcie_hp_slot_t *slot_p,
    ddi_hp_cn_state_code_t *result_state)
{
 ...
 */
static char *
pcishpc_slot_textslotstate(ddi_hp_cn_state_code_t state)
{
