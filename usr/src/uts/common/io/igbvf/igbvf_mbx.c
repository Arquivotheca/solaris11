 ...
 */
static s32
e1000_read_posted_mbx(struct e1000_hw *hw, u32 *msg, u16 size,
    u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
 ...
 */
static s32
e1000_write_posted_mbx(struct e1000_hw *hw, u32 *msg, u16 size,
    u16 mbx_id)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
u32
e1000_read_v2p_mailbox(struct e1000_hw *hw)
{
 ...
 */
static s32
e1000_check_for_bit_vf(struct e1000_hw *hw, u32 mask)
{
 ...
 */
static s32
e1000_check_for_msg_vf(struct e1000_hw *hw, u16 mbx_id)
{
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
static s32
e1000_check_for_ack_vf(struct e1000_hw *hw, u16 mbx_id)
{
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
static s32
e1000_check_for_rst_vf(struct e1000_hw *hw, u16 mbx_id)
{
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
static s32
e1000_obtain_mbx_lock_vf(struct e1000_hw *hw)
{
	s32 ret_val = -E1000_ERR_MBX;
 ...
 */
static s32
e1000_write_mbx_vf(struct e1000_hw *hw, u32 *msg, u16 size,
    u16 mbx_id)
{
	s32 ret_val;
	u16 i;
	...
	(void) e1000_check_for_msg_vf(hw, 0);
	(void) e1000_check_for_ack_vf(hw, 0);
 ...
 */
static s32
e1000_read_mbx_vf(struct e1000_hw *hw, u32 *msg, u16 size,
    u16 mbx_id)
{
 ...
 */
s32
e1000_init_mbx_params_vf(struct e1000_hw *hw)
{
	struct e1000_mbx_info *mbx = &hw->mbx;
