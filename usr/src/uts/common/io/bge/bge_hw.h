...
/*
 * MSI capabilities, in PCI config space
 */
#define	PCI_CONF_BGE_MSI_CTRL			0x5a
...
#define	READ_DMA_RESERVED_CTL_REG	0x4900
...
/*
 * BCM5717, 5718, 5724 only
 * Fix enable bit in LSO Read DMA Reserved Control Register
 * (READ_DMA_RESERVED_CTL_REG, 0x4900)
 */
#define	DMA_FIFO_OVERRUN_FIX_CQ25155	0x00000004
...
/*
 * Standard & Jumbo Replenish LWM Registers
 */
#define	STD_REPLENISH_LWM_REG	0x2d00
#define	STD_REPLENISH_LWM_DEFAULT	0x00000020	/* 32	*/
#define	JUMBO_REPLENISH_LWM_REG	0x2d04
#define	JUMBO_REPLENISH_LWM_DEFAULT	0x00000010	/* 16	*/
...
#define	MAC_RX_MBUF_LOWAT_5717_JUMBO	0x0000007e
...
#define	MBUF_HIWAT_5717_JUMBO		0x000000ea
...
#define	SBD_FLAG_JUMBO_PKT		0x0008
...
/*
 * Hardware-defined Extended Receive Buffer Descriptor
 */
typedef struct {
	uint64_t	host_buf_addr1;
	uint64_t	host_buf_addr2;
	uint64_t	host_buf_addr3;
#ifdef	_BIG_ENDIAN
	uint16_t	len1;
	uint16_t	len2;
	uint16_t	len3;
