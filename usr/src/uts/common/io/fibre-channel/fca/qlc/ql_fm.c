...
#pragma ident   "Copyright 2011 QLogic Corporation; qlc_fm.c"
...
qlc_fm_init(ql_adapter_state_t *ha)
{
	 ...
	 */
	if (DDI_FM_ACC_ERR_CAP(ha->fm_capabilities)) {
		qlc_dev_acc_attr.devacc_attr_access = DDI_FLAGERR_ACC;
	} else {
		qlc_dev_acc_attr.devacc_attr_access = DDI_DEFAULT_ACC;
	}
