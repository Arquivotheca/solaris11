...
/*
 * 2. Checksum_Offload/LSO for EoIB packets
 */
int eib_wa_no_cksum_offload = 0;
int eib_wa_no_lso = 0;
...
/*
 * 4. The older BX software does not seem to set the VP flag correctly
...
/*
 * 5. Each vhub table is expected to carry a checksum at the end to
