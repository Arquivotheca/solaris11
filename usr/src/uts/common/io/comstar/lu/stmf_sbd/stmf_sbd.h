...
/*
 * SL_READ_ONLY is the effective read-only mode which comes from
 * SL_WRITE_PROTECT and read-only mode of the backing store(zvol)
 */
#define	SL_READ_ONLY			   0x100000
