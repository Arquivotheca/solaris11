...
/*
 * The dynamic linker in an s10 branded zone makes a direct
 * call to this system call trap.  We retain it for the moment,
 * until a better solution for the s10 brand is worked out.
 */
int
s10_open(char *path, int fmode, int cmode)
{
 ...
 */
int
s10_open64(char *path, int fmode, int cmode)
{
 ...
 */
int
s10_open32(char *path, int fmode, int cmode)
{
