...
#define	FLG_RE_WDISP16		0x00000100	/* funky sparc WDISP16 rel */
#define	FLG_RE_WDISP10		0x00000200	/* funky sparc WDISP10 rel */
#define	FLG_RE_SIGN		0x00000400	/* value is signed */
#define	FLG_RE_ADDRELATIVE	0x00000800	/* RELATIVE relocation */
						/*	required for non- */
						/*	fixed objects */
#define	FLG_RE_EXTOFFSET	0x00001000	/* extra offset required */
#define	FLG_RE_REGISTER		0x00002000	/* relocation initializes */
						/*    a REGISTER by OLO10 */
#define	FLG_RE_SIZE		0x00004000	/* symbol size required */
