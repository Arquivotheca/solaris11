...
struct sctp_sonode {
	...
	boolean_t		ss_recvrcvinfo;	/* receive sctp_rcvinfo */
	boolean_t		ss_recvnxtinfo;	/* receive sctp_nxtinfo */
...
struct sctp_soassoc {
	...
	boolean_t		ssa_recvrcvinfo; /* receive sctp_rcvinfo */
	boolean_t		ssa_recvnxtinfo; /* receive sctp_nxtinfo */
};
...
extern boolean_t sosctp_aid_grow(struct sctp_sonode *ss, int kmflags);
...
extern void sosctp_aid_reserve(struct sctp_sonode *ss, sctp_assoc_t id,
    int incr);
extern void sosctp_num_aid(struct sonode *, int *);
extern int sosctp_get_aid_list(struct sonode *, struct sctp_assoc_ids *,
    uint32_t *);
...
extern void sosctp_assoc_free(struct sctp_sonode *ss, struct sctp_soassoc *ssa,
    cred_t *);
extern int sosctp_assoc_createconnx(struct sctp_sonode *ss,
    const struct sockaddr *name, int addrcnt,
