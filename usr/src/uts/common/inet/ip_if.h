...
#define	IFF_ALL_FLAGS		(IFF_PHYINT_FLAGS|IFF_PHYINTINST_FLAGS| \
    IFF_LOGINT_FLAGS)
...
#define	PHYI_PROBER		IFF_PROBER	/* attempting NIC recovery */
...
#define	IPIF_MATCH_UP		0x00000002
...
extern	void	ill_flowctl_cleanup(ill_t *);
...
extern	boolean_t ill_has_testaddr(ill_t *);
...
extern	ipif_t	*ipif_lookup_up_addr(ipaddr_t, ill_t *, zoneid_t,
    ip_stack_t *);
...
extern	ipif_t	*ipif_lookup_addr_exact_v6(const in6_addr_t *, ill_t *,
    ip_stack_t *);
extern	ipif_t	*ipif_lookup_up_addr_v6(const in6_addr_t *, ill_t *,
    zoneid_t, ip_stack_t *);
