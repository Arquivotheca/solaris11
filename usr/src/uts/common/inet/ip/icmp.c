...
/* default maximum size of rawip socket buffer */
#define	RAWIP_DEF_MAX_SOCKBUF	(256 * 1024)
...
static mod_prop_info_t icmp_propinfo_tbl[] = {
	...
	{ MOD_PROPNAME_SEND_BUF, MOD_PROTO_RAWIP,
	    mod_set_buf, mod_get_buf,
	    {4096, RAWIP_DEF_MAX_SOCKBUF, 8192}, {8192} },

	{ "_xmit_lowat", MOD_PROTO_RAWIP,
	    mod_set_uint32, mod_get_uint32,
	    {0, 65536, 1024}, {1024} },

	{ MOD_PROPNAME_RECV_BUF, MOD_PROTO_RAWIP,
	    mod_set_buf, mod_get_buf,
	    {4096, RAWIP_DEF_MAX_SOCKBUF, 8192}, {8192} },

	{ MOD_PROPNAME_MAX_BUF, MOD_PROTO_RAWIP,
	    mod_set_max_buf, mod_get_max_buf,
	    {65536, 1024*1024*1024, RAWIP_DEF_MAX_SOCKBUF},
	    {RAWIP_DEF_MAX_SOCKBUF} },
...
icmp_input(void *arg1, mblk_t *mp, void *arg2, ip_recv_attr_t *ira)
{
	...
	if (recv_ancillary.crb_all != 0) {
		/*
		 * Call on ip_find_hdr_v6 which gets individual lengths of
...
icmp_output_hdrincl(conn_t *connp, mblk_t *mp, cred_t *cr, pid_t pid)
{
	 ...
	 * checksummed by ip_output is in the first mblk. (ip_output assumes
