...
typedef struct ipsa_cm_mech_s {
	...
	union {
		...
		CK_AES_GMAC_PARAMS paramu_gmac;
	} paramu;
...
#define	param_gpIv paramu.paramu_gmac.ipsa_pIv
#define	param_gpAAD paramu.paramu_gmac.pAAD
#define	param_gulAADLen paramu.paramu_gmac.ulAADLen
} ipsa_cm_mech_t;
...
typedef struct ipsec_crypto_s {
	...
	crypto_data_t	*ic_mac;
	ipsa_cm_mech_t	ic_cmm;
	mblk_t *ic_AAD;	/* Some algs need to copy data for authentication. */
	uint64_t	ic_espstart; /* Used when crypto is async */
	uint64_t	ic_processed_len; /* Used when crypto is async */
} ipsec_crypto_t;
...
typedef struct ipsa_s {
	...
	void (*ipsa_noncefunc)(struct ipsa_s *, uint_t, ipsec_crypto_t *,
	    mblk_t *, uint_t, boolean_t);
	/*
...
void gcm_params_init(ipsa_t *, uint_t, ipsec_crypto_t *,
    mblk_t *, uint_t, boolean_t);
void esp_gmac_params_init(ipsa_t *, uint_t, ipsec_crypto_t *,
    mblk_t *, uint_t, boolean_t);
void ah_gmac_params_init(ipsa_t *, uint_t, ipsec_crypto_t *,
    mblk_t *, uint_t, boolean_t);
void ccm_params_init(ipsa_t *, uint_t, ipsec_crypto_t *,
    mblk_t *, uint_t, boolean_t);
void cbc_params_init(ipsa_t *, uint_t, ipsec_crypto_t *,
    mblk_t *, uint_t, boolean_t);
