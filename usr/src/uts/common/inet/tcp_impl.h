...
{									\
	...
	if (atomic_add_64_nv(&(tcp)->tcp_listen_cnt->tlc_cnt, -1) == 0) \
...
#define	tcps_cong_default		tcps_propinfo_tbl[59].prop_cur_sval
...
extern void	tcp_cong_init(tcp_t *, tcp_t *, char *);
