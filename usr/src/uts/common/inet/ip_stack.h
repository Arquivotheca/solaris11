...
#define	TX_FANOUT_SIZE	127
#define	IDLHASHINDEX(cookie)						\
	((((uintptr_t)cookie >> 2) ^ ((uintptr_t)cookie >> 9) ^ 	\
	((uintptr_t)cookie >> 16) ^ ((uintptr_t)cookie >> 23)) % TX_FANOUT_SIZE)
