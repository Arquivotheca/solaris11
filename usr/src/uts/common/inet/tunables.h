...
/* default small and large annon port values */
#define	ULP_DEF_SMALL_ANONPORT	(32 * 1024)
#define	ULP_DEF_LARGE_ANONPORT	ULP_MAX_PORT

#define	MOD_PROPNAME_SMALL_ANONPORT	"smallest_anon_port"
#define	MOD_PROPNAME_LARGE_ANONPORT	"largest_anon_port"
#define	MOD_PROPNAME_SEND_BUF		"send_buf"
#define	MOD_PROPNAME_RECV_BUF		"recv_buf"
#define	MOD_PROPNAME_MAX_BUF		"max_buf"

/* generic function to set/get global module properties */
extern mod_prop_setf_t	mod_set_boolean, mod_set_uint32, mod_set_anon,
			mod_set_aligned, mod_set_extra_privports,
			mod_set_cong_enabled, mod_set_cong_default,
			mod_set_buf, mod_set_max_buf;

extern mod_prop_getf_t	mod_get_boolean, mod_get_uint32, mod_get_string,
			mod_get_allprop, mod_get_extra_privports,
			mod_get_cong_enabled, mod_get_anon,
			mod_get_buf, mod_get_max_buf;
