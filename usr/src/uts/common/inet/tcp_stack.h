...
#define	TCP_NUM_EPRIV_PORTS	64
	...
	/* congestion control */
	kmutex_t	tcps_cong_lock;
	list_t		tcps_cong_enabled;	/* enabled algs list */
	tcpcong_list_ent_t *tcps_cong_default_ent; /* default alg entry */
};
