...
/*
 * Certificate structure. The msg field is the DER data of the certificate
 * with "certificate" SSL header prepended and "server_hello_done" appended.
 *
 * Note: The MDB KSSL module depends on the definition.
 */
