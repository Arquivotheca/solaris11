...
extern	ire_t	*ire_ftable_lookup_simple_v4(ipaddr_t, uint32_t, ip_stack_t *,
    uint_t *, boolean_t *, ire_t *, boolean_t *);
...
extern	ire_t	*ire_multicast_ext(ill_t *, ire_t *, boolean_t *);
...
extern ire_t   	*ire_round_robin(irb_t *, ire_ftable_args_t *, uint_t,
    ire_t *, ip_stack_t *, kmutex_t **lock);
...
extern ire_t	*ire_route_recursive_dstonly_v4(ipaddr_t, uint_t,
    uint32_t, ip_stack_t *, ire_t *, boolean_t *);
...
extern nce_t	*ire_to_nce_pkt(ire_t *, mblk_t *, uint_t);
extern nce_t	*ire_to_nce(ire_t *, ipaddr_t, const in6_addr_t *, uint_t);
