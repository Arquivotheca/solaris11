...
/* masks */
#ifndef	IPV6_FLOWINFO_VERSION
#define	IPV6_FLOWINFO_VERSION			0xf0000000U
#endif
#ifndef	IPV6_FLOWINFO_FLOWLABEL
#define	IPV6_FLOWINFO_FLOWLABEL			0x000fffffU
#endif
#ifndef	IPV6_FLOWINFO_TCLASS
#define	IPV6_FLOWINFO_TCLASS			0x0ff00000U
#endif

/* version */
#ifndef	IPV6_FLOW_VERSION
#define	IPV6_FLOW_VERSION(x)		(((x) & IPV6_FLOWINFO_VERSION) >> 28)
#endif
#ifndef	IPV6_VERSION_FLOW
#define	IPV6_VERSION_FLOW(f, c)		(((f) & ~IPV6_FLOWINFO_VERSION) |\
					((c) << 28))
#endif

/* traffic class values */
#ifndef	IPV6_FLOW_TCLASS
#define	IPV6_FLOW_TCLASS(x)		(((x) & IPV6_FLOWINFO_TCLASS) >> 20)
#endif
#ifndef	IPV6_TCLASS_FLOW
#define	IPV6_TCLASS_FLOW(f, c)		(((f) & ~IPV6_FLOWINFO_TCLASS) |\
					((c) << 20))
#endif

/* flow label values */
#ifndef	IPV6_FLOW_FLOWLABEL
#define	IPV6_FLOW_FLOWLABEL(x)		((x) & IPV6_FLOWINFO_FLOWLABEL)
#endif
#ifndef	IPV6_FLOWINFO_FLOW
#define	IPV6_FLOWINFO_FLOW(f, c)	(((f) & ~IPV6_FLOWINFO_FLOWLABEL) | (c))
#endif
...
/* masks */
#ifndef	IPV6_FLOWINFO_VERSION
#define	IPV6_FLOWINFO_VERSION			0x000000f0U
#endif
#ifndef	IPV6_FLOWINFO_FLOWLABEL
...
/* version */
#ifndef	IPV6_FLOW_VERSION
#define	IPV6_FLOW_VERSION(x)		(((x) & 0xf0) >> 4)
#endif
#ifndef	IPV6_VERSION_FLOW
#define	IPV6_VERSION_FLOW(f, c)		(((f) & ~IPV6_FLOWINFO_VERSION) |\
					((((c) & 0xf) << 4))
...
/* flow label values */
#ifndef	IPV6_FLOW_FLOWLABEL
#define	IPV6_FLOW_FLOWLABEL(x)		((((x) & 0xff000000U) >> 24) |\
					(((x) & 0xff0000U) >> 8) |\
					(((x) & 0xf00) << 8))
#endif
#ifndef	IPV6_FLOWINFO_FLOW
#define	IPV6_FLOWINFO_FLOW(f, c)	(((f) & ~IPV6_FLOWINFO_FLOWLABEL) |\
					((((c) & 0xff) << 24) |\
					(((c) & 0xff00) << 8) |\
					(((c) & 0xf0000U) >> 8)))
#endif
