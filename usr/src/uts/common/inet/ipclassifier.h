...
#define	conn_priv	conn_proto_priv.cp_priv
	...
	mblk_t		*conn_sq_cleanup_mp;
	kcondvar_t	conn_sq_cleanup_cv;
...
#define	conn_start_clr	conn_recv_ancillary
	...
	unsigned int
		...
		conn_reuseport_bind_done : 1,	/* Bound with SO_REUSEPORT */
		conn_passive_connect : 1,	/* SO_PASSIVE_CONNECT state */
		conn_pad_to_bit_31 : 9;
...
#define	conn_v4lastsrc	V4_PART_OF_V6(conn_v6lastsrc)
	...
	uint32_t	conn_sum;
	pm_handle_t	conn_pmh;

	uint32_t	conn_ioctlref;		/* ioctl ref count */
	kcondvar_t	conn_idl_cv;

	uid_t		conn_bind_uid;		/* thread uid at bind time */
#ifdef CONN_DEBUG
