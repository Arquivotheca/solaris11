...
#pragma ident	"@(#)ip_lookup.h	1.4	10/03/16 SMI"
...
# define	SIOCLOOKUPRESETNODE	_IOWR('r', 69, struct iplookupop)
# define	SIOCLOOKUPRESETNODEW	_IOW('r', 69, struct iplookupop)
# define	SIOCLOOKUPNODE		_IOW('r', 70, struct iplookupop)
# define	SIOCLOOKUPNODEW		_IOW('r', 71, struct iplookupop)
#else
# define	SIOCLOOKUPADDTABLE	_IOWR(r, 60, struct iplookupop)
# define	SIOCLOOKUPDELTABLE	_IOWR(r, 61, struct iplookupop)
# define	SIOCLOOKUPSTAT		_IOWR(r, 64, struct iplookupop)
