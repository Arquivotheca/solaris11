...
/*
 * group not assigned (bound) to a group.
 */
#define	NXGE_NO_HIO_SHARE	-1

/*
 * Group/VR has no RDC table assigned.
 */
#define	NXGE_NO_RDC_TABLE	-1
...
extern nxge_status_t nxge_tdc_lp_conf(p_nxge_t, int, boolean_t);
extern nxge_status_t nxge_rdc_lp_conf(p_nxge_t, int, boolean_t);
