...
#define	RX_LOG_DMA_OFFSET(channel) \
	(channel * RX_LOG_REG_SIZE)
...
#define	RX_DMA_ENT_MSK_ALL \
	(RX_DMA_ENT_MSK_CFIGLOGPGE_MASK | \
...
#define	RX_DMA_CTL_STAT_ERROR \
	(RX_DMA_ENT_MSK_ALL <<  RX_DMA_CTRL_STAT_ENT_MASK_SHIFT)

/*
 * The following are write 1 to clear bits
 */
#define	RX_DMA_CTL_STAT_WR1C \
	RX_DMA_CTL_STAT_RBREMPTY | \
...
#define	RDC_DIS_CNT_OFFSET(rdc)	\
	(RED_DIS_CNT_REG + RED_DMC_OFFSET(rdc))
