...
typedef enum {
	NXGE_NO_GROUP_TYPE = 0,	/* No group type assigned */
	NXGE_TRANSMIT_GROUP,	/* Legacy transmit group */
	NXGE_RECEIVE_GROUP,	/* Legacy receive group */
	NXGE_VR_GROUP_TX,	/* Virtualization Region group for TX */
	NXGE_VR_GROUP_RX,	/* Virtualization Region group for RX */
} nxge_grp_type_t;
...
#define	NXGE_MAGIC		0x3ab434e3
	...
	boolean_t		use_contig_premapped;
	void			*tx_pm_buf[NXGE_MAX_TDCS];
	size_t			tx_pm_len[NXGE_MAX_TDCS];
	uint_t			premapped_min_size;
};
