...
#define	MTDADP		21	/* mt_count is tape_dadp_state for dadp mode */
#define	MTVERIFY	22	/* mt_count is block size if variable, number */
				/* of blocks if fixed, On return is resid */
 ...
 */
enum mtio_state { MTIO_NONE, MTIO_EJECTED, MTIO_INSERTED, MTIO_UNTHREADED };
