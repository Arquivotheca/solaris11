...
#define	FM_SUSPECT_TOPO_UUID		"topo-uuid"
...
#define	FM_SUSPECT_REPLAYED		"__replayed"
#define	FM_SUSPECT_CASE_STATE		"__case_state"
...
#define	FMD_SUSPECT_CASE_SOLVED		1
#define	FMD_SUSPECT_CASE_CLOSE_WAIT	2
#define	FMD_SUSPECT_CASE_CLOSED		3
#define	FMD_SUSPECT_CASE_REPAIRED	4
#define	FMD_SUSPECT_CASE_RESOLVED	5
...
#define	FM_FAULT_IDENT_NODE		"ident_node"
...
#define	FM_RSRC_ASRU_TOPO_UUID		"topo-uuid"
...
/*
 * FM ENA "Error Numeric Association" Format Macros
 */
...
/*
 * CNA_DEV "Configuration Numeric Association" Format Macros
 */
#define	CNA_DEV_TIMEBASE_MASK		0xFFFFFFFF00000000ull
#define	CNA_DEV_TIMEBASE_SHFT		32
#define	CNA_DEV_GEN_MASK		0x00000000FFFFFFFFull
...
#define	FM_FMRI_HC_PARENT_SERIAL	"parent-serial"
#define	FM_FMRI_HC_DEVID		"devid"
...
#define	FM_FMRI_HC_SPECIFIC_L2CACHE	"l2cache"
#define	FM_FMRI_HC_SPECIFIC_L3CACHE	"l3cache"
#define	FM_FMRI_HC_SPECIFIC_CACHEINDEX	"cacheindex"
#define	FM_FMRI_HC_SPECIFIC_CACHEWAY	"cacheway"
...
extern void fm_fmri_hc_set(nvlist_t *, int, const nvlist_t *, nvlist_t *,
    int, ...);
extern void fm_fmri_dev_set(nvlist_t *, int, uint64_t, const nvlist_t *,
...
extern uint64_t fm_cna_dev_generate(void);
extern uint32_t fm_cna_dev_gen_get(uint64_t);
extern time_t	fm_cna_dev_timebase_get(uint64_t);
