...
int priv_mwac_enable(boolean_t, zoneid_t);
int priv_mwac_disable(zoneid_t);
int priv_mwac_list(zoneid_t, size_t, void *, boolean_t);
int priv_mwac_mark_transient(zoneid_t);
int priv_policy_mwac(const cred_t *, vnode_t *, const char *);
void klpd_freemwac_tree(struct avl_tree *);
boolean_t priv_mwac_needed(const cred_t *, struct vfs *, vnode_t *);
boolean_t priv_mwac_mntpnt_writable(cred_t *, char *);
#endif /* _KERNEL */
