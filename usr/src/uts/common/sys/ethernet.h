...
#define	ETHERTYPE_MAC_CONTROL	(0x8808)	/* 802.3 MAC Control Frame */
#define	ETHERTYPE_SLOW		(0x8809)	/* Slow Protocol */
#define	ETHERTYPE_ORCL_1	(0x881B)	/* Oracle private L2 protocol */
						/* with common ether_orcl_1_t */
						/* header */
#define	ETHERTYPE_PPPOED	(0x8863)	/* PPPoE Discovery Stage */
#define	ETHERTYPE_PPPOES	(0x8864)	/* PPPoE Session Stage */
#define	ETHERTYPE_LLDP		(0x88CC)	/* LLDP (IEEE 802.1AB) */
...
#define	ETHERTYPE_FIP		(0x8914)	/* FIP protocol */
...
/*
 * common header for structures used for ETHERTYPE_ORCL_1
 */
typedef struct ether_orcl_1_s {
	uint16_t	ether_orcl_1_proto;
} ether_orcl_1_t;

#define	ETHERTYPE_ORCL_XPROBE	0x0001
