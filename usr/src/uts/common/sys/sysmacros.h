...
/* highbit(), but only for compile time computable arguments */
#define	_HIGHBIT32_CONST(n)	(				\
	((n) < (1UL <<  0)) ?  0 : ((n) < (1UL <<  1)) ?  1 :	\
	((n) < (1UL <<  2)) ?  2 : ((n) < (1UL <<  3)) ?  3 :	\
	((n) < (1UL <<  4)) ?  4 : ((n) < (1UL <<  5)) ?  5 :	\
	((n) < (1UL <<  6)) ?  6 : ((n) < (1UL <<  7)) ?  7 :	\
	((n) < (1UL <<  8)) ?  8 : ((n) < (1UL <<  9)) ?  9 :	\
	((n) < (1UL << 10)) ? 10 : ((n) < (1UL << 11)) ? 11 :	\
	((n) < (1UL << 12)) ? 12 : ((n) < (1UL << 13)) ? 13 :	\
	((n) < (1UL << 14)) ? 14 : ((n) < (1UL << 15)) ? 15 :	\
	((n) < (1UL << 16)) ? 16 : ((n) < (1UL << 17)) ? 17 :	\
	((n) < (1UL << 18)) ? 18 : ((n) < (1UL << 19)) ? 19 :	\
	((n) < (1UL << 20)) ? 20 : ((n) < (1UL << 21)) ? 21 :	\
	((n) < (1UL << 22)) ? 22 : ((n) < (1UL << 23)) ? 23 :	\
	((n) < (1UL << 24)) ? 24 : ((n) < (1UL << 25)) ? 25 :	\
	((n) < (1UL << 26)) ? 26 : ((n) < (1UL << 27)) ? 27 :	\
	((n) < (1UL << 28)) ? 28 : ((n) < (1UL << 29)) ? 29 :	\
	((n) < (1UL << 30)) ? 30 : ((n) < (1UL << 31)) ? 31 : 32)

#ifdef _LP64
#define	HIGHBIT_CONST(n)	(				\
	((n) < (1UL << 32)) ? _HIGHBIT32_CONST(n) :		\
	((n) < (1UL << 33)) ? 33 : ((n) < (1UL << 34)) ? 34 :	\
	((n) < (1UL << 35)) ? 35 : ((n) < (1UL << 36)) ? 36 :	\
	((n) < (1UL << 37)) ? 37 : ((n) < (1UL << 38)) ? 38 :	\
	((n) < (1UL << 39)) ? 39 : ((n) < (1UL << 40)) ? 40 :	\
	((n) < (1UL << 41)) ? 41 : ((n) < (1UL << 42)) ? 42 :	\
	((n) < (1UL << 43)) ? 43 : ((n) < (1UL << 44)) ? 44 :	\
	((n) < (1UL << 45)) ? 45 : ((n) < (1UL << 46)) ? 46 :	\
	((n) < (1UL << 47)) ? 47 : ((n) < (1UL << 48)) ? 48 :	\
	((n) < (1UL << 49)) ? 49 : ((n) < (1UL << 50)) ? 50 :	\
	((n) < (1UL << 51)) ? 51 : ((n) < (1UL << 52)) ? 52 :	\
	((n) < (1UL << 53)) ? 53 : ((n) < (1UL << 54)) ? 54 :	\
	((n) < (1UL << 55)) ? 55 : ((n) < (1UL << 56)) ? 56 :	\
	((n) < (1UL << 57)) ? 57 : ((n) < (1UL << 58)) ? 58 :	\
	((n) < (1UL << 59)) ? 59 : ((n) < (1UL << 60)) ? 60 :	\
	((n) < (1UL << 61)) ? 61 : ((n) < (1UL << 62)) ? 62 :	\
	((n) < (1UL << 63)) ? 63 : 64)
#else
#define	HIGHBIT_CONST(n)	_HIGHBIT32_CONST(n)
#endif /* _LP64 */

/* Round up to the nearest log2() */
#define	LOG2UP_CONST(n)	(((n) == 0) ? 0 : (HIGHBIT_CONST(n) - ISP2(n)))
