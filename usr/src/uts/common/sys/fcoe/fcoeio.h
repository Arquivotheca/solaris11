...
#define	FCOEIO_SETPROP_FCOE_PORT		(FCOEIO_SUB_CMD + 0x04)
...
#define	FCOE_DCB_PRIORITY	0x00000001
typedef struct fcoeio_setprop_port {
	uint32_t	fsp_mask;
	datalink_id_t	fsp_mac_linkid;
	uint8_t		fsp_priority;
	uint8_t		_fsp_pad[3];
} fcoeio_setprop_port_t;
