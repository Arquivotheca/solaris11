...
extern void mac_rx_bypass_set(mac_client_handle_t, mac_direct_rx_t, void *);
...
extern void mac_resource_set_common(mac_client_handle_t,
    mac_resource_add_t, mac_resource_remove_t, void *);
...
extern int mac_vnic_unicast_set(mac_client_handle_t, const uint8_t *, size_t *);
...
extern int mac_client_open_zone(mac_handle_t, mac_client_handle_t *, char *,
    uint16_t, zoneid_t);
...
extern int mac_link_flow_remove(char *, zoneid_t);
extern int mac_link_flow_modify(char *, mac_resource_props_t *, zoneid_t);
extern int mac_link_flow_createkstat(char *, zoneid_t);
extern int mac_link_setlinkzoneid(datalink_id_t, zoneid_t);
extern int mac_link_setlinkzid(mac_handle_t, zoneid_t);
...
extern int mac_link_flow_info(char *, mac_flowinfo_t *, zoneid_t);

extern void mac_setup_enter(mac_handle_t);
extern void mac_setup_exit(mac_handle_t);
...
extern int mac_deftxring_get(mac_client_handle_t, mac_ring_handle_t *);
extern mac_ring_info_t *mac_hwring_getinfo(mac_ring_handle_t);
...
extern mblk_t *mac_hwring_poll(mac_ring_handle_t, int, int);
...
extern void mac_get_hwrxgrp_ids(mac_handle_t, int, uint_t *);
extern void mac_get_hwrxgrp_info(mac_handle_t, int, uint_t *, uint_t *,
    uint_t *, uint_t *, uint_t *, char *);
extern void mac_get_hwtxgrp_ids(mac_handle_t, int, uint_t *);
...
extern int mac_unicast_default_set(mac_handle_t, const uint8_t *);
extern void mac_unicast_default_get(mac_handle_t, uint8_t *);

extern void mac_get_ringids(mac_client_handle_t, uint_t[], uint_t *,
    boolean_t *, uint_t[], uint_t *, boolean_t *);
