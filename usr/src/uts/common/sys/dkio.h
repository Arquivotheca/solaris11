...
/*
 * allocate all blocks of a zvol (for dump & swap)
 */
#define	DKIOCPREALLOCINIT	(DKIOC | 28)
#define	DKIOCPREALLOCFINI	(DKIOC | 29)
 ...
 *
 * Note: on S10, this is DKIOC|46, which unfortunately clashes with
 * DKIOCSETEXTPART. Since the latter is public and widely used, this got
 * changed instead.
 */
#define	DKIOC_GETDISKID	(DKIOC|50)
...
#define	DKD_ATA_MODEL	41	/* model number length */
#define	DKD_ATA_FWVER	9	/* firmware revision length */
#define	DKD_ATA_SERIAL	21	/* serial number length */

#define	DKD_SCSI_VENDOR	9	/* vendor ID length */
#define	DKD_SCSI_PRODUCT 17	/* product ID length */
#define	DKD_SCSI_REVLEVEL 5	/* revision level length */
#define	DKD_SCSI_SERIAL 13	/* serial number length */
