...
void i_ddi_fm_init(dev_info_t *dip, int *fmcap, ddi_iblock_cookie_t *ibcp);
void i_ddi_fm_fini(dev_info_t *dip);
...
/*
 * Common EC_DEVFS sysevent generation
 */
int
i_ddi_log_event(char *, dev_info_t *, mdi_pathinfo_t *,
	uint64_t, char *, char *, char *, char *, char *, int, uint_t);
...
extern boolean_t dev_path_match_assigned(char *devpath);

/*
 * DVMA space limit
 */
extern int i_ddi_dvma_space(dev_info_t *, int *, dvma_space_t *);
