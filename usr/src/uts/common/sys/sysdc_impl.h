...
typedef struct sysdc {
	...
	pri_t		sdc_minpri;	/* our minimum priority */
	pri_t		sdc_maxpri;	/* our maximum priority */
	...
	uint_t		sdc_sleep_updates; /* nupdates when we slept */
	...
	uint_t		sdc_asleep;	/* currently asleep? */
	pri_t		sdc_pri;	/* our last computed priority */
	pri_t		sdc_epri;	/* our actual thread priority */
