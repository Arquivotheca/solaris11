...
#define	A_BALANCE	24	/* For I/O balancer control */
 ...
 *	The first two are succeeded by AD_SUSPEND and
 *		AD_CHECK respectively.
...
#define	AD_SUSPEND		0	/* CPR/Suspend */
#define	AD_FORCE		1	/* force to do AD_SUSPEND - OBSOLETE */
#define	AD_CHECK_SUSPEND	2	/* test if CPR/Suspend is enabled */
#define	AD_COMPRESS		AD_SUSPEND	/* For compatibility */
#define	AD_CHECK		AD_CHECK_SUSPEND
#define	AD_SUSPEND_TO_DISK	   AD_SUSPEND	/* A_FREEZE, CPR or ACPI S4 */
#define	AD_CHECK_SUSPEND_TO_DISK   AD_CHECK	/* A_FREEZE, CPR/S4 capable? */
/*
 * Specific "Suspend to RAM" entrypoint will be removed sometime in
 * the future, but is retained for compatibility.
 */
#define	AD_SUSPEND_TO_RAM	   20		/* A_FREEZE, Suspend */
#define	AD_CHECK_SUSPEND_TO_RAM	   21		/* A_FREEZE, Suspend capable? */
...
/*
 * Functions of A_BALANCE Private interface
 */
#define	AD_BALANCER_STOP	0	/* disable I/O balancer operation */
#define	AD_BALANCER_START	1	/* enable I/O balancer operation */
