...
#define	DADKIO_FLAG_EXT			0x04	/* 64-bit wide version */
...
/*
 * If DADKIO_FLAG_EXT is set, this structure is used instead, supporting
 * 512-byte block devices larger than 2Tb.
 */
struct dadkio_rwcmd_ext {
	int32_t			cmd;
	int32_t			flags;
	int32_t			pad[2];
	uint64_t		blkaddr;
