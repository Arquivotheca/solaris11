 ...
 * for these devices.
 * We really need to resolve this discrepancy with ACPI.
 */
...
/*
 * This *should* be obsolete, but is used in the internal implementation
 * (good move, obsoleting a crucial function).
 */
int
