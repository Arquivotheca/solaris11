...
/*
 * The vendor properties record the original properties provided
 * in the driver.conf, which may be supplemented with additional
 * properties and/or merged values from the admin set.
 */
#define	DDI_PROP_VENDOR		0x100000
#define	DDI_PROP_ADMIN		0x200000
