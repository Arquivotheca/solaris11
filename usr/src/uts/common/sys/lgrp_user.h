...
#define	LGRP_SYS_AFF_INHERIT_GET	8  /* lgrp_affinity_inherit_get() */
#define	LGRP_SYS_AFF_INHERIT_SET	9  /* lgrp_affinity_inherit_set() */
 ...
 */
#define	LGRP_AFF_INHERIT_DEFAULT	1  /* Default affinity inheritance */
#define	LGRP_AFF_INHERIT_NONE		2  /* No affinity inheritance */
#define	LGRP_AFF_INHERIT_FUTURE		3  /* Affinity inherited by   */
					    /* future children	*/

typedef	int lgrp_aff_inherit_t;
...
/*
 * Arguments to lgrp_aff_inherit_{get,set}()
 */
typedef struct lgrp_aff_inherit_args {
	idtype_t		idtype;		/* ID type */
	id_t			id;		/* ID */
	lgrp_aff_inherit_t	aff_inherit;	/* affinity inheritance */
} lgrp_aff_inherit_args_t;
...
typedef enum lgrp_content {
	LGRP_CONTENT_ALL,	/* everything in lgroup */
	    /* everything in lgroup's hierarchy (for compatibility) */
...
lgrp_aff_inherit_t	lgrp_affinity_inherit_get(idtype_t idtype, id_t id);

int		lgrp_affinity_inherit_set(idtype_t idtype, id_t id,
    lgrp_aff_inherit_t inherit);
...
lgrp_aff_inherit_t	lgrp_affinity_inherit_get();
int			lgrp_affinity_inherit_set();
int			lgrp_children();
