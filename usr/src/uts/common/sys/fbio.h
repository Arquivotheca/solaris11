...
/*
 * register the userland helper with the gfx driver.
 * The kernel communicates with the userland helper via the door interface.
 */
#define	FBIOLOADHNDL	(FIOC|45)

typedef struct fbio_load_handle {
	int	id;			/* upcall door identifier */
} fbio_load_handle_t;
