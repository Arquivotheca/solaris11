...
#define	NO_FAILOVER		0x06u
#define	NO_FAILOVER_MASK	(NO_FAILOVER<<16)
...
#define	MAX_TX_RING_DMA_HDLS		(32 * 1024)
#define	DEFAULT_TX_RING_DMA_HDLS	8192
