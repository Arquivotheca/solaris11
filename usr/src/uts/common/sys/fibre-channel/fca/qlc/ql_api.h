...
#define	VP_ID_NOT_ACQUIRED		BIT_17
#define	IDC_STALL_NEEDED		BIT_18
#define	IDC_STALLED			BIT_19
#define	IDC_RESTART_NEEDED		BIT_20
#define	IDC_ACK_NEEDED			BIT_21
#define	LOOPBACK_ACTIVE			BIT_22
