...
typedef	idm_status_t (transport_buf_alloc_sgl_op_t)(struct idm_buf_s *idb,
    struct stmf_sglist_ent *sglp, uint32_t numbufs, uint32_t flags);
typedef void (transport_buf_free_sgl_op_t)(struct idm_buf_s *idb);
...
typedef struct idm_transport_ops_s {
	...
	transport_buf_alloc_sgl_op_t		*it_buf_alloc_sgl;
	transport_buf_free_sgl_op_t		*it_buf_free_sgl;
} idm_transport_ops_t;
