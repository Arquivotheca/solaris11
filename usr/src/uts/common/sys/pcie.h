...
#define	PCIE_DEVCAP_EP_L0S_LAT_SHIFT	6
...
#define	PCIE_LINKCAP_L0S_EXIT_LAT_SHIFT	12	/* L0s Exit shift */
...
#define	PCIE_LINKCAP_DLL_ACTIVE_REP_CAPABLE	0x100000    /* DLL Active */
							    /* Capable bit */
#define	PCIE_LINKCAP_BW_NOT_CAPABLE	0x200000	/* Link Bandwidth */
							/* Notification */
...
#define	PCIE_LINKCTL_HW_AUT_WIDTH_DIS	0x200	/* Hardware Autonomous */
						/* Width Disable */
#define	PCIE_LINKCTL_BAND_MGT_INT_EN	0x400	/* Bandwidth Management */
						/* Interrupt Enable */
#define	PCIE_LINKCTL_AUTO_BAND_INT_EN	0x800	/* Autonomous Bandwidth */
						/* Interrupt Enable */

/*
 * Link Status Register (2 bytes)
 */
#define	PCIE_LINKSTS_SPEED_2_5		0x1	/* Gen1 Link Speed */
#define	PCIE_LINKSTS_SPEED_5		0x2	/* Gen2 Link Speed */
#define	PCIE_LINKSTS_SPEED_8		0x3	/* Gen3 Link Speed */
#define	PCIE_LINKSTS_SPEED_MASK		0xF	/* Link Speed Mask */
...
/* PCIe v2.0 spec based */
#define	PCIE_LINKSTS_BAND_MGT_STS	0x4000  /* Bandwidth management sts */
#define	PCIE_LINKSTS_AUTO_BAND_STS	0x8000  /* Autonomous bandwidth sts */
 ...
 */
#define	PCIE_DEVCAP2_COM_TO_RANGE_A	0x1
#define	PCIE_DEVCAP2_COM_TO_RANGE_B	0x2
#define	PCIE_DEVCAP2_COM_TO_RANGE_A_B	0x3
#define	PCIE_DEVCAP2_COM_TO_RANGE_B_C	0x6
#define	PCIE_DEVCAP2_COM_TO_RANGE_A_B_C	0x7
#define	PCIE_DEVCAP2_COM_TO_RANGE_B_C_D	0xE
#define	PCIE_DEVCAP2_COM_TO_RANGE_A_B_C_D	0xF
 ...
 */
#define	PCIE_LINKCAP2_LINK_SPEED_2_5	0x2
#define	PCIE_LINKCAP2_LINK_SPEED_5	0x4
#define	PCIE_LINKCAP2_LINK_SPEED_8	0x8
#define	PCIE_LINKCAP2_LINK_SPEED_VECTOR_MASK	0xFE

/*
 * Link Control 2 Register (2 bytes)
 */
#define	PCIE_LINKCTL2_TARGET_LINK_SPEED_MASK	0xF
#define	PCIE_LINKCTL2_HW_AUT_SPEED_DIS		0x20

/*
 * Link Status 2 Register (2 bytes)
 */
#define	PCIE_LINKSTS2_EQU_COMPL		0x2	/* Equalization Complete */
#define	PCIE_LINKSTS2_EQU_PHASE1_SUC	0x4	/* Equalization Phase1 */
						/* Successfully */
#define	PCIE_LINKSTS2_EQU_PHASE2_SUC	0x8	/* Equalization Phase2 */
						/* Successfully */
#define	PCIE_LINKSTS2_EQU_PHASE3_SUC	0x10	/* Equalization Phase3 */
						/* Successfully */
#define	PCIE_LINKSTS2_EQU_REQ		0x20	/* Link Equalization Request */
...
#define	PCIE_EXT_CAP_ID_SRIOV		0x10	/* SR-IOV capabiliry */
#define	PCIE_EXT_CAP_ID_EXT2		0x19	/* Secondary PCIe */
						/* Extended Capability */

#define	PCIE_EXT_CAP_SRIOV_CONTROL_OFFSET		0x08
#define	PCIE_EXT_CAP_SRIOV_INITIAL_VFS_OFFSET		0x0c
#define	PCIE_EXT_CAP_SRIOV_TOTAL_VFS_OFFSET		0x0e
#define	PCIE_EXT_CAP_SRIOV_NUMVFS_OFFSET		0x10
#define	PCIE_EXT_CAP_SRIOV_VF_OFFSET_OFFSET		0x14
#define	PCIE_EXT_CAP_SRIOV_VF_STRIDE_OFFSET		0x16
#define	PCIE_EXT_CAP_SRIOV_VF_DEV_ID_OFFSET		0x1A
#define	PCIE_EXT_CAP_SRIOV_SUPPORTED_PAGE_SIZE_OFFSET	0x1c
#define	PCIE_EXT_CAP_SRIOV_SYSTEM_PAGE_SIZE_OFFSET	0x20
#define	PCIE_EXT_CAP_SRIOV_VF_BAR0_OFFSET		0x24
#define	PCIE_EXT_CAP_SRIOV_VF_BAR1_OFFSET		0x28
#define	PCIE_EXT_CAP_SRIOV_VF_BAR2_OFFSET		0x2c
#define	PCIE_EXT_CAP_SRIOV_VF_BAR3_OFFSET		0x30
#define	PCIE_EXT_CAP_SRIOV_VF_BAR4_OFFSET		0x34
#define	PCIE_EXT_CAP_SRIOV_VF_BAR5_OFFSET		0x38

/*
 * SRIOV CONTROL register (0x08)
 */
#define	PCIE_SRIOV_CONTROL_VF_ENABLE			0x01
#define	PCIE_SRIOV_CONTROL_MS_ENABLE			0x08
#define	PCIE_SRIOV_CONTROL_ARI_CAPABLE_HEIRARCHY	0x10
#if defined(__sparc)
#define	PCICFG_SRIOV_SYSTEM_PAGE_SIZE	2
#else
#define	PCICFG_SRIOV_SYSTEM_PAGE_SIZE	1
#endif
#define	PCIE_SRIOV_VF_DEV_VEN_ID	0xffffffff

#define	PCIE_CONFIG_VF_SUCCESS		(0)
#define	PCIE_CONFIG_VF_FAILURE		(-1)
#define	PCIE_CONFIG_VF_EINVAL		(-2)
#define	PCIE_CONFIG_VF_ENOT_SRIOV	(-3)
#define	PCIE_CONFIG_VF_EINITIAL_VF	(-4)
#define	PCIE_CONFIG_VF_ETOTAL_VF	(-5)
#define	PCIE_CONFIG_VF_ESUPPORTED_PAGE	(-6)
#define	PCIE_CONFIG_VF_EPAGE_NOTSUP	(-7)
#define	PCIE_CONFIG_VF_ESET_PAGE_SIZE	(-8)
#define	PCIE_CONFIG_VF_ECALLBACK_PRE	(-9)
#define	PCIE_CONFIG_VF_ECALLBACK_POST	(-10)
#define	PCIE_CONFIG_VF_ESET_NUMVF	(-11)
#define	PCIE_CONFIG_VF_ESET_CONTROL	(-12)
#define	PCIE_CONFIG_VF_EPROBE_VF	(-13)
#define	PCIE_CONFIG_VF_EVF_OFFSET	(-14)
#define	PCIE_CONFIG_VF_EVF_STRIDE	(-15)
#define	PCIE_CONFIG_VF_EBUS_NOTSUP	(-16)
#define	PCIE_CONFIG_VF_EOFFSET_INVAL	(-17)
#define	PCIE_CONFIG_VF_ESTRIDE_INVAL	(-18)
#define	PCIE_CONFIG_VF_EVF_BAR_ASSIGN	(-19)
#define	PCIE_CONFIG_VF_PF_NOT_ATTACHED	(-20)
/*
...
#define	PCIE_AER_UCE_ACS		0x200000 /* ACS Violation Status */
...
/*
 * SR-IOV VF AER register bitmasks for RsvdP bits
 * XXX ACS violation is not supported yet
 */
#define	PCIE_AER_UCE_VF_MASK		(PCIE_AER_UCE_PTLP | \
    PCIE_AER_UCE_TO | PCIE_AER_UCE_CA | PCIE_AER_UCE_UC | PCIE_AER_UCE_UR)
#define	PCIE_AER_CE_VF_MASK		PCIE_AER_CE_AD_NFE

/*
 * SR-IOV AER register bitmasks for non-function specific error bits
 * which are only logged in PF
 */
#define	PCIE_AER_UCE_PF_MASK		(PCIE_AER_UCE_DLP | \
    PCIE_AER_UCE_SD | PCIE_AER_UCE_FCP | PCIE_AER_UCE_RO | \
    PCIE_AER_UCE_MTLP | PCIE_AER_UCE_ECRC)
#define	PCIE_AER_CE_PF_MASK		(PCIE_AER_CE_RECEIVER_ERR | \
    PCIE_AER_CE_BAD_TLP | PCIE_AER_CE_BAD_DLLP | PCIE_AER_CE_REPLAY_ROLLOVER | \
    PCIE_AER_CE_REPLAY_TO)

#define	PCIE_AER_HLOG_OVFL_VAL		0xffffffff
...
/*
 * PCI-Express Vendor Spec Extended Capability Offsets
 */
#define	PCIE_VSEC_HEADER	0x4	/* Vendor Specific Header */
#define	PCIE_VSEC_LENGTH_MASK	0xFFF00000 /* The length mask of the VSEC */
#define	PCIE_VSEC_LENGTH_SHIFT	20	/* The length mask of the VSEC */
...
/*
 * ACS Capability offsets
 */
#define	PCIE_ACS_HDR		0x0
#define	PCIE_ACS_CAP		0x4
#define	PCIE_ACS_CTL		0x6
#define	PCIE_ACS_EGRESS_CTL_VEC	0x8

#define	PCIE_ACS_CAP_SOURCE_VAL			0x01
#define	PCIE_ACS_CAP_TRANS_BLK			0x02
#define	PCIE_ACS_CAP_P2P_REQ_REDIRECT		0x04
#define	PCIE_ACS_CAP_P2P_COM_REDIRECT		0x08
#define	PCIE_ACS_CAP_UP_FORW			0x10
#define	PCIE_ACS_CAP_P2P_EGRESS_CTL		0x20
#define	PCIE_ACS_CAP_DIRECT_TRANS_P2P		0x40
#define	PCIE_ACS_CAP_EGRESS_VEC_SIZE		0xFF00
#define	PCIE_ACS_CAP_EGRESS_VEC_SHIFT		0x8

#define	PCIE_ACS_CTL_SOURCE_VAL_EN		0x01
#define	PCIE_ACS_CTL_TRANS_BLK_EN		0x02
#define	PCIE_ACS_CTL_P2P_REQ_REDIRECT_EN	0x04
#define	PCIE_ACS_CTL_P2P_COM_REDIRECT_EN	0x08
#define	PCIE_ACS_CTL_UP_FORW_EN			0x10
#define	PCIE_ACS_CTL_P2P_EGRESS_CTL_EN		0x20
#define	PCIE_ACS_CTL_DIRECT_TRANS_P2P_EN	0x40
#define	PCIE_ACS_CTL_MASK	(PCIE_ACS_CTL_SOURCE_VAL_EN | \
	PCIE_ACS_CTL_TRANS_BLK_EN | PCIE_ACS_CTL_P2P_REQ_REDIRECT_EN | \
	PCIE_ACS_CTL_P2P_COM_REDIRECT_EN | PCIE_ACS_CTL_UP_FORW_EN | \
	PCIE_ACS_CTL_P2P_EGRESS_CTL_EN | PCIE_ACS_CTL_DIRECT_TRANS_P2P_EN)

/*
 * Secondary PCI-Express Extended Capability (4 bytes)
 */
#define	PCIE_EXT2_HDR		0x0
#define	PCIE_EXT2_LINKCTL3	0x4

#define	PCIE_EXT2_LINKCTL3_PERF_EQU	0x1	/* Perform Equalization */
#define	PCIE_EXT2_LINKCTL3_EQU_INT_EN	0x2	/* Link Equalization */
						/* Interrupt Enable */
