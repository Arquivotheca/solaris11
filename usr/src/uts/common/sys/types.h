...
/*
 * A suitable alignment for avoiding false sharing problems.
 *
 * While individual hardware platforms have different cache line sizes,
 * we pick a single value for aligning structures for convenience.
 */
#define	FALSE_SHARING_ALIGN	64
