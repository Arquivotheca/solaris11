...
/*
 * MAXLINKNAMESPECIFIER defines the longest possible linkname argument.
 * Linknames can include a zonename prefix to refer to non-global linknames
 * from the global zone. In which the max length of such strings can be
 * MAXLINKNAMELEN (32) plus ZONENAME_MAX (64).
 */
#define	MAXLINKNAMESPECIFIER	96
