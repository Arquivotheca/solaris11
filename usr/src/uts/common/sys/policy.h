...
void priv_policy_errmsg(const cred_t *, int, const char *);
int priv_build_path(vnode_t *, vnode_t *, char *, const char *, const cred_t *,
    boolean_t);
...
int secpolicy_flow_config(const cred_t *);
...
int secpolicy_procfs_kaddr(const cred_t *);
...
int secpolicy_share(const cred_t *);
...
int secpolicy_uvfs_server(const cred_t *);
...
int secpolicy_vnode_chown(const cred_t *cr, struct vfs *, uid_t);
...
int secpolicy_mwac_protected(const cred_t *, vnode_t *);
