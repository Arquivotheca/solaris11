...
#define	MNTTYPE_UVFS 	"uvfs"		/* uvfs file system */
...
#define	MNTOPT_SEMISOFT	"semisoft"	/* partial soft, uncommitted i/f */
...
#define	MNTOPT_SHRZONE	"sharezone"	/* sharing zoneid, only for NGZ */
#define	MNTOPT_SHADOW	"shadow"	/* shadow data migration source */
