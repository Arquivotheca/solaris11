...
/*
 * Indexes for the cp_online_id[] array, which indicates the lowest and
 * highest sequential CPU id's of the online processors in the partition.
 */
#define	CP_ONLINE_LOWER		(0)
#define	CP_ONLINE_UPPER		(1)
...
typedef struct cpupart {
	...
	uint_t		cp_online_ids[2]; /* lowest/highest online CPUs */
} cpupart_t;
...
extern int	cpupart_destroy_locked(psetid_t);
...
extern void	cpupart_update_online_ids(cpupart_t *, cpupart_t *, cpu_t *);
