...
/*
 * ATA/ATAPI commands (subset)
 * Protocol is noted in comment for each command:
 * ND (Non-data), PI (PIO In), PO (PIO Out), DM (DMA), DMQ (DMA Queued),
 * DR (Device Reset), DD (Device Diagnostics), SD (subfunction dependent)
 * M in comment denotes mandatory command (as of ACS2)
 *
 * As commands are added, add them to sata_get_cmd_protocol in sata.c
 */
#define	SATAC_DSM		0x06	/* data set management - SD */
#define	SATAC_DEVICE_RESET	0x08    /* ATAPI device reset - DR */
#define	SATAC_RDSEC		0x20    /* read sector - PI */
#define	SATAC_RDSEC_EXT		0x24    /* read sector extended - LBA48/PI */
#define	SATAC_READ_DMA_EXT	0x25	/* read DMA extended - LBA48/DM */
#define	SATAC_RDMULT_EXT	0x29	/* read multiple extended - LBA48/PI */
#define	SATAC_READ_LOG_EXT	0x2f	/* read log - LBA48/PI */
#define	SATAC_WRSEC		0x30    /* write sector - PO */
#define	SATAC_WRSEC_EXT		0x34    /* write sector extended - LBA48/PO */
#define	SATAC_WRITE_DMA_EXT	0x35	/* read DMA extended - LBA48/DM */
#define	SATAC_WRMULT_EXT	0x39	/* read multiple extended - LBA48/PO */
#define	SATAC_RDVER		0x40	/* read verify - ND */
#define	SATAC_READ_FPDMA_QUEUED	0x60	/* First-Party-DMA read queued - DMQ */
#define	SATAC_WRITE_FPDMA_QUEUED 0x61	/* First-Party-DMA write queued - DMQ */
#define	SATAC_DIAG		0x90    /* device diagnostics - DD - M */
#define	SATAC_DOWNLOAD_MICROCODE 0x92   /* download microcode - PO */
#define	SATAC_DLOAD_MCODE_DMA	0x93	/* download microcode DMA - DM */
#define	SATAC_PACKET		0xa0	/* ATAPI packet */
#define	SATAC_SMART		0xb0	/* SMART - ND */
#define	SATAC_RDMULT		0xc4	/* read multiple - PI */
#define	SATAC_WRMULT		0xc5	/* write multiple - PO */
#define	SATAC_SETMULT		0xc6	/* set multiple mode - ND */
#define	SATAC_READ_DMA		0xc8	/* read w/DMA - DM */
#define	SATAC_WRITE_DMA		0xca	/* write w/DMA - DM */
#define	SATAC_ID_PACKET_DEVICE	0xa1	/* identify packet device - PI/M */
#define	SATAC_STANDBY_IM	0xe0	/* standby immediate - ND */
#define	SATAC_IDLE_IM		0xe1	/* idle immediate - ND */
#define	SATAC_STANDBY		0xe2	/* standby - ND */
#define	SATAC_IDLE		0xe3	/* idle	- ND */
#define	SATAC_READ_BUFFER	0xe4	/* read buffer - PI */
#define	SATAC_CHECK_POWER_MODE	0xe5	/* check power mode - ND/M */
#define	SATAC_SLEEP		0xe6	/* sleep - ND/M */
#define	SATAC_FLUSH_CACHE	0xe7	/* flush cache - ND */
#define	SATAC_WRITE_BUFFER	0xe8	/* write buffer - PO */
#define	SATAC_READ_BUFFER_DMA	0xe9	/* read buffer DMA - DM */
#define	SATAC_FLUSH_CACHE_EXT	0xea	/* flush cache ext - ND */
#define	SATAC_WRITE_BUFFER_DMA	0xeb	/* write buffer DMA - DM */
#define	SATAC_ID_DEVICE		0xec    /* identify device - PI/M */
#define	SATAC_SET_FEATURES	0xef	/* set features	- ND/M */

/*
 * Obsolete ATA Commands
 * Either remove or flag in the future.
 */
/* as of ATA4 */
...
/*
 * Port Multiplier Commands (redefined from ATA/ATAPI spec)
 * Along the way duplicate definitions were created.
 */
#define	SATAC_READ_PORTMULT	0xe4	/* read port multiplier */
#define	SATAC_READ_PM_REG	SATAC_READ_PORTMULT
#define	SATAC_WRITE_PORTMULT	0xe8	/* write port multiplier */
#define	SATAC_WRITE_PM_REG	SATAC_WRITE_PORTMULT

/*
 * Power Managment Mode/State
 */
...
/* ATA data transfer protocols */
#define	SATA_PROTOCOL_UNKNOWN		0
#define	SATA_PROTOCOL_DMA		1
#define	SATA_PROTOCOL_PIO_IN		2
#define	SATA_PROTOCOL_PIO_OUT		3
#define	SATA_PROTOCOL_NONDATA		4
#define	SATA_PROTOCOL_PACKET		5
#define	SATA_PROTOCOL_DIAG		6
#define	SATA_PROTOCOL_RESET		7
