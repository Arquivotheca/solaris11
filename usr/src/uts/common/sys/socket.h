...
/*
 * Types
 * Update lib/libinetutil/common/inetutil.c when new types are added.
 */
#if !defined(_XPG4_2) || defined(__EXTENSIONS__)
...
#define	SO_REUSEPORT	0x100e		/* allow local port reuse */
#define	SO_PASSIVE_CONNECT	0x100f	/* do passive connect */
 ...
 * in sync.
 * Also update lib/libinetutil/common/inetutil.
 */
...
#define	AF_INET_SDP	33		/* SDP socket */
