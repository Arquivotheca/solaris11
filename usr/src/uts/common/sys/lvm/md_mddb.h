...
#define	MD_PRV_COMMIT		0x0004	/* Record pending to be committed */
...
#define	MDDB_DEVID_CONV		0x0004  /* LB conversion in progress */
...
/*
 * Given a minor name string, identify it as associated
 * with a standard ctd style device ("h" or "g,raw") or a
 * SunCluster did device ("20,20s6,raw" or "23,23s6,blk").
 */
#define	UNK_MIN_NM	0x0
#define	STD_MIN_NM	0x1
#define	DID_MIN_NM	0x2

#define	MIN_NM_TYPE(str, typ) {\
