...
extern int	md_devid_supported_in_did(void);
extern int	md_compare_minors(char *, char *);
...
extern void	md_alter_sidenos(mddb_set_t *s, side_t side);
extern side_t	md_side_in_namespace(mddb_set_t *s);
extern void	md_cull_sides(mddb_set_t *s);
extern int	md_xlate_namespace(mddb_set_t *s);
extern int	md_xlate_minors(mddb_set_t *s);
...
/* Return/state values for md_devid_supported_in_did() */
#define	MD_DEVID_NOT_SUPPORTED	0
#define	MD_DEVID_SUPPORTED	1
#define	MD_DEVID_NO_INIT	2
