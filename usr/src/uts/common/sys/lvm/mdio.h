...
/*
 * Flag values for l_flags
 *
 * MDDB_DEVID_TRANSPLANT	- associated locator has been transplanted
 */
#define	MDDB_DEVID_TRANSPLANT	0x0001
...
#define	MD_DID_DEVID		(MDIOC|110) /* devid support in SC did driver */
