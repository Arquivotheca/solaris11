...
/*
 * SAP value definitions for DLPI_ANY_SAP mode are given below
 * DLPI clients don't care about packet SAP value in this mode.
 */
#define	DL_TPR_ANY_SAP		0x02	/* SAP value for Token Ring */
#define	DL_ANY_SAP		0x00	/* SAP value for other media types */
...
#define	DL_NOTE_FC_MODE		0x4000	/* Flow Control mode */
...
/* Private information passed as notification when flow control mode chanegs */
typedef struct dl_fc_info_s {
	uint32_t	dfi_mode;
	uint8_t		dfi_pfc;
	uint8_t		dfi_ntc;
} dl_fc_info_t;
