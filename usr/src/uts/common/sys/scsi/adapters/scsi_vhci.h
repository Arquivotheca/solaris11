...
/*
 * VHCI_DEBUG_DEFAULT_VAL is used to initialize vhci_debug in both debug and
 * non-debug version.
 */
...
typedef struct scsi_vhci_lun {
	...
	int			svl_ref_cnt; /* Reference count */
} scsi_vhci_lun_t;
...
/*
 * This flag is used to refresh path states for implicit arrays
 * that do not support target UNIT ATTENTION queuing.
 */
#define	VLUN_UPDATE_PATH_ON_RESET	0x20

/*
 * This flag is set to tell vhci_update_pathstates to keep the
 * vlun being held.
 */
#define	VLUN_KEEP_HELD			0x21
