...
#define	PMCS_MSGU_AAP_CPU_SOFT_RST_RDY	0x08
#define	PMCS_MSGU_AAP_ERROR_MASK	0xffffff00
 ...
 */
#define	PMCS_IOP_STATE_MASK		0x03
#define	PMCS_IOP_STATE_POR		0
#define	PMCS_IOP_STATE_SOFT_RESET	1
#define	PMCS_IOP_STATE_ERROR		2
#define	PMCS_IOP_STATE_READY		3
#define	PMCS_IOP_HOST_SOFT_RST_RDY	0x04
#define	PMCS_IOP_CPU_SOFT_RST_RDY	0x08
#define	PMCS_IOP_ERROR_MASK		0xfffffc00
...
#define	GSM_FLASH_ILA				(GSM_FLASH_BASE + 0x000000)
#define	GSM_FLASH_REG_DUMP_AAP1			(GSM_FLASH_BASE + 0x290000)
#define	GSM_FLASH_EVT_LOG_AAP1			(GSM_FLASH_BASE + 0x2A0000)
#define	GSM_FLASH_IMG_FLAGS			(GSM_FLASH_BASE + 0x400000)
#define	GSM_FLASH_REG_DUMP_IOP			(GSM_FLASH_BASE + 0x690000)
#define	GSM_FLASH_EVT_LOG_IOP			(GSM_FLASH_BASE + 0x6A0000)

/*
 * The register dumps, if they exist, will begin with the string "PMC-".  They
 * are human-readable.  The event logs, if they exist, begin with the respective
 * event log signature (PMCS_FWLOG_IOP_SIG or PMCS_FWLOG_AAP1_SIG)
 */
#define	GSM_FLASH_REG_DUMP_SIZE			0x4000
#define	GSM_FLASH_REG_DUMP_SIG			0x504D432D	/* "PMC-" */
#define	GSM_FLASH_EVT_LOG_SIZE			GSM_FLASH_REG_DUMP_SIZE

/*
 * There are a total of 2 register dumps and 2 event logs, each 0x4000 bytes
 */
#define	PMCS_FLASH_REG_DUMP_SIZE		(GSM_FLASH_REG_DUMP_SIZE * 4)
