...
/*
 * Special STATUS returned when RETURN_ERROR_ON_OUT_OF_IOST_RESOURCE
 * condition is met. Only when Fairness Queue Algorithm is enabled on chip.
 */
#define	PMCOUT_STATUS_IO_RESOURCES_LOW					0x1004
