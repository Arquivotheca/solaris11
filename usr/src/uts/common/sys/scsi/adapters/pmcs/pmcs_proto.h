...
boolean_t pmcs_remove_device(pmcs_hw_t *, pmcs_phy_t *);
void pmcs_handle_dead_phys(pmcs_hw_t *);

int pmcs_acquire_scratch(pmcs_hw_t *);
void pmcs_release_scratch(pmcs_hw_t *, int);
void *pmcs_get_scratch_area(pmcs_hw_t *, int);
uint64_t pmcs_get_scratch_dma_area(pmcs_hw_t *, int);
...
/*
 * Handles broadcast event processing in worker thread context
 */
void pmcs_process_broadcast_event(pmcs_hw_t *);
...
int pmcs_sata_identify(pmcs_hw_t *, pmcs_phy_t *, int);
void pmcs_sata_work(pmcs_hw_t *);
void pmcs_abort_completion_work(pmcs_hw_t *);
...
int pmcs_get_nvmd(pmcs_hw_t *pwp, pmcs_nvmd_type_t nvmd_type, uint8_t nvmd,
    uint32_t offset, char *buf, uint32_t size_left, boolean_t);
...
void pmcs_flush_all_tgts_queues(pmcs_hw_t *);
...
void pmcs_register_device_work(pmcs_hw_t *);
void pmcs_deregister_device_work(pmcs_hw_t *);
...
void pmcs_process_sysevent(pmcs_hw_t *);
...
/*
 * Read register dumps into memory so they can be easily retrieved
 */
uint32_t pmcs_load_register_dumps(pmcs_hw_t *, caddr_t, uint32_t, boolean_t);

/*
 * Complete processing of SATA PHY UP
 */
void pmcs_sata_phy_up(pmcs_hw_t *);

/*
 * Get/mark/clear an iport as having had something underneath change
 */
boolean_t pmcs_get_iport_changed(pmcs_iport_t *);
void pmcs_set_iport_changed(pmcs_iport_t *);
boolean_t pmcs_clear_iport_changed(pmcs_iport_t *);
