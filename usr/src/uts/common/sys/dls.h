...
#define	DLS_PROMISC_ALL		(DLS_PROMISC_SAP | DLS_PROMISC_MULTI |	\
				DLS_PROMISC_PHYS)
...
extern int	dls_promisc(dld_str_t *, uint32_t, boolean_t);
...
extern int		dls_devnet_create(mac_handle_t, datalink_id_t,
			    zoneid_t);
extern int		dls_devnet_create_zone(mac_handle_t, datalink_id_t,
			    zoneid_t, zoneid_t);
...
extern int		dls_devnet_get_onloan(mac_handle_t,
			    boolean_t *);
...
extern int		dls_devnet_macname2linkid(const char *,
			    datalink_id_t *);
extern int		dls_devnet_get_active_linkid(const char *, zoneid_t,
			    datalink_id_t *);
extern int		dls_devnet_get_active_linkname(datalink_id_t,
			    zoneid_t *, char *, size_t);
extern void		dls_mgmt_update_vlink(datalink_id_t, datalink_id_t,
