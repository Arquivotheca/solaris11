...
typedef uintptr_t rdsv3_af_procspec_t;
...
rdsv3_af_procspec_t rdsv3_af_procspec();

rdsv3_af_thr_t *rdsv3_af_thr_create(rdsv3_af_thr_drain_func_t fn, void *data,
    uint_t flag, rdsv3_af_grp_t *hcagp, rdsv3_af_procspec_t procspec, char *);
rdsv3_af_thr_t *rdsv3_af_intr_thr_create(rdsv3_af_thr_drain_func_t fn,
    ...
    rdsv3_af_procspec_t procspec, char *);
