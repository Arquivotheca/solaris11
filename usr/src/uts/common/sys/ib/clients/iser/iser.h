...
/* iSER ZCOPY parameters, for cards that support Reserved LKey */
#define	ISER_COPY_THRESHOLD	4 * 1024
 ...
 */
typedef enum {
	ISER_IBT_STATE_ATTACHING,
	ISER_IBT_STATE_ATTACHED,
	ISER_IBT_STATE_DETACHING
} iser_ibt_state_t;
