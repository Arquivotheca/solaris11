...
typedef struct iser_hca_s {
	...
	idm_refcnt_t		hca_refcnt;
	ibt_hca_attr_t		hca_attr;
	ibt_pd_hdl_t		hca_pdhdl;
	ib_guid_t		hca_guid;
	uint_t			hca_num_ports;
	uint_t			hca_max_sgl_size;
...
#define	ISER_IB_RQ_SGLIST_SIZE	1
...
void iser_ib_hca_hold(iser_hca_t *hca);
void iser_ib_hca_rele(iser_hca_t *hca);
