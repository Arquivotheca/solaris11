...
struct hermon_sw_mr_s {
	...
	uint64_t		*mr_mpt_table;	/* FMR: mr_mptrsrcp->hr_addr */
	uint32_t		mr_fmr_indx;	/* FMR: mr_mptrsrcp->hr_indx */
...
uint32_t hermon_mr_keycalc(hermon_state_t *state, uint32_t indx);
