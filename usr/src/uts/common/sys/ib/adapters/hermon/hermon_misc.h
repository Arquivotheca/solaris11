 ...
 */
#define	HERMON_NUM_MCG_SHIFT		0xb
 ...
 */
#define	HERMON_NUM_MCG_HASH_SHIFT	0x7
...
int hermon_set_udav(hermon_state_t *state, ibt_adds_vect_t *av,
    hermon_hw_udav_t *udav);
int hermon_set_addr_path(hermon_state_t *state, ibt_adds_vect_t *av,
    hermon_hw_addr_path_t *path);
void hermon_get_udav(hermon_state_t *state, hermon_hw_udav_t *udav,
    ibt_adds_vect_t *av);
