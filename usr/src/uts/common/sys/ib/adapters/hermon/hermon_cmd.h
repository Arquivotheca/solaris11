 ...
 * mailboxes (256 in, 256 out), as 256 interrupts is the max allowed.
 */
#define	HERMON_NUM_MAILBOXES_SHIFT	0xA
#define	HERMON_NUM_INTR_MAILBOXES_SHIFT	8
 ...
 * QUERY_EQ, and QUERY_CQ.  Note that QUERY_QP now has its own function.
...
/* The QP specific query function */
int hermon_qp_query_cmd_post(hermon_state_t *state, uint_t opcode,
    uint_t opmod, uint_t queryindx, void *query, uint_t size, uint_t sleepflag);
