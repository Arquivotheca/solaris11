...
struct sock_proto_props {
	...
	ssize_t	sopp_pm_min;		/* Minimum write size for premapped */
	ssize_t	sopp_pm_max;		/* Maximum write size for premapped */
...
/* flags to determine which socket properties are set */
...
#define	SOCKOPT_PREMAPPED_MIN	0x2000
#define	SOCKOPT_PREMAPPED_MAX	0x4000
#define	SOCKOPT_STRICT_BACKLOG	0x8000	/* strict backlog value */
...
struct sock_upcalls_s {
	...
	void	(*su_set_pmh)(sock_upper_handle_t, pm_handle_t);
};
