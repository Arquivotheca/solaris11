...
/* HID LSR state */
#define	HID_LSR_SUSPENDED	1

/* HID LSR Capabilities */
#define	HID_CB_LSR_ACTIVITIES	(DDI_CB_LSR_ACT_DMA | \
				    DDI_CB_LSR_ACT_PIO | \
				    DDI_CB_LSR_ACT_INTR)
#define	HID_CB_LSR_IMPACTS	(DDI_CB_LSR_IMP_DMA_ADDR_CHANGE | \
...
typedef struct hid_state {
	...
	/* HID LSR state */
	uint_t			hid_lsr_state;
	uint_t			hid_lsr_activities;
	uint_t			hid_lsr_impacts;
	boolean_t		hid_lsr_polled;
...
#define	PRINT_MASK_LSR		0x00000020
