...
extern int	ehci_live_suspend(ehci_state_t		*ehcip);
extern int	ehci_live_resume(ehci_state_t		*ehcip);
extern int	ehci_lsr_capability(ehci_state_t	*ehcip,
				void			*cbarg);

extern void ehci_fm_init(ehci_state_t *ehcip);
extern void ehci_fm_ereport(ehci_state_t *ehcip, char *detail);
extern int ehci_check_acc_handle(ehci_state_t *ehcip, ddi_acc_handle_t handle);
extern int ehci_check_dma_handle(ehci_state_t *ehcip, ddi_dma_handle_t handle);
