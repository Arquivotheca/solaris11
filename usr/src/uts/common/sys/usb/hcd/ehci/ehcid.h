...
typedef struct ehci_state {
	...
	ddi_cb_handle_t		ehci_cb_hdl;		/* EHCI cb handler */
	...
	/* EHCI Host Controller LSR State */
	uint_t			ehci_hc_lsr_state;
	uint_t			ehci_hc_lsr_activities;
	uint_t			ehci_hc_lsr_impacts;
...
_NOTE(DATA_READABLE_WITHOUT_LOCK(ehci_state_t::ehci_itd_pool_dma_handle))
...
/*
 * Define EHCI LSR State
 */
#define	EHCI_LSR_SUSPENDED		1

/*
 * Define EHCI LSR Capability
 */
#define	EHCI_CB_LSR_ACTIVITIES		(DDI_CB_LSR_ACT_DMA | \
					    DDI_CB_LSR_ACT_PIO | \
					    DDI_CB_LSR_ACT_INTR)
#define	EHCI_CB_LSR_IMPACTS		(DDI_CB_LSR_IMP_DMA_ADDR_CHANGE | \
...
#define	EHCI_DOORBELL_TIMEWAIT		1000 /* HC door bell waiting time */
#define	EHCI_DOORBELL_WAIT_COUNT	1000 /* HC door bell waiting count */
...
#define	PRINT_MASK_LSR		0x00000200	/* LSR info */
