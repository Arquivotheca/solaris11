...
#define	SIOCCLIFFLAGS	 _IOWR('i', 147, struct lifreq) /* change if flags */

/* 148 was SIOC*TUNPARAM ioctl.  Feel free to re-use. */
 ...
 * 183 can be reused (was consolidation-private SIOCSENABLESDP).
 */
...
/*
 * IOCTL for SCTP new functions calls.
 */
#define	SIOCSCTPCTX	_IOWN('i', 193, 16)	/* sctp_connectx */
#define	SIOCSCTPSNDV	_IOWRN('i', 194, 16)	/* sctp_sendv */
