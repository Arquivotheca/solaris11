...
typedef struct credgrp credgrp_t;
...
extern struct credgrp *crgrpalloc(int);
extern gid_t *crgrpgetgroups(struct credgrp *);
extern int crgrpgetngroups(struct credgrp *);
extern void crgrphold(struct credgrp *);
extern void crgrprele(struct credgrp *);
extern void crgrpsort(struct credgrp *);
