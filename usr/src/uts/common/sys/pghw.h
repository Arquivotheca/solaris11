...
/*
 * Hardware type and platform specific routines to specify mappings
 * between priorities and utilization levels.
 */
extern boolean_t	pghw_pri_util(pghw_type_t, pg_pri_util_spec_t *);
extern boolean_t	pg_plat_pri_util(pghw_type_t, pg_pri_util_spec_t *);
