...
uint64_t mdi_pi_get_cna_dev(mdi_pathinfo_t *);
void mdi_pi_set_cna_dev(mdi_pathinfo_t *, uint64_t);
...
/* Support vHCI representation of a merged/combined pHCI ddi_dma_attr_t */
void mdi_devi_set_dma_attr(dev_info_t *, ddi_dma_attr_t *);
