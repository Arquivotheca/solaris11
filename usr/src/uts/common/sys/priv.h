...
#define	PRIVSYS_ZONE_LOCK	10
#define	PRIVSYS_ZONE_UNLOCK	11
#define	PRIVSYS_ZONE_LOCK_TEMP	12 /* temporary */
#define	PRIVSYS_ZONE_MWAC_WHITE_LIST	13 /* download mwac white list */
#define	PRIVSYS_ZONE_MWAC_BLACK_LIST	14 /* download mwac black list */
#define	PRIVSYS_ZONE_TRANSIENT_RW	15 /* mark zone transient rw */
