...
#define	HW_FCOE			0x20	/* On Transmit: hardware does */
					/* FCoE offload */
					/* On Receive: N/A */

#define	HCK_FCOE_FC_CRC_OK	0x40	/* On Transmit: N/A */
					/* On Receive: FC CRC status */
					/* If set, implies FC CRC */
					/* computation was successful */
					/* i.e. CRC was correct. If it's */
					/* not set, FCoE software will */
					/* re-check the CRC value to */
					/* determine if CRC was bad */

#define	HW_HASH			0x80	/* Rx hash */
