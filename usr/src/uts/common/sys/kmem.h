...
extern void kmem_dump_patch(void (*)(void *, size_t), size_t *);
...
extern void kmem_cache_reap_all_now(kmem_cache_t *);
extern void kmem_cache_move_notify(kmem_cache_t *, void *);
extern void kmem_cache_set_magsize_max(kmem_cache_t *, short);
