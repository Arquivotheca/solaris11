...
lgrp_t			*lgrp_phys_to_lgrp(u_longlong_t);  /* numat driver */
int			lgrp_privm_policy_set(lgrp_mem_policy_t,
    lgrp_mem_policy_info_t *, size_t);
...
lgrp_mem_policy_info_t	*lgrp_shm_policy_get(struct anon_map *, ulong_t,
    vnode_t *, u_offset_t);
int			lgrp_shm_policy_set(lgrp_mem_policy_t,
    struct anon_map *, ulong_t, vnode_t *, u_offset_t, size_t);
lgrp_mem_policy_t	lgrp_shmadv_to_policy(uint_t);
...
lpl_t	*lgrp_affinity_best(kthread_t *, struct cpupart *, lgrp_id_t,
    boolean_t);
void	lgrp_affinity_init(lgrp_aff_t **);
void	lgrp_affinity_free(lgrp_aff_t **);
...
uint_t	lgrp_plat_dev_init(dev_info_t *, lgrp_handle_t **);
boolean_t lgrp_plat_use_all_hw_threads(void);
