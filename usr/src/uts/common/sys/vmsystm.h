...
/*
 * Threads which are involved with pushing pages to disk.  They have
 * dispensation to tap the pageout reserve instead of sleeping for memory,
 * since deadlock may occur if they do sleep.
 */
#define	NOMEMWAIT()	((curthread->t_flag & T_PUSHPAGE) != 0)
