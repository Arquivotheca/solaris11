...
/* For tcpcong modules. */
struct modltcpcong {
	struct mod_ops		*tcpcong_modops;
	char			*tcpcong_linkinfo;
	struct tcpcong_ops_s	*tcpcong_ops;
};
...
#define	MODHPOPS_INSTALL		5
#define	MODHPOPS_UNINSTALL		6

/*
 * subcmds for MODIOVOPS
 */
#define	MODIOVOPS_GET_PF_LIST		1
...
extern void add_spec(struct hwc_spec *, struct par_list **);
