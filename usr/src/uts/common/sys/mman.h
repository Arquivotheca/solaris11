...
#define	MAP_OSM		0x2000		/* OSM segment. */
#endif /* _KERNEL */
 ...
 * address of mapping on success and (void *)-1 on error.
 */
#ifdef	__STDC__
#if _POSIX_C_SOURCE > 2 || defined(_XPG4_2) || \
	(!defined(__XOPEN_OR_POSIX) && !defined(__USE_LEGACY_PROTOTYPES__))
...
#define	MADV_ACCESS_MANY_PSET	9	/* many processes in pset to access */
					/* heavily */
#endif	/* (_POSIX_C_SOURCE <= 2) && !defined(_XPG4_2) ...  */
...
#define	MC_LOCK_GRANULE	8		/* allocate, lock granule size memory */
#define	MC_UNLOCK_GRANULE 9		/* unlock, free granule size memory */
