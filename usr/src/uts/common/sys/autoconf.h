...
struct devnames {
	...
	ddi_prop_list_t	*dn_vdr_global_props; /* delivered global props */
	ddi_prop_list_t	*dn_adm_global_props; /* site global props */
};
...
extern void i_ddi_di_cache_invalidate(dev_info_t *dip, mdi_pathinfo_t *pip);
