...
#define	KMEM_NON_PAGEABLE	0x200	/* locked kernel memory */
#define	UMEM_LOCKED		0x400	/* locked user process memory */
#define	UMEM_TRASH		0x800	/* trash page mapping */
#define	UMEM_LOCKED_PP		0x080	/* locked user process memory pages */
...
#define	DEVMAP_LOCK_INITED		0x200	/* locks are initialized */
