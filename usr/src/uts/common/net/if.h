...
#define	IFF_PROBER	0x80000000000ll	/* attempting interface recovery */
...
/* For SIOCCLIFFLAGS */
typedef struct lif_cflags_req {
	uint64_t	lcr_modflags; /* flags to be modified on the if */
...
#define	lifr_cflags	lifr_lifru.lifru_cflags_req /* SIOCCLIFFLAGS */
};
...
typedef struct ifa_msghdr {
	...
	int	ifam_metric;	/* value of ill_metric */
} ifa_msghdr_t;
