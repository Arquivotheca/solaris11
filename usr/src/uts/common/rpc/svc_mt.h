...
SVCXPRT *svc_dg_xprtcopy(SVCXPRT *);
SVCXPRT *svc_vc_xprtcopy(SVCXPRT *);
SVCXPRT *svc_fd_xprtcopy(SVCXPRT *);
SVCXPRT *svc_copy(SVCXPRT *);
void svc_xprt_free(SVCXPRT *);
void svc_xprt_destroy(SVCXPRT *);
void svc_dg_xprtfree(SVCXPRT *);
void svc_vc_xprtfree(SVCXPRT *);
void svc_fd_xprtfree(SVCXPRT *);
void svc_door_xprtfree(SVCXPRT *);
void svc_args_done(SVCXPRT *);
void _svc_dg_destroy_private(SVCXPRT *);
void _svc_vc_destroy_private(SVCXPRT *, bool_t);
void _svc_destroy_private(SVCXPRT *);

#define	RPC_DOOR_DIR		_PATH_SYSVOL "/rpc_door"
#define	RPC_DOOR_RENDEZVOUS	_PATH_SYSVOL "/rpc_door/rpc_%d.%d"
