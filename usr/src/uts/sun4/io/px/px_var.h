...
struct px {
	...
	/* IOV related fields */
	ddi_cb_handle_t		px_fm_cb_hdl;	/* Event handler */
	ddi_taskq_t		*px_fm_tq;	/* Error taskq */
	kmutex_t		px_fm_tq_mutex;	/* Taskq mutex */
	int			px_fm_tq_state;	/* Taskq state */
	uint_t			px_fm_seg_count; /* FMA data seg num */
	uint64_t		px_fm_data_id;	/* Unique transfer id */
	pcie_fm_tq_arg_t	px_fm_tq_arg;	/* Taskq arg */
};
