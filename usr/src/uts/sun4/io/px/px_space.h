...
extern uint_t px_dvma_space_shrink;
extern int64_t px_dvma_top_cache_quantum;
extern int64_t px_dvma_cache_quantum;

extern uint8_t px_dvma_mapc_slice;
extern uint8_t px_dvma_mapc_scale;
