...
#define	PX_DMAI_FLAGS_KMEM1		0x100000
#define	PX_DMAI_FLAGS_KMEM2		0x200000
#define	PX_DMAI_FLAGS_KMEM8		0x800000
#define	PX_DMAI_FLAGS_VMEM16		0x1000000
#define	PX_DMAI_FLAGS_VMEM1M		0x2000000
#define	PX_DMAI_FLAGS_FAILSAFE		0x4000000
#define	PX_DMAI_FLAGS_VMEM	(PX_DMAI_FLAGS_KMEM1 | PX_DMAI_FLAGS_KMEM2 | \
	PX_DMAI_FLAGS_KMEM8 | PX_DMAI_FLAGS_VMEM16 | PX_DMAI_FLAGS_VMEM1M | \
	PX_DMAI_FLAGS_FAILSAFE)
...
extern int px_dvma_space(dev_info_t *dip, dev_info_t *rdip,
	int *nrec, dvma_space_t *rec);
