...
amd_iommu_acpi_ivhd_t *amd_iommu_lookup_ivhd(int seg, int32_t deviceid);
int amd_iommu_acpi_init_devtbl(amd_iommu_t *iommu);
void amd_iommu_acpi_rsvd_mem(dev_info_t *dip, iommu_pci_info_t *pinfo,
