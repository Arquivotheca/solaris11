...
/*
 * This is the hardware definition of an x86 CPU.  There should be one
 * of these structs for each installed CPU for suspend/resume to work
 * properly.  Be cautious, though, of blowing the stack.
 */
