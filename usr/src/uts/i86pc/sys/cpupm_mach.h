...
/*
 * Intel specific power management feature data structure
 */
typedef struct cpupm_intel {
	void	*turbo;		/* Dynamic Acceleration feature */
	void	*rapl;		/* Running Average Power Limit */
} cpupm_intel_t;
