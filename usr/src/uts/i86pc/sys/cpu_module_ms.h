 ...
 *
 * CMS_ERRSCOPE_ASYNC indicates that the error was detected by an
 * agent that is not related to the current operation. We can keep the
 * operation continue in this situation.
 */
...
#define	CMS_ERRSCOPE_ASYNC		0x20
