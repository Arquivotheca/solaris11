...
#ifndef _SYS_WM_PCBE_H
#define	_SYS_WM_PCBE_H
...
#define	EVENTS_FAM6_WM							\
									\
{ 0x03, 0x02, C0|C1|C2|C3, "load_block.overlap_store" },		\
{ 0x04, 0x07, C0|C1|C2|C3, "sb_drain.any" },				\
{ 0x05, 0x02, C0|C1|C2|C3, "misalign_mem_ref.store" },			\
...
{ 0x08, 0x04, C0|C1|C2|C3, "dtlb_load_misses.walk_cycles" },		\
...
{ 0x0E, 0x02, C0|C1|C2|C3, "uops_issued.fused" },			\
									\
{ 0x0F, 0x01, C0|C1|C2|C3, "mem_uncore_retired.unknown_source" },	\
...
{ 0x49, 0x04, C0|C1|C2|C3, "dtlb_misses.walk_cycles" },			\
...
{ 0x4F, 0x10, C0|C1|C2|C3, "ept.walk_cycles" },				\
									\
{ 0x51, 0x01, C0|C1,	   "l1d.repl" },				\
{ 0x51, 0x02, C0|C1,	   "l1d.m_repl" },				\
{ 0x51, 0x04, C0|C1,	   "l1d.m_evict" },				\
{ 0x51, 0x08, C0|C1,	   "l1d.m_snoop_evict" },			\
{ 0x52, 0x01, C0|C1|C2|C3, "l1d_cache_prefetch_lock_fb_hit" },		\
									\
{ 0x60, 0x01, C0,	   "offcore_requests_out.demand.read_data" },	\
{ 0x60, 0x02, C0,	   "offcore_requests_out.demand.read_code" },	\
{ 0x60, 0x04, C0,	   "offcore_requests_out.demand.read_rfo" },	\
{ 0x60, 0x08, C0,	   "offcore_requests_outstanding.any_read" },	\
									\
...
{ 0x85, 0x04, C0|C1|C2|C3, "itlb_misses.walk_cycles" },			\
{ 0x85, 0x80, C0|C1|C2|C3, "itlb_misses.large_walk_completed" },	\
									\
...
{ 0xB0, 0x02, C0|C1|C2|C3, "offcore_requests.demand.read_code" },	\
...
{ 0xB1, 0x1F, C0|C1|C2|C3, "uops_executed.core_act_cycles_no_port5" },	\
...
{ 0xB3, 0x01, C0,	   "snoopq_requests_outstanding.data" },	\
{ 0xB3, 0x02, C0,	   "snoopq_requests_outstanding.invalidate" },	\
{ 0xB3, 0x04, C0,	   "snoopq_requests_outstanding.code" },	\
									\
{ 0xB4, 0x01, C0|C1|C2|C3, "snoopq_requests.data" },			\
{ 0xB4, 0x02, C0|C1|C2|C3, "snoopq_requests.invalidate" },		\
{ 0xB4, 0x04, C0|C1|C2|C3, "snoopq_requests.code" },			\
									\
...
{ 0xC4, 0x04, C0|C1|C2|C3, "br_inst_retired.all_branches" },		\
									\
{ 0xC5, 0x01, C0|C1|C2|C3, "br_misp_retired.conditional" },		\
{ 0xC5, 0x02, C0|C1|C2|C3, "br_misp_retired.near_call" },		\
{ 0xC5, 0x04, C0|C1|C2|C3, "br_misp_retired.all_branches" },		\
									\
...
{ 0xD1, 0x01, C0|C1|C2|C3, "uops_decoded.stall_cycles" },		\
...
{ 0xF2, 0x0F, C0|C1|C2|C3, "l2_lines_out.any" },			\
									\
{ 0xF4, 0x04, C0|C1|C2|C3, "sq_misc.lru_hints" },			\
...
#define	EVENTS_FAM6_WM_EP_ONLY						\
									\
{ 0x0F, 0x02, C0|C1|C2|C3, "mem_uncore_retired.other_core_l2_hit" },	\
{ 0x0F, 0x04, C0|C1|C2|C3, "mem_uncore_retired.remote_hitm" },		\
{ 0x0F, 0x08, C0|C1|C2|C3, "mem_uncore_retired.local_dram_remote_cache_hit" },\
{ 0x0F, 0x10, C0|C1|C2|C3, "mem_uncore_retired.remote_dram" },		\
{ 0x0F, 0x20, C0|C1|C2|C3, "mem_uncore_retired.other_llc_miss" }

#define	EVENTS_FAM6_WM_MSR						\
									\
{{ 0xB7, 0x01, C2, "off_core_response_0" }, 0x1A6, 0xFFFF},		\
{{ 0xBB, 0x01, C1, "off_core_response_1" }, 0x1A7, 0xFFFF}


extern const struct events_table_t events_fam6_wm[];
extern const struct events_table_t events_fam6_wm_ex[];
extern const struct msr_events events_fam6_wm_msr[];

#ifdef __cplusplus
}
#endif

#endif /* _SYS_WM_PCBE_H */
