 ...
 * OPL TLB sizes
 */
#define	OPL_fTLB_ENT	32			/* Number of entries of fTLB */
#define	OPL_sTLB_ENT	2048			/* Number of entries of sTLB */
#define	OPL_sDTLB_ENT	OPL_sTLB_ENT		/* Number of entires of sDTLB */
#define	OPL_sITLB_ENT	OPL_sTLB_ENT		/* Number of entires of sITLB */
#define	OPL_fTLB_SZ	OPL_fTLB_ENT * 16	/* fTLB buffer size */
#define	OPL_sTLB_SZ	OPL_sTLB_ENT * 16	/* sTLB buffer size */

#define	OPL_DTLB_BUF_SZ	OPL_fTLB_SZ + OPL_sTLB_SZ
#define	OPL_ITLB_BUF_SZ	OPL_DTLB_BUF_SZ		/* equal size on OPL */

#define	OPL_DTLB_T32		(0 << 16)
#define	OPL_DTLB_T2048_0	(2 << 16)

#define	OPL_ITLB_T32		(0 << 16)
#define	OPL_ITLB_T2048_0	(2 << 16)
...
typedef struct opl_olympus_private {
	tlb_dump_buf_t tlb_dump_buf;
} opl_olympus_private_t;
#endif /* _ASM */
