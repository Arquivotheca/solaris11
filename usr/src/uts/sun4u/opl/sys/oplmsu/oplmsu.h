...
/*
 * The upper path table is used to control the path status, and also the
 * existence of each lower-side stream. One exists per XSCF serial port.
 */
...
/*
 * The lower path table is the STREAMS private data structure for the
 * lower-side stream. Each has a corresponding upper path table.
 */
...
/*
 * The control table is the STREAMS private data structure for the
 * upper-side of the MUX.
 */
