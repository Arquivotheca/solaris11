...
/*
 * Domain suspend message types.
 */
#define	DOMAIN_SUSPEND_SUSPEND		0x0
#define	DOMAIN_SUSPEND_CAPS		0x1

/*
 * Domain suspend response result values.
 */
...
/*
 * Domain suspend recovery result values.
 */
#define	DOMAIN_SUSPEND_REC_SUCCESS	0x0
#define	DOMAIN_SUSPEND_REC_FAILURE	0x1

/*
 * Domain suspend capabilities message response result values.
 */
#define	DOMAIN_SUSPEND_CAP_SUCCESS	0x0
#define	DOMAIN_SUSPEND_CAP_FAILURE	0x1

/*
 * Domain suspend capabilities.
 */
#define	DOMAIN_SUSPEND_CAP_GEN_CPU	0x1
#define	DOMAIN_SUSPEND_CAP_GEN_SPEED	0x2

#define	DOMAIN_SUSPEND_CAP_MASK		0x3
...
typedef struct platsvc_suspend_caps {
	uint64_t	req_num;
	uint32_t	result;
	uint16_t	gen_major;
	uint16_t	gen_minor;
	uint64_t	caps;
} platsvc_suspend_caps_t;
