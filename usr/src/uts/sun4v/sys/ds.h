...
#define	DS_VER_EQ(ds_verp, major_ver, minor_ver)	\
	((ds_verp)->major == (major_ver) &&		\
	    (ds_verp)->minor == (minor_ver))

#define	DS_VER_LT(ds_verp, major_ver, minor_ver)	\
	(((ds_verp)->major < (major_ver)) ||		\
	    ((ds_verp)->major == (major_ver) &&		\
	    (ds_verp)->minor < (minor_ver)))

#define	DS_VER_GTEQ(ds_verp, major_ver, minor_ver)	\
	(((ds_verp)->major > (major_ver)) ||		\
	    ((ds_verp)->major == (major_ver) &&		\
	    (ds_verp)->minor >= (minor_ver)))
