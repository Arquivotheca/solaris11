...
#define	HV_CLM_RETIRE		0x173
#define	HV_CLM_UNRETIRE		0x174
#define	HV_CLM_STATUS		0x175
...
extern uint64_t hv_clm_retire(uint64_t strand, uint64_t cachetype,
    uint64_t level, uint64_t index, uint64_t way, uint64_t *status);
extern uint64_t hv_clm_unretire(uint64_t strand, uint64_t cachetype,
    uint64_t level, uint64_t index, uint64_t way, uint64_t *status);
extern uint64_t hv_clm_status(uint64_t strand, uint64_t cachetype,
    uint64_t level, uint64_t index, uint64_t way, uint64_t *status);
