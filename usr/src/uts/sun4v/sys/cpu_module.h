...
#pragma	weak cpu_gen_status
void cpu_gen_status(uint16_t *, uint16_t *, uint64_t *);
...
void	vtag_flush_pgcnt_tl1(uint64_t addr_pgcnt_pshift, uint64_t sfmmup);
...
#define	NO_LASTLEVEL_CACHE_MAPPING_FOUND	NO_MAPPING_FOUND
/*
...
int	lastlevel_cache_node_count(void);
