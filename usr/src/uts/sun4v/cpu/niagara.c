...
cpu_setup(void)
{
	...
	/*
	 * Limit OOB large page size use on N1 platforms
	 */
	max_uheap_lpsize = MMU_PAGESIZE64K;
	max_ustack_lpsize = MMU_PAGESIZE64K;
	max_privmap_lpsize = MMU_PAGESIZE64K;
