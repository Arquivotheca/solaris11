...
defined(KT_IMPL) || defined(VT_IMPL)
...
#elif defined(VFALLS_IMPL) || defined(KT_IMPL) || defined(VT_IMPL)
	{HV_DRAM_CTL0, HV_DRAM_COUNT0},
	{HV_DRAM_CTL1, HV_DRAM_COUNT1},
	{HV_DRAM_CTL2, HV_DRAM_COUNT2},
	{HV_DRAM_CTL3, HV_DRAM_COUNT3},
...
niagara_dram_events[] = {
	...
	{"mem_writes",		0x1},
	{"mem_read_write",	0x2},
#elif defined(KT_IMPL) || defined(VT_IMPL)
	{"remote_reads",	0x0},
	{"remote_writes",	0x1},
	{"remote_read_write",	0x2},
#endif
#if defined(NIAGARA_IMPL) || defined(KT_IMPL) || defined(VT_IMPL)
...
niagara_kstat_init()
{
	int i;
	ni_ksinfo_t *ksinfop;
#if defined(VFALLS_IMPL) || defined(KT_IMPL) || defined(VT_IMPL)
	uint64_t stat, pcr;
#endif
	...
	int num_ev, ni_kev_mask_t *ev_array)
{
	 ...
	 * last entry in the array (clear_pic) is added separately
