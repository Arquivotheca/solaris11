...
struct	dcd_identify {
	...
	ushort_t dcd_padding2[2];	/* 81 pad to 82 */
	ushort_t dcd_cmdset83;		/* 83 Command sets supported */
	ushort_t dcd_padding3;		/* 84  one word padding */
	ushort_t dcd_features85;	/*  85  feature enabled bits */
	ushort_t dcd_padding4[2];	/* 86 pad to 87 */
	ushort_t dcd_ultra_dma;	/*  88	Ultra dma capability */
	ushort_t dcd_padding5[37];	/* 89 pad to 125 */
	ushort_t dcd_lastlun;	/* 126 last logical unit number */
	ushort_t dcd_padding6[129];	/* pad to 255 */
};
...
/*
 * The following are bits for dcd_cmdset83, word 83
 */
#define	FLUSH_CACHE_SUPPORTED	(1 << 12)
