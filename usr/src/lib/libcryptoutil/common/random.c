...
/* Forward declarations for the inline pragmas below. */
static size_t pkcs11_read_common(int *fd, pthread_mutex_t *mtx,
    void *dbuf, size_t dlen);
static size_t pkcs11_read_random(void *dbuf, size_t dlen);
static size_t pkcs11_read_urandom(void *dbuf, size_t dlen);
 ...
 */
#pragma inline(pkcs11_read_common, pkcs11_read_random, pkcs11_read_urandom)
static size_t
 ...
 */
#pragma inline(pkcs11_get_random, pkcs11_get_urandom)
int
