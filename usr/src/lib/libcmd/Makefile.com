...
# Use -KPIC as libcmd is too big for -Kpic on sparcv9 with gcc
$(__GNUC)sparcv9_C_PICFLAGS= $(sparcv9_C_BIGPICFLAGS)
...
CPPFLAGS = \
	...
	'-DUSAGE_LICENSE=\
		...
		"[-copyright?Copyright (c) 1992-2011 AT&T Intellectual Property]"\
