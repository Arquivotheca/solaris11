 ...
 *			appropriate to suppress any interaction;
...
z_get_nonglobal_zone_list(void)
{
	...
	if ((brands = z_make_brand_list("solaris cluster labeled", " "))
	    == NULL)
		return (NULL);
...
{
	/*
	 * Legacy packaging should treat all zones as branded, as to not
	 * recurse into them.
	 */
