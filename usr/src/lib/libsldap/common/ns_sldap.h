...
#define	NS_LDAP_NO_PAGE_CTRL	  0x0200
 ...
 */
#define	NS_LDAP_UPDATE_ATTR	0x0200
 ...
 */
#define	NS_LDAP_BASE64_BINARY_ATTR_VALUE	0x0100
#define	NS_LDAP_BASE64_TAG	"\1{base64}"
#define	NS_LDAP_BASE64_TAG_LEN	(sizeof (NS_LDAP_BASE64_TAG) - 1)
#define	NS_LDAP_BASE64_TAG_LDIF "\1{base64}:: "
#define	NS_LDAP_BASE64_TAG_LDIF_LEN (sizeof (NS_LDAP_BASE64_TAG_LDIF) - 1)
 ...
 * result is from.
 */
#define	NS_LDAP_OP_ATTR_SERVER_TYPE	"__ns_ldap_op_attr_server_type"

#define	NS_LDAP_ATTR_VAL_SERVER_ODSEE	"ODSEE"
#define	NS_LDAP_ATTR_VAL_SERVER_OID	"OID"
#define	NS_LDAP_ATTR_VAL_SERVER_AD	"AD"
#define	NS_LDAP_ATTR_VAL_SERVER_OPENLDAP "OPENLDAP"
#define	NS_LDAP_ATTR_VAL_SERVER_UNKNOWN	"UNKNOWN"

typedef enum {
	NS_LDAP_SERVERTYPE_ODSEE	= 0,
	NS_LDAP_SERVERTYPE_OID		= 1,
	NS_LDAP_SERVERTYPE_AD		= 2,
	NS_LDAP_SERVERTYPE_OPENLDAP	= 3,
	NS_LDAP_SERVERTYPE_UNKNOWN	= 4
