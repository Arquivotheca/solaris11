...
#define	GETSTATUSCHANGE	25
	/* perform admin modify (add new attribute) via ldap_cachemgr */
#define	ADMINMODIFY_ADD	26
	/* perform admin modify (replace attribute) via ldap_cachemgr */
#define	ADMINMODIFY_REP	27
	/* perform admin modify (delete an attribute) via ldap_cachemgr */
#define	ADMINMODIFY_DEL	28
	/* get admin credentials for shadow lookups */
#define	GETADMINCRED	29
	/* perform admin addEntry via ldap_cachemgr */
#define	ADMIN_ADDENTRY	30
	/* perform admin delEntry via ldap_cachemgr */
#define	ADMIN_DELENTRY	31
...
#define	LDAP_CACHE_DOOR _PATH_SYSVOL "/ldap_cache_door"
