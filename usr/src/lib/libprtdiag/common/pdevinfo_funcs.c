...
Prom_node *
dev_find_node(Prom_node *root, const char *name)
{
	Prom_node *node;
...
Prom_node *
dev_next_node(Prom_node *root, const char *name)
{
	Prom_node *node;
 ...
 */
Prom_node *
dev_find_type(Prom_node *root, const char *type)
{
	Prom_node *node;
 ...
 */
Prom_node *
dev_next_type(Prom_node *root, const char *type)
{
	Prom_node *node;
...
int
node_status(Prom_node *node, const char *status)
{
	void *value;
 ...
 */
Prop *
find_prop(Prom_node *pnode, const char *name)
{
	Prop *prop;
...
Prom_node *
dev_find_node_by_type(Prom_node *root, const char *type, const char *property)
{
	Prom_node *node;
	char *type_prop;
...
Prom_node *
dev_next_node_by_type(Prom_node *root, const char *type, const char *property)
{
	Prom_node *node;
 ...
 */
Prom_node *
dev_find_node_by_compatible(Prom_node *root, const char *compatible)
{
	Prom_node *node;
	Prop	*prop;
 ...
 */
Prom_node *
dev_next_node_by_compatible(Prom_node *root, const char *compatible)
{
	Prom_node *node;
