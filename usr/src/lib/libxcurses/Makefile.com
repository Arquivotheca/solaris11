...
STUBROOTLIBDIR=	$(STUBROOT)/usr/xpg4/lib
STUBROOTLIBDIR64=	$(STUBROOT)/usr/xpg4/lib/$(MACH64)
STUBROOTLIBS=	$(LIBS:%=$(STUBROOTLIBDIR)/%)

LROOTLIBDIR=	$(LROOT)/usr/xpg4/lib
LROOTLIBDIR64=	$(LROOT)/usr/xpg4/lib/$(MACH64)
