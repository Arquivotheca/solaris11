...
Prop	*find_prop(Prom_node *pnode, const char *name);
...
static    int32_t find_child_device(picl_nodehdl_t, const char *,
				picl_nodehdl_t *);
...
int32_t
find_child_device(picl_nodehdl_t parent, const char *child_name,
