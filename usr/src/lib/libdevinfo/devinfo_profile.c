...
/*
 * Add a device annotation to the profile.
 */
int
di_prof_add_devann(di_prof_t prof, const char *dev, const char *ann)
{
	char *array[2];
	...
	if (nvlist_add_string_array((nvlist_t *)prof, SDEV_NVNAME_ANNOTATE,
	    array, 2))
		return (-1);
	return (0);
}
