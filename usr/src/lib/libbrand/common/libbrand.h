...
extern boolean_t brand_allow_readonly(brand_handle_t);
...
extern int brand_get_postinstall(brand_handle_t, const char *, const char *,
    char *, size_t);
extern int brand_get_postmove(brand_handle_t, const char *, const char *,
    char *, size_t);
...
extern int brand_config_iter_privilege(brand_handle_t,
    int (*)(void *, priv_iter_t *), void *);

extern boolean_t brand_verify_mac_profile(brand_handle_t, const char *);
extern int brand_config_iter_rwp(brand_handle_t, int (*)(void *, const char *),
    const char *, void *, boolean_t);
...
extern int brand_platform_iter_datasets(brand_handle_t, const char *,
