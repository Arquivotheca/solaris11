...
#define	NP_DEFAULT_FMRI		"svc:/network/physical:default"
#define	NP_NWAM_FMRI		"svc:/network/physical:nwam"
#define	NWAM_PG			"nwamd"
#define	NETCFG_PG		"netcfg"
#define	NETCFG_ACTIVE_NCP_PROP	"active_ncp"
#define	UPGRADE_PG		"upgrade"
#define	NWAMD_VERSION_PROP	"nwamd_version"
...
#define	NWAM_LOC_PROP_DNS_NAMESERVICE_SORTLIST	"dns-nameservice-sortlist"
#define	NWAM_LOC_PROP_DNS_NAMESERVICE_OPTIONS	"dns-nameservice-options"
...
#define	NWAM_NCP_NAME_DEFAULT_FIXED	"DefaultFixed"

#define	NWAM_NCP_AUTOMATIC(name)	\
			(strcasecmp(name, NWAM_NCP_NAME_AUTOMATIC) == 0)
#define	NWAM_NCP_DEFAULT_FIXED(name)	\
			(strcasecmp(name, NWAM_NCP_NAME_DEFAULT_FIXED) == 0)
