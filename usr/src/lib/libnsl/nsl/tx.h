...
extern void *_tx_alloc(int, int, int, int);
...
extern int _tx_free(void *, int, int);
...
extern int _tx_rcv(int, void *, unsigned, int *, int);
...
extern int _tx_snd(int, void *, unsigned, int, int);
...
extern const char *_tx_strerror(int, int);
