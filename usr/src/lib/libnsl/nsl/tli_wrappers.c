...
int
t_accept(int fd, int resfd, const struct t_call *call)
{
...
int
t_free(void *ptr, int struct_type)
{
...
int
t_snddis(int fd, const struct t_call *call)
{
...
int
t_sndudata(int fd, const struct t_unitdata *unitdata)
{
