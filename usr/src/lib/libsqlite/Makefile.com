...
STUBSMBSRVLIBDIR=   $(STUBROOTLIBDIR)/smbsrv
STUBSMBSRVLINK=     $(STUBSMBSRVLIBDIR)/$(LIBLINKS)
...
#
all:		stub $(LIBS)
install:	stubinstall all \
		$(ROOTLIBDIR)/$(RELOC) $(ROOTLIBDIR)/$(NATIVERELOC) \
...
$(SMBSRVLIBDIR) $(STUBSMBSRVLIBDIR): $(ROOTLIBDIR)
	$(INS.dir)

$(SMBSRVLIBDIR)/% : % $(SMBSRVLIBDIR)
	$(INS.file)

$(STUBSMBSRVLIBDIR)/%: stubs/% $(STUBSMBSRVLIBDIR)
	$(INS.file)

$(SMBSRVLINK): $(SMBSRVLIBDIR) $(SMBSRVLIBDIR)/$(DYNLIB)
	$(INS.liblink)

$(STUBSMBSRVLINK): $(STUBSMBSRVLIBDIR) $(STUBSMBSRVLIBDIR)/$(DYNLIB)
	$(INS.liblink)
