...
LIBRARY= encrypted_challenge.a
VERS= .1

ENCRYPTED_CHALLENGE_OBJS= \
	encrypted_challenge_main.o

OBJECTS= $(ENCRYPTED_CHALLENGE_OBJS)

# include library definitions
include $(SRC)/lib/krb5/Makefile.lib

SRCS= $(ENCRYPTED_CHALLENGE_OBJS:%.o=../%.c)
