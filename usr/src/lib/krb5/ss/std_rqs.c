...
extern int ss_self_identify __SS_PROTO;
static char const * const ssu00002[] = {
"help",
    (char const *)0
};
extern int ss_help __SS_PROTO;
static char const * const ssu00003[] = {
"list_help",
    "lh",
    (char const *)0
};
extern int ss_unimplemented __SS_PROTO;
...
extern int ss_subsystem_name __SS_PROTO;
static char const * const ssu00010[] = {
"subsystem_version",
    (char const *)0
};
extern int ss_subsystem_version __SS_PROTO;
