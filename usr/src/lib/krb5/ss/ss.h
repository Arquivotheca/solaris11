...
typedef struct _ss_request_entry {
    ...
    int (* __SS_CONST function) __SS_PROTO; /* foo */
...
/* Solaris Kerberos - errors are now returned. */
int ss_help __SS_PROTO;
int ss_list_requests __SS_PROTO;
int ss_quit __SS_PROTO;
...
void ss_set_use_pager (int); /* Solaris Kerberos: */
int ss_use_pager (void); /* Solaris Kerberos: */
