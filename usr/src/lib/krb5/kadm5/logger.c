...
/* Solaris Kerberos */
#define lspec_parse_err_1       gettext("%s: cannot parse <%s>\n")
#define lspec_parse_err_2       gettext("%s: warning - logging entry syntax error\n")
#define log_file_err            gettext("%s: error writing to %s\n")
#define log_device_err          gettext("%s: error writing to %s device\n")
#define log_ufo_string          gettext("?\?\?") /* nb: avoid trigraphs */
#define log_emerg_string        gettext("EMERGENCY")
#define log_alert_string        gettext("ALERT")
#define log_crit_string         gettext("CRITICAL")
#define log_err_string          gettext("Error")
#define log_warning_string      gettext("Warning")
#define log_notice_string       gettext("Notice")
#define log_info_string         gettext("info")
#define log_debug_string        gettext("debug")

/*
 * Output logging.
 *
                ...
                *cp2 = '\0';
                 ...
                 */
                    ...
                    log_control.log_entries[i].lfu_filep =
                        fdopen(fileno(stderr), "a+F"); /* Solaris Kerberos */
                 ...
                 */
                    ...
                    log_control.log_entries[i].ldu_filep =
                        CONSOLE_OPEN("a+F");  /* Solaris Kerberos */
