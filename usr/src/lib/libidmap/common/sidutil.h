...
/*
 * The maximum size of a SID in string format, not including terminating null.
 */
...
void sid_splitstr(char *sidprefix, size_t buflen, idmap_rid_t *rid,
    const char *sid);

boolean_t is_sidstr(const char *sid);
