...
/*
 * Private versions of the functions above with special semantics for NFSv4.
 *
 * Private, subject to change without notice.
 */
extern idmap_stat idmap_nfsv4_getwinnamebyuid(uid_t, int, char **);
extern idmap_stat idmap_nfsv4_getwinnamebygid(gid_t, int, char **);
extern idmap_stat idmap_nfsv4_getuidbysid(const char *, int, uid_t *);
extern idmap_stat idmap_nfsv4_getgidbysid(const char *, int, gid_t *);
