...
#define	IPMI_CMD_SUNOEM_CLI		0x19
#define	IPMI_SUNOEM_CLI_VERSION		0x01
#define	IPMI_SUNOEM_CLI_INBUFSZ		72
#define	IPMI_SUNOEM_CLI_OPEN		0
#define	IPMI_SUNOEM_CLI_FORCE		1
#define	IPMI_SUNOEM_CLI_CLOSE		2
#define	IPMI_SUNOEM_CLI_POLL		3
#define	IPMI_SUNOEM_CLI_EOF		4

typedef struct ipmi_sunoem_cli_msg {
	uint8_t		icli_version;
	uint8_t		icli_cmdresp;
	uint8_t		__reserved1;
	uint8_t		__reserved2;
	uint8_t		icli_handle[4];
	char		icli_buf[IPMI_SUNOEM_CLI_INBUFSZ];
} ipmi_sunoem_cli_msg_t;

int ipmi_sunoem_cli(ipmi_handle_t *, char **, char *, uint_t, boolean_t);
