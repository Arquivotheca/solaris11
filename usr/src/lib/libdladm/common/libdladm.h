 ...
 *
 *  - DLADM_OPT_AUTOVNIC:
 *    Signifies datalink was automatically created by zoneadm for use in a
 *    non-global zone. Auto VNICs have the special property of being created
 *    in the global zone but are not visible in the global zone (they are always
 *    assigned to a non-global zone).
 */
...
#define	DLADM_OPT_AUTOVNIC	0x00000800
