...
static fad_checkf_t do_check_dsfield;
...
do_check_dsfield(char *attr_val, flow_desc_t *fdesc)
{
	return (dladm_check_dsfield(attr_val, fdesc));
}

static dladm_status_t
do_check_local_ip(char *attr_val, flow_desc_t *fdesc)
{
	return (dladm_check_ip_addr(attr_val, B_TRUE, fdesc));
}

static dladm_status_t
do_check_remote_ip(char *attr_val, flow_desc_t *fdesc)
{
	return (dladm_check_ip_addr(attr_val, B_FALSE, fdesc));
}

dladm_status_t
dladm_check_ip_addr(char *addr_str, boolean_t local, flow_desc_t *fd)
{
...
dladm_status_t
dladm_check_dsfield(char *str, flow_desc_t *fd)
{
