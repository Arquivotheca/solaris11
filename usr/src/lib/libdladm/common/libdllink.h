...
typedef struct dladm_phys_attr {
	...
	/*
	 * Physical location (slot name).
	 */
	char		dp_loc[DLD_LOC_STRSIZE];
	/*
	 * prefix for vanity naming (if supported)
	 */
	char		dp_phys_prefix[MAXLINKNAMELEN];
} dladm_phys_attr_t;
...
#define	DLADM_MAX_PROP_VALCNT	DLADM_MAX_ARG_VALS
/*
...
typedef struct dladm_datalink_info {
	datalink_id_t		di_linkid;
	char			di_linkname[MAXLINKNAMESPECIFIER];
	uint32_t		di_flags;
	datalink_class_t	di_class;
	uint32_t		di_media;
	zoneid_t		di_zoneid;
} dladm_datalink_info_t;

typedef int (dladm_walk_datalink_cb_t)(dladm_handle_t, dladm_datalink_info_t *,
    void *);
...
extern dladm_status_t	dladm_create_datalink_id(dladm_handle_t, const char *,
			    ...
			    datalink_id_t *);
extern dladm_status_t	dladm_create_datalink_id_zone(dladm_handle_t,
			    const char *, datalink_class_t, uint32_t,
			    uint32_t, zoneid_t, datalink_id_t *);
...
extern dladm_status_t	dladm_datalink_id2info(dladm_handle_t, datalink_id_t,
			    ...
			    size_t);
extern dladm_status_t	dladm_datalink_id2linkinfo(dladm_handle_t,
			    datalink_id_t, uint32_t *, datalink_class_t *,
			    uint32_t *, char *, size_t, zoneid_t *);
extern dladm_status_t	dladm_walk_datalink_id(int (*)(dladm_handle_t,
			    datalink_id_t, void *), dladm_handle_t, void *,
			    datalink_class_t, datalink_media_t, uint32_t);
extern dladm_status_t	dladm_walk_datalinks(dladm_handle_t, datalink_id_t,
			    dladm_walk_datalink_cb_t *, void *,
			    datalink_class_t, datalink_media_t, uint32_t,
			    uint32_t, zoneid_t *);
extern dladm_status_t	dladm_search_zonelist(zoneid_t, uint32_t, zoneid_t *);
...
extern dladm_status_t	dladm_walk_phys_info(dladm_handle_t,
			    int (*fn)(dladm_handle_t, datalink_id_t,
			    dladm_phys_attr_t *, void *), void *, uint32_t);

extern dladm_status_t	dladm_reinit_phys(dladm_handle_t, const char *);
...
extern void		dladm_get_ring_counts(dladm_handle_t, datalink_id_t,
			    uint_t *, uint_t *);
extern void		dladm_query_primary_linkid(dladm_handle_t,
			    datalink_id_t, datalink_id_t *);
extern void		dladm_get_ring_index_list(dladm_handle_t, datalink_id_t,
