...
__nis_config_t	ldapConfig = {
	ini_none,			/* nisLDAPinitialUpdate */
	pass_error,			/* nisLDAPthreadCreationError */
	{
		-1,			/* Try forever */
		15			/* 15 second timeout */
	},
	de_retry,			/* nisLDAPdumpError */
	{
		-1,			/* Try forever */
		200			/* 200 second timeout */
	},
	directory_locked,		/* nisLDAPresyncService */
	accumulate,			/* nisLDAPupdateBatching */
	{
		-1,			/* Not used */
		120			/* Accumulate for 120 seconds */
	},
	block				/* nisLDAPexclusiveWaitMOde */
};
