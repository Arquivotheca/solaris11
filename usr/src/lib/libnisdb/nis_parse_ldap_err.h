...
static char *parse_error_msg[] =
{
	...
	"nisLDAPconfigProxyUser was not specified",

	/* parse_no_config_auth_error */
	"nisLDAPconfigAuthenticationMethod was not specified",
	...
	"nisLDAPconfigDefaultServerList was not specified",
	...
	"nisLDAPconfigTLSCertificateDBPath must be specified",

	/* parse_no_cert_db */
	"nisLDAPTLSCertificateDBPath must be specified",
