...
#define	IS_BIND_INFO(x)	\
	((x) >= key_preferred_servers && (x) <= key_search_base)

/* This information will be need to determine the server behavior */

#define	INITIAL_UPDATE_ACTION	"nisLDAPinitialUpdateAction"
#define	INITIAL_UPDATE_ONLY	"nisLDAPinitialUpdateOnly"
#define	REFRESH_ERROR_ACTION	"nisLDAPrefreshErrorAction"
#define	REFRESH_ERROR_ATTEMPTS	"nisLDAPrefreshErrorAttempts"
#define	REFRESH_ERROR_TIMEOUT	"nisLDAPrefreshErrorTimeout"
#define	THREAD_CREATE_ERROR_ACTION	\
				"nisThreadCreationErrorAction"
#define	THREAD_CREATE_ERROR_ATTEMPTS	\
				"nisThreadCreationErrorAttempts"
#define	THREAD_CREATE_ERROR_TIMEOUT	\
				"nisThreadCreationErrorTimeout"
#define	DUMP_ERROR_ACTION	"nisDumpErrorAction"
#define	DUMP_ERROR_ATTEMPTS	"nisDumpErrorAttempts"
#define	DUMP_ERROR_TIMEOUT	"nisDumpErrorTimeout"
#define	RESYNC			"nisResyncService"
#define	UPDATE_BATCHING		"nisUpdateBatching"
#define	UPDATE_BATCHING_TIMEOUT	"nisUpdateBatchingTimeout"
#define	NUMBER_THREADS		"nisNumberOfServiceThreads"
#define	YP_EMULATION		"ENABLE_NIS_YP_EMULATION"
#define	MAX_RPC_RECSIZE		"nisMaxRPCRecordSize"
