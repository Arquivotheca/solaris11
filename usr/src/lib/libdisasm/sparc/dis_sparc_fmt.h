...
int fmt_cbcond(dis_handle_t *, uint32_t, const inst_t *, int);
int fmt_crypto(dis_handle_t *, uint32_t, const inst_t *, int);
int fmt_crypto4op(dis_handle_t *, uint32_t, const inst_t *, int);
