...
#define	SUNFMPROBLEM_COL_SEVERITY	8
#define	SUNFMPROBLEM_COL_FAULTSTATUS	9
#define	SUNFMPROBLEM_COL_INJECTED	10

#define	SUNFMPROBLEM_COLMIN		SUNFMPROBLEM_COL_UUID
#define	SUNFMPROBLEM_COLMAX		SUNFMPROBLEM_COL_INJECTED
