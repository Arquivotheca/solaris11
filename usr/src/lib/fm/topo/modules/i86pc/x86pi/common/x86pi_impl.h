...
/* bay node generation */
void x86pi_gen_bay(topo_mod_t *, tnode_t *, int, int);
int x86pi_gen_sas_bay(topo_mod_t *, tnode_t *, int *);
int x86pi_gen_sata_bay(topo_mod_t *, tnode_t *, smbios_port_ext_t *,
    int);
int x86pi_gen_expander_bay(topo_mod_t *, tnode_t *, int *);
