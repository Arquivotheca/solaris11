 ...
 * Each node export three methods expand() presence_state() and service_state().
 *
 */
...
static int cpu_presence_state(topo_mod_t *, tnode_t *, topo_version_t,
    nvlist_t *, nvlist_t **);
static int cpu_expand(topo_mod_t *, tnode_t *, topo_version_t, nvlist_t *,
    nvlist_t **);
static int cpu_service_state(topo_mod_t *, tnode_t *, topo_version_t,
    nvlist_t *, nvlist_t **);
...
/*ARGSUSED*/
static int
cpu_presence_state(topo_mod_t *mod, tnode_t *node, topo_version_t vers,
...
/*ARGSUSED*/
static int
cpu_service_state(topo_mod_t *mod, tnode_t *node, topo_version_t vers,
    nvlist_t *in, nvlist_t **out)
{
	int rc = -1;
	uint8_t version;
