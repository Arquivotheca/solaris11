...
#define	EXTERNALCHASSIS	"external-chassis"
#define	FAN		"fan"
...
#define	USBTOPO		"usb"
#define	USB_BUS		"usb-bus"
#define	USB_HUB		"usbhub"
#define	USB_DEV		"usbdev"
#define	USB_IFC		"usbif"
#define	XAUI		"xaui"
#define	XFP		"xfp"
...
/*
 * The binding group is used to allow one topo enumeration plugin that creates
 * receptacles nodes (like ses.so creates BAY nodes) to select a method for
 * another topo enumerator (like disk.so) to locate that receptacle's current
 * occupant (like a disk with a specific target-port).
 */
#define	TOPO_PGROUP_BINDING		"binding"
#define	TOPO_BINDING_OCCUPANT		"occupant-path"
#define	TOPO_BINDING_OCCUPANT_TARGET_PORTS "occupant-target-ports"
