...
#define	TOPO_DBG_SNAP	0x0040	/* enable snapshot debug messages */
#define	TOPO_DBG_UUID	0x0080	/* Use uuid_generate_time(). */
...
extern char *topo_search_path(topo_mod_t *, const char *);
...
extern boolean_t topo_is_excluded(const char *, const char *);
