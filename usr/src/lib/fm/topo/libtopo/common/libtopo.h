...
extern char *topo_snap_hold_flag(topo_hdl_t *, const char *, int *, int);
#define	TOPO_SNAP_HOLD_CROMK	0x1
extern void topo_snap_release(topo_hdl_t *);
extern char *topo_snap_load(topo_hdl_t *, const char *, int *);
extern void topo_cleanup();
...
extern di_cromk_hdl_t topo_hdl_cromk_hdl(topo_hdl_t *);
...
extern int topo_fmri_presence_state(topo_hdl_t *, nvlist_t *, int *);
...
extern boolean_t topo_fmri_strcmp_noauth(topo_hdl_t *, const char *,
    const char *);
extern boolean_t topo_fmri_strcmp_ident(topo_hdl_t *, const char *,
    const char *);
extern int topo_fmri_ident_node(topo_hdl_t *, nvlist_t *, nvlist_t **, int *);
...
typedef enum topo_hdl_errno {
    ...
    ETOPO_HDL_UUID,		/* uuid already set or missing */
...
extern void topo_hdl_strfreevn(topo_hdl_t *, char **, uint_t);
extern void topo_debug_set(topo_hdl_t *, const char *, const char *);

extern char *topo_hdl_uuid(topo_hdl_t *);
extern time_t topo_hdl_timestamp(topo_hdl_t *);
