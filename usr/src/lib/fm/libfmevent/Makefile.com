...
STUBROOTLIBDIR=     $(STUBROOTFS_LIBDIR)/fm
STUBROOTLIBDIR64=   $(STUBROOTFS_LIBDIR)/fm/$(MACH64)
LROOTLIBDIR=        $(LROOTFS_LIBDIR)/fm
LROOTLIBDIR64=      $(LROOTFS_LIBDIR)/fm/$(MACH64)
