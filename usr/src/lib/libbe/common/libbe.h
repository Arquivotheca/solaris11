...
#define	BE_ATTR_NEW_BE_NESTED_BE		"new_be_nested_be"
#define	BE_ATTR_NEW_BE_ALLOW_AUTO_NAMING	"new_be_allow_auto_naming"
#define	BE_ATTR_NEW_BE_PARENTBE			"new_be_parentbe"
#define	BE_ATTR_POLICY				"policy"
#define	BE_ATTR_ZFS_PROPERTIES			"zfs_properties"

#define	BE_ATTR_FS_NAMES			"fs_names"
#define	BE_ATTR_FS_ZFS_PROPERTIES		"fs_zfs_properties"
#define	BE_ATTR_FS_NUM				"fs_num"
#define	BE_ATTR_SHARED_FS_NAMES			"shared_fs_names"
#define	BE_ATTR_SHARED_FS_ZFS_PROPERTIES	"shared_fs_zfs_properties"
#define	BE_ATTR_SHARED_FS_NUM			"shared_fs_num"

#define	BE_ATTR_ALT_POOL			"alt_pool"
...
#define	BE_ATTR_ACTIVE_UNBOOTABLE		"active_unbootable"
...
enum {
	...
	BE_ERR_INTR,		/* interrupted system call */
	...
	BE_ERR_ZONE_ROOT_NOT_SLASH, /* Zone root dataset mntpt is not / */
	...
	BE_ERR_PKG_VERSION,	/* Package versioning error. */
	BE_ERR_ADD_SPLASH_ICT,	/* Add_splash_image ICT failed. */
	BE_ERR_PKG,		/* Error running pkg(1M). */
	BE_ERR_BOOTFILE_INST,	/* Error installing boot files. */
	BE_ERR_EXTCMD,		/* External command error */
	BE_ERR_ZONE_NOTSUP,	/* Operation not supported for zone BE */
	BE_ERR_ZONE_MPOOL_NOTSUP, /* Operation not supported for zone BE */
	BE_ERR_ZONE_RO_NOTSUP,	/* Operation not supported in a R/O zone */
	BE_ERR_NO_MENU_ENTRY,	/* Menu entry can't be found */
	BE_ERR_NESTED_PYTHON,	/* Attempted to nest Python interpreters */
	BE_ERR_PYTHON,		/* Native Python library call failed */
	BE_ERR_PYTHON_EXCEPT,	/* Python code raised an exception */
	BE_ERR_RENAME_ACTIVE_ON_BOOT, /* Can not rename active on boot BE */
	BE_ERR_NO_RPOOLS	/* No root pools could be found */
} be_errno_t;
...
typedef struct be_node_list {
	...
	boolean_t be_active_unbootable; /* is this BE potentially bootable */
...
#define	BE_UNMOUNT_FLAG_NO_ZONES	0x00000002
 ...
 */
int be_get_boot_args_and_mountpt(int, char *, size_t, char *, size_t);
