...
/*
 * Solaris Kerberos: XXX this should be cleaned up along with gssapiP_generic.h
 */
#undef g_token_size
...
/* EXPORT DELETE START */ /* CRYPT DELETE START */
    NULL, /* wrap_aead */
    NULL, /* unwrap_aead */
    NULL, /* Solaris Kerberos: no gss_wrap_iov */
    NULL, /* Solaris Kerberos: no gss_unwrap_iov */
    NULL, /* Solaris Kerberos: no gss_wrap_iov_length */
/* EXPORT DELETE END */ /* CRYPT DELETE END */
    ...
    NULL, /* Solaris Kerberos no gss_pseudo_random */
    NULL, /* set_neg_mechs */
};
...
/*ARGSUSED*/
OM_uint32
dummy_gss_acquire_cred(minor_status, desired_name, time_req, desired_mechs,
	...
	OM_uint32 *time_rec;
{
	...
	*output_cred_handle = (gss_cred_id_t)
	...
	if (actual_mechs) {
		if (gssint_copy_oid_set(minor_status, gss_mech_set_dummy,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_release_cred(minor_status, cred_handle)
	OM_uint32 *minor_status;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_init_sec_context(minor_status, claimant_cred_handle,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_accept_sec_context(minor_status, context_handle,
	...
	gss_cred_id_t *delegated_cred_handle;
{
	...
	if ((status == GSS_S_COMPLETE) && src_name) {
		...
		status = dummy_gss_import_name(minor_status, &name,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_process_context_token(minor_status, context_handle, token_buffer)
	OM_uint32 *minor_status;
	gss_ctx_id_t context_handle;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_delete_sec_context(minor_status, context_handle, output_token)
	OM_uint32 *minor_status;
	gss_ctx_id_t *context_handle;
	gss_buffer_t output_token;
{
...
/*ARGSUSED*/
OM_uint32
dummy_gss_context_time(minor_status, context_handle, time_rec)
	OM_uint32 *minor_status;
	gss_ctx_id_t context_handle;
	OM_uint32 *time_rec;
{
...
/*ARGSUSED*/
OM_uint32
dummy_gss_sign(minor_status, context_handle,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_verify(minor_status, context_handle,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_seal(minor_status, context_handle, conf_req_flag,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_unseal(minor_status, context_handle,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_display_status(minor_status, status_value, status_type,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_indicate_mechs(minor_status, mech_set)
	OM_uint32 *minor_status;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_compare_name(minor_status, name1, name2, name_equal)
	OM_uint32 *minor_status;
	gss_name_t name1;
	gss_name_t name2;
	int *name_equal;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_display_name(minor_status, input_name, output_name_buffer,
			output_name_type)
	OM_uint32 *minor_status;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_import_name(minor_status, input_name_buffer,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_release_name(minor_status, input_name)
	OM_uint32 *minor_status;
	gss_name_t *input_name;
{
	dummy_name_t name = (dummy_name_t)*input_name;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_inquire_cred(minor_status, cred_handle, name, lifetime_ret,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_add_cred(minor_status, input_cred_handle,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_export_sec_context(minor_status, context_handle,
				interprocess_token)
	OM_uint32 *minor_status;
	gss_ctx_id_t *context_handle;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_import_sec_context(minor_status, interprocess_token,
				context_handle)
OM_uint32 *minor_status;
gss_buffer_t interprocess_token;
gss_ctx_id_t *context_handle;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_inquire_cred_by_mech(minor_status, cred_handle,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_inquire_names_for_mech(minor_status, mechanism, name_types)
	OM_uint32	*minor_status;
	gss_OID		mechanism;
...
/*ARGSUSED*/
OM_uint32
dummy_gss_inquire_context(minor_status, context_handle, initiator_name,
...
/*ARGSUSED*/
OM_uint32
dummy_gss_internal_release_oid(minor_status, oid)
	OM_uint32	*minor_status;
	gss_OID		*oid;
{
...
/*ARGSUSED*/
OM_uint32
dummy_gss_wrap_size_limit(minor_status, context_handle, conf_req_flag,
...
/* ARGSUSED */
OM_uint32
dummy_pname_to_uid(minor_status, name, uidOut)
	OM_uint32 *minor_status;
