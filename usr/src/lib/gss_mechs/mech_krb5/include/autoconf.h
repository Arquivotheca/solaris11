...
#define PROVIDE_KERNEL_IMPORT 1
#define USE_BUNDLE_ERROR_STRINGS 1 /* Solaris Kerberos */
...
/* Solaris Kerberos:
 * Make sure that we don't end up using OpenSSL
 */
...
#define HAVE_PYTHON2_5_PYTHON_H 1
...
#define PACKAGE_STRING "Kerberos 5 1.8.3"
