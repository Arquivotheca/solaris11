              ...
              krb5_error **dec_error)
{
    ...
    /* Solaris Kerberos: modified this to support dtrace  */
    ret = decode_krb5_error(enc_errbuf, dec_error);

    KERBEROS_PROBE_KRB_ERROR(READ, enc_errbuf, ret == 0 ? *dec_error : NULL);
