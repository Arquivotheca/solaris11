...
#define	DES_FIRST_MECH  0
	...
	CKM_DES2_KEY_GEN,
	CKM_DES3_KEY_GEN,
#define	DES_LAST_MECH   10
#define	AES_FIRST_MECH  11
	CKM_AES_CBC,
	CKM_AES_CBC_PAD,
	CKM_AES_CTR,
	CKM_AES_ECB,
	CKM_AES_KEY_GEN,
#define	AES_LAST_MECH   15
	CKM_BLOWFISH_CBC,
	CKM_BLOWFISH_KEY_GEN,
#define	SHA1_FIRST_MECH 18
	CKM_SHA_1,
	CKM_SHA_1_HMAC,
	CKM_SHA_1_HMAC_GENERAL,
#define	SHA1_LAST_MECH  20
#define	SHA256_FIRST_MECH	21
	CKM_SHA256,
	CKM_SHA256_HMAC,
	CKM_SHA256_HMAC_GENERAL,
#define	SHA256_LAST_MECH	23
#define	SHA384_FIRST_MECH	24
	CKM_SHA384,
	CKM_SHA384_HMAC,
...
#define	SHA512_LAST_MECH	29
	CKM_SSL3_SHA1_MAC,
#define	MD5_FIRST_MECH  31
	CKM_MD5,
	CKM_MD5_HMAC,
	CKM_MD5_HMAC_GENERAL,
#define	MD5_LAST_MECH   33
	CKM_SSL3_MD5_MAC,
	CKM_RC4,
	CKM_RC4_KEY_GEN,
#define	DSA_FIRST_MECH  37
	CKM_DSA,
	CKM_DSA_SHA1,
	CKM_DSA_KEY_PAIR_GEN,
#define	DSA_LAST_MECH   39
#define	RSA_FIRST_MECH  40
	CKM_RSA_PKCS,
	...
	CKM_SHA384_RSA_PKCS,
	CKM_SHA512_RSA_PKCS,
#define	RSA_LAST_MECH   47
#define	DH_FIRST_MECH 48
	CKM_DH_PKCS_KEY_PAIR_GEN,
	CKM_DH_PKCS_DERIVE,
#define	DH_LAST_MECH 50
	...
	CKM_TLS_PRF,
#define	EC_FIRST_MECH   66
	CKM_EC_KEY_PAIR_GEN,
	CKM_ECDSA,
	CKM_ECDSA_SHA1,
	CKM_ECDH1_DERIVE
#define	EC_LAST_MECH    69
};
...
static CK_MECHANISM_INFO soft_mechanism_info[] = {
	...
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
		...
		CKF_WRAP|CKF_UNWRAP|
		CKF_VERIFY|CKF_VERIFY_RECOVER},	/* CKM_RSA_PKCS */
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
	...
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
		...
		CKF_SIGN|CKF_SIGN_RECOVER|
		CKF_WRAP|CKF_UNWRAP|
		CKF_VERIFY|CKF_VERIFY_RECOVER},	/* CKM_RSA_X_509 */
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
		CKF_SIGN|CKF_VERIFY},		/* CKM_MD5_RSA_PKCS */
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
		CKF_SIGN|CKF_VERIFY},		/* CKM_SHA1_RSA_PKCS */
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
		CKF_SIGN|CKF_VERIFY},		/* CKM_SHA256_RSA_PKCS */
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
		CKF_SIGN|CKF_VERIFY},		/* CKM_SHA384_RSA_PKCS */
	{RSA_MIN_KEY_LEN, RSA_MAX_KEY_LEN,
		CKF_SIGN|CKF_VERIFY},		/* CKM_SHA512_RSA_PKCS */
...
update_mech_hw_flags(void)
{
	...
	if (ui & AV_386_AES) {
		...
		for (m = AES_FIRST_MECH; m <= AES_LAST_MECH; m++) {
			soft_mechanism_info[m].flags |= CKF_HW;
		}
	}
	...
	if (ui & AV_SPARC_SHA256) {
		for (m = SHA256_FIRST_MECH; m <= SHA256_LAST_MECH; m++) {
			soft_mechanism_info[m].flags |= CKF_HW;
		}
	}
	...
	if ((ui & AV_SPARC_MONT) && (ui & AV_SPARC_MPMUL)) {
