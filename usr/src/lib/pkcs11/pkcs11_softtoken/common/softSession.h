...
/*
 * Definition of types of active operation, used to set contexts.
 */
typedef enum session_op {
	SOFT_NO_OP = 0,
	SOFT_DIGEST_OP = 1,
	SOFT_MAC_OP,
	SOFT_ENCRYPT_OP,
...
void soft_set_session_context(soft_session_t *pSession,
    soft_session_op_t op, void *pContext, CK_MECHANISM_PTR pMechanism);
void soft_clear_session_context(soft_session_t *pSession,
    soft_session_op_t op, size_t ctx_sz);
