...
IO_OBJS = io_tag.o io_mvec.o

OBJECTS=$(ZFS_COMMON_OBJS) $(ZFS_SHARED_OBJS) $(IO_OBJS) $(KERNEL_OBJS)
...
IO_SRCS=		$(IO_OBJS:%.o=../../../uts/common/os/%.c)
KERNEL_SRCS=		$(KERNEL_OBJS:%.o=../common/%.c)

SRCS=$(ZFS_COMMON_SRCS) $(ZFS_SHARED_SRCS) $(IO_SRCS) $(KERNEL_SRCS)
SRCDIR=		../common
