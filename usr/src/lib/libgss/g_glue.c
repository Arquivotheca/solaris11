 ...
 */
int
gssint_get_der_length(unsigned char **buf, unsigned int buf_len,
	unsigned int *bytes)
{
 ...
 */
int
gssint_put_der_length(unsigned int length, unsigned char **buf,
...
OM_uint32
gssint_get_mech_type_oid(OID, token)
	gss_OID		OID;
	gss_buffer_t	token;
{
...
OM_uint32
gssint_get_mech_type(OID, token)
	gss_OID		OID;
	gss_buffer_t	token;
{
...
OM_uint32
gssint_export_internal_name(minor_status, mech_type,
...
OM_uint32
gssint_display_internal_name(minor_status, mech_type, internal_name,
...
OM_uint32
gssint_release_internal_name(minor_status, mech_type, internal_name)
OM_uint32	*minor_status;
gss_OID		mech_type;
gss_name_t	*internal_name;
{
