...
{ "IDROPS",	8,	FLOW_S_IDROPS,		print_flow_stats_cb},
{ "IDROPBYTES",	8,	FLOW_S_IDROPBYTES,	print_flow_stats_cb},
...
{ "ODROPS",	8,	FLOW_S_ODROPS,		print_flow_stats_cb},
{ "ODROPBYTES",	8,	FLOW_S_ODROPBYTES,	print_flow_stats_cb},
NULL_OFMT}
;
...
print_flow_stats_cb(ofmt_arg_t *of_arg, char *buf, uint_t bufsize)
{
	...
	case FLOW_S_IERRORS:
		...
		break;
	case FLOW_S_IDROPS:
		map_to_units(buf, bufsize, diff_stats->fl_idrops, unit,
		    parsable);
		break;
	case FLOW_S_IDROPBYTES:
		map_to_units(buf, bufsize, diff_stats->fl_idropbytes, unit,
		    parsable);
		break;
	case FLOW_S_OPKTS:
	...
	case FLOW_S_OERRORS:
		...
		break;
	case FLOW_S_ODROPS:
		map_to_units(buf, bufsize, diff_stats->fl_odrops, unit,
		    parsable);
		break;
	case FLOW_S_ODROPBYTES:
		map_to_units(buf, bufsize, diff_stats->fl_odropbytes, unit,
		    parsable);
		break;
	default:
		die("invalid input");
