...
#define	NSS_DBNAM_COMPAT_NUM_DB	4
	/*
...
static	nscd_cfg_param_desc_t	_nscd_cfg_param_desc[] = {
	...
	NSCD_CFG_PARAM_DESC(
		"global_enable_loopback_checking",
		NSCD_CFG_DATA_BOOLEAN,
		NSCD_CFG_PFLAG_GLOBAL,
	...
	NSCD_CFG_PARAM_DESC(
		"global_check_smf_state_interval",
		NSCD_CFG_DATA_INTEGER,
		NSCD_CFG_PFLAG_GLOBAL,
	...
	/* non_global config param from this point on */

	NSCD_CFG_PGROUP_DESC(
		"param_group_frontend",
		NSCD_CFG_DATA_NONE,
		NSCD_CFG_PFLAG_INIT_SEND_WHOLE_GROUP,
		fe,
		nscd_cfg_nsw_db_data_t,
