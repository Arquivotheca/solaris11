	...
	int infd, int outfd, off_t insize)
{
	...
	if (!errflag) {
		 ...
		 * Do the final part
		 *
		 * Note: Because EncryptFinal/DecryptFinal should return
		 * maximally last unfinished block, which is smaller than our
		 * buffer, we should not get CKR_BUFFER_TOO_SMALL error.
		 */
		resultlen = resultbuflen;
