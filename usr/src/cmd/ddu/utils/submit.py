...
class SubmitDlg:
    ...
    def submit_run(self):
        ...
        try:
            http_send = httplib.HTTPS("www.sun.com")
            http_send.putrequest('POST',
                                 "/cgi-bin/sun/bigadmin/parseHCLTool.cgi")
        ...
        if self.__finish == False:
            ...
            if self.__success == True:
                ...
                msg += _("Your submission will now be reviewed before being "
                         "posted to the Oracle Solaris HCL.\n")
                msg += _('To get more Oracle Solaris HCL information, See:\n')
                msg += _('http://www.sun.com/bigadmin/hcl/data/os/.\n')
