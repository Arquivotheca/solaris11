...
/*
 * check that newq is compatible with the groups current disk queue.
 * Newq is incompatible if it is set and the groups queue is set and the queues
 * are different.
 *
 ...
 *		a simckd device or 0 otherwise.  Any line preceded by a '#'
