...
#define	DCMD_HDRSPEC(fl)	\
	((((fl) & DCMD_LOOPFIRST) || !((fl) & DCMD_LOOP)) && \
	    !((fl) & DCMD_PIPE_OUT))
...
#define	MDB_OPT_LISTCB	8		/* mdb_opt_listcb_f+void * args */

typedef int mdb_opt_listcb_f(char, char *, size_t, void *);
#define	MDB_LISTCB_OK		0
#define	MDB_LISTCB_FAIL		(-1)
