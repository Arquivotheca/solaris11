...
extern void	nstrcpy(char *dst, int dstsize, char *src);
extern void	nstrcat(char *dst, int dstsize, char *src);
...
extern void	puthead(struct header *hp, FILE *fo, int w, long clen);
