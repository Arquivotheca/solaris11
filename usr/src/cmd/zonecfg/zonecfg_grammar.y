...
%token ALLOW_PARTITION ALLOW_RAW_IO MACPROFILE
%token ANET ALLOWED_ADDRESS LINKNAME LOWER_LINK ALLOWED_DHCP_CIDS
%token MAC_ADDRESS AUTO_MAC_ADDRESS MAC_PREFIX MAC_SLOT
%token MAXBW PRIORITY VLAN_ID RXRINGS TXRINGS MTU LINK_PROTECTION
%token CONFIGURE_ALLOWED_ADDRESS ALIAS RXFANOUT
...
%type <ival> resource_type NET ANET FS DEVICE RCTL ATTR DATASET PSET PCAP MCAP
    ADMIN
%type <ival> property_name SPECIAL RAW DIR OPTIONS TYPE ADDRESS PHYSICAL NAME
    MATCH ZONENAME ZONEPATH AUTOBOOT POOL LIMITPRIV BOOTARGS VALUE PRIV LIMIT
    ACTION BRAND SCHED IPTYPE DEFROUTER HOSTID USER AUTHS FS_ALLOWED
    ALLOW_PARTITION ALLOW_RAW_IO ALLOWED_ADDRESS LINKNAME LOWER_LINK
    ALLOWED_DHCP_CIDS MAC_ADDRESS AUTO_MAC_ADDRESS MAC_PREFIX MAC_SLOT
    MAXBW PRIORITY VLAN_ID RXRINGS TXRINGS MTU LINK_PROTECTION MACPROFILE
    CONFIGURE_ALLOWED_ADDRESS ALIAS RXFANOUT
%type <cmd> command
...
property_name: SPECIAL	{ $$ = PT_SPECIAL; }
	...
	| CONFIGURE_ALLOWED_ADDRESS	{ $$ = PT_CONFIGURE_ALLOWED_ADDRESS; }
	| PHYSICAL	{ $$ = PT_PHYSICAL; }
	| DEFROUTER	{ $$ = PT_DEFROUTER; }
	| LINKNAME	{ $$ = PT_LINKNAME; }
	| LOWER_LINK	{ $$ = PT_LOWER_LINK; }
	| ALLOWED_DHCP_CIDS	{ $$ = PT_ALLOWED_DHCP_CIDS; }
	| MAC_ADDRESS	{ $$ = PT_MAC_ADDRESS; }
	| AUTO_MAC_ADDRESS	{ $$ = PT_AUTO_MAC_ADDRESS; }
	| MAC_PREFIX	{ $$ = PT_MAC_PREFIX; }
	| MAC_SLOT	{ $$ = PT_MAC_SLOT; }
	| MAXBW		{ $$ = PT_MAXBW; }
	...
	| TXRINGS	{ $$ = PT_TXRINGS; }
	| MTU		{ $$ = PT_MTU; }
	| LINK_PROTECTION	{ $$ = PT_LINK_PROTECTION; }
	| NAME		{ $$ = PT_NAME; }
	| VALUE		{ $$ = PT_VALUE; }
	| MATCH		{ $$ = PT_MATCH; }
	| PRIV		{ $$ = PT_PRIV; }
	...
	| ALLOW_PARTITION	{ $$ = PT_ALLOW_PARTITION; }
	| ALLOW_RAW_IO	{ $$ = PT_ALLOW_RAW_IO; }
	| MACPROFILE	{ $$ = PT_MAC_PROFILE; }
	| ALIAS		{ $$ = PT_ALIAS; }
	| RXFANOUT	{ $$ = PT_RXFANOUT; }
