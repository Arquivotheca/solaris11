...
#define	READANY(f)	((stat((f), &__s_) == 0) && \
	((__s_.st_mode & (0004)) != 0))
#define	READSOME(f)	((stat((f), &__s_) == 0) && \
	((__s_.st_mode & (0444)) != 0))

#define	WRITEANY(f)	((stat((f), &__s_) == 0) && \
	((__s_.st_mode & (0002)) != 0))
#define	DIRECTORY(f)	((stat((f), &__s_) == 0) && \
	((__s_.st_mode & (S_IFMT)) == S_IFDIR))
