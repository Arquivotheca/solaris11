...
#define	HEX_FLAG	0x100000
#define	DEC_FLAG	0x200000
#define	SORT_CPU_FLAG	0x400000
#define	SORT_DRV_FLAG	0x800000
#define	RETRAIN_FLAG	0x1000000
#define	EQUA_FLAG	0x2000000
#define	CTO_FLAG	0x4000000
...
/* PCIe last field offset */
#define	PCIE_LS_OFF	0
#define	PCIE_LW_OFF	1
#define	PCIE_MLS_OFF	2
#define	PCIE_MLW_OFF	3
#define	PCIE_SLS_OFF	4
#define	PCIE_CTO_OFF	5

#define	PCI_FIRST_FIELDS_NUM    10
...
#define	SNPRINTF(name, fmt, data) (void)snprintf(name, sizeof (name), fmt, data)
