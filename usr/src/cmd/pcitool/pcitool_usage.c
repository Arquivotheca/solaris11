...
"  [ -v ]",
"  [ -q ]",
"  [ -t <link speed to retrain> ]",
"  [ -L ]",
"  [ -u <completion timeout value> ]",
"",
"  -n may also include:",
"",
"  [ -y ]",
...
"Interrupt mode:",
" X86:",
" %s pci@<unit-address> -i <cpu#,ino#> |",
"       [ all [ -s cpu | driver ] [ -h |-d ] ]",
"	[ -r [ -c ] |  -w <cpu#> [ -g ] ] [ -v ] [ -q ]",
" SPARC:",
" %s pci@<unit-address> -i <ino#> |",
"       [ all [ -s cpu | driver ] [ -h |-d ] ]",
"	[ -r [ -c ] |  -w <cpu#> [ -g ] ] [ -v ] [ -q ]",
" %s pci@<unit-address> -m <msi#> |",
"       [ all [ -s cpu | driver ] [ -h |-d ] ]",
"	[ -r [ -c ] |  -w <cpu#> [ -g ] ] [ -v ] [ -q ]",
"",
"where",
...
"--------------",
"",
"-i <cpu#,ino#> or <ino#> changes or retrieves current interrupts information",
"   of given nexus and given INO. The special value of 'all' can be used to",
"   select all INOs.",
"",
"-m <msi#> changes or retrieves current interrupts information of given",
...
"",
"all [ -s cpu | driver ][ -h | -d ] displays all interrupts information on a",
"    given nexus. If the option \"all\" is not provided on the commandline,",
"    it is assumed, but the option \"all\" must be provided when use the ",
"    options -s, -h, -d. Besides, -h and -d must be at end of the commandline."
"",
"    The option -s cpu | driver is to sort by cpu or driver name.",
"    The option  -h | -d is to display all numbers in decimal or hexadecimal.",
"    No \"0x\" prefix is used in the output when the the -h option is used.",
"    The numbers are by default display in Hexadecimal.",
"",
...
"    instead.",
"       drivername # instance number [interrupt number]",
"",
