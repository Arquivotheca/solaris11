 ...
 */
static const char *script_ps_state_file = _PATH_SYSVOL "/rcm_script_state";
...
run_script(script_info_t *rsi, char *argv[], char *envp[], char **errmsg)
{
	...
	*errmsg = NULL;
	 ...
	 *   RCM_STATE_FILE   - _PATH_SYSVOL/rcm_daemon_state
	 *   DAEMON_LOCK_FILE - _PATH_SYSVOL/rcm_daemon_lock
	 *   RCM_SERVICE_DOOR - _PATH_SYSVOL/rcm_daemon_door
