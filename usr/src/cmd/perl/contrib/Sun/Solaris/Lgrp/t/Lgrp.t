...
##
$c = Sun::Solaris::Lgrp->new(LGRP_VIEW_OS) or
    die "Lgrp->new(LGRP_VIEW_OS): $!";

my $c_caller = Sun::Solaris::Lgrp->new(LGRP_VIEW_CALLER) or
    die "Lgrp->new(LGRP_VIEW_CALLER): $!";

my $c_default = Sun::Solaris::Lgrp->new() or
    die "Lgrp->new(): $!";

ok($c->view, LGRP_VIEW_OS);
ok($c_caller->view, LGRP_VIEW_CALLER);
ok($c_default->view, LGRP_VIEW_OS);
