...
extern int kadmin_addprinc __SS_PROTO;
static char const * const ssu00002[] = {
"delete_principal",
    "delprinc",
    (char const *)0
};
extern int kadmin_delprinc __SS_PROTO;
static char const * const ssu00003[] = {
"modify_principal",
    "modprinc",
    (char const *)0
};
extern int kadmin_modprinc __SS_PROTO;
static char const * const ssu00004[] = {
"change_password",
    "cpw",
    (char const *)0
};
extern int kadmin_cpw __SS_PROTO;
static char const * const ssu00005[] = {
"get_principal",
    "getprinc",
    (char const *)0
};
extern int kadmin_getprinc __SS_PROTO;
...
extern int kadmin_getprincs __SS_PROTO;
static char const * const ssu00007[] = {
"add_policy",
    "addpol",
    (char const *)0
};
extern int kadmin_addpol __SS_PROTO;
static char const * const ssu00008[] = {
"modify_policy",
    "modpol",
    (char const *)0
};
extern int kadmin_modpol __SS_PROTO;
static char const * const ssu00009[] = {
"delete_policy",
    "delpol",
    (char const *)0
};
extern int kadmin_delpol __SS_PROTO;
static char const * const ssu00010[] = {
"get_policy",
    "getpol",
    (char const *)0
};
extern int kadmin_getpol __SS_PROTO;
...
extern int kadmin_getpols __SS_PROTO;
static char const * const ssu00012[] = {
"get_privs",
    "getprivs",
    (char const *)0
};
extern int kadmin_getprivs __SS_PROTO;
static char const * const ssu00013[] = {
"ktadd",
    "xst",
    (char const *)0
};
extern int kadmin_keytab_add __SS_PROTO;
static char const * const ssu00014[] = {
"ktremove",
    "ktrem",
    (char const *)0
};
extern int kadmin_keytab_remove __SS_PROTO;
static char const * const ssu00015[] = {
"lock",
    (char const *)0
};
extern int kadmin_lock __SS_PROTO;
static char const * const ssu00016[] = {
"unlock",
    (char const *)0
};
extern int kadmin_unlock __SS_PROTO;
...
extern int ss_list_requests __SS_PROTO;
