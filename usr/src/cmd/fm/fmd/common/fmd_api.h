...
extern boolean_t fmd_hdl_unloading(fmd_hdl_t *);
...
extern ssize_t fmd_nvl_fmri_nvl2str(fmd_hdl_t *, nvlist_t *, char *, size_t);
...
extern int fmd_nvl_fmri_presence_state(fmd_hdl_t *, nvlist_t *);
extern int fmd_nvl_fmri_service_state(fmd_hdl_t *, nvlist_t *);
extern int fmd_nvl_fmri_has_fault(fmd_hdl_t *, nvlist_t *, int, char *);

#define	FMD_HAS_FAULT_FRU	0x0
#define	FMD_HAS_FAULT_ASRU	0x1
#define	FMD_HAS_FAULT_RESOURCE	0x2

#define	FMD_HAS_FAULT_TYPE_MASK	0x7

#define	FMD_HAS_FAULT_RETIRE	0x8	/* exclude retire=0 faults */
#define	FMD_HAS_FAULT_RESPONSE	0x10	/* exclude response=0 faults */

extern void fmd_repair_fru(fmd_hdl_t *, const char *);
extern int fmd_repair_asru(fmd_hdl_t *, const char *);
extern void fmd_resolved_asru(fmd_hdl_t *, nvlist_t *);
extern void fmd_isolated_asru(fmd_hdl_t *, nvlist_t *);
extern void fmd_resolved_fru(fmd_hdl_t *, nvlist_t *);
extern void fmd_isolated_fru(fmd_hdl_t *, nvlist_t *);
