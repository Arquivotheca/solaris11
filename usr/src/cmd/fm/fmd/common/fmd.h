...
typedef struct fmd_statistics {
	...
	fmd_stat_t ds_dr_filter_class;	/* DR events filtered by class */
	fmd_stat_t ds_dr_filter_time;	/* DR events filtered by time */
	fmd_stat_t ds_dr_filter_cna_dev; /* DR events filtered by CNA_DEV */
	fmd_stat_t ds_dr_filter_debug;	/* DR events filter debug */
...
typedef struct fmd {
	...
	fmd_event_t *d_mod_start_sync_event;	/* startup sync event */
	fmd_event_t *d_mod_start_topo_event;	/* startup topo change event */
	fmd_event_t *d_mod_dr_topo_event;	/* dr topo change event */
	...
	fmd_topo_t *d_topo_current;	/* current topology */
	fmd_topo_t *d_topo_previous;	/* previous topology */
