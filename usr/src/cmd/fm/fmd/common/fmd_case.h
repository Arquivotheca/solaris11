...
typedef struct fmd_case_impl {
	...
	char *ci_topo_uuid;		/* uuid string for case topology */
} fmd_case_impl_t;
...
#define	FMD_CF_FLUSH_IMM	0x100	/* case should be flushed immediately */
...
extern fmd_case_t *fmd_case_recreate(struct fmd_module *,
    struct fmd_xprt *, uint_t, const char *, const char *, const char *);
...
extern nvlist_t *fmd_case_mkreplayevent(fmd_case_t *, const char *);
...
extern void fmd_case_update(fmd_case_t *);
extern void fmd_case_check_isolated(fmd_case_t *);
extern void fmd_case_check_resolved(fmd_case_t *);
...
extern int fmd_case_update_status(fmd_case_t *, uint8_t *, uint8_t *,
    uint8_t *);
...
extern void fmd_case_set_flush(fmd_case_t *, void *);
