...
typedef struct fcf_case {
	...
	fcf_stridx_t fcfc_topo_uuid; /* topo snapshot uuid */
} fcf_case_t;

#define	FCF_CASE_UNSOLVED	0
#define	FCF_CASE_SOLVED		1
#define	FCF_CASE_CLOSE_WAIT	2
#define	FCF_CASE_REPAIR_WAIT	3
#define	FCF_CASE_DISCARD_WAIT	4
#define	FCF_CASE_STATE_MAX	FCF_CASE_DISCARD_WAIT
