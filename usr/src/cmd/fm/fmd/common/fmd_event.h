...
#define	FMD_EVT_PROTOCOL_STR	"protocol"
#define	FMD_EVT_TIMEOUT_STR	"timeout"
#define	FMD_EVT_CLOSE_STR	"close"
#define	FMD_EVT_STATS_STR	"stats"
#define	FMD_EVT_GC_STR		"gc"
#define	FMD_EVT_CTL_STR		"control"
#define	FMD_EVT_PUBLISH_STR	"publish"
#define	FMD_EVT_TOPO_STR	"topo"
#define	FMD_EVT_UNKNOWN_STR	"unknown"
...
extern void fmd_event_rele_no_ctl_wait(fmd_event_t *);
extern const char *fmd_event_type2str(uint8_t);
