...
#define	FMD_MOD_DISP_NAMED	0x01	/* dispatch to named module */
#define	FMD_MOD_DISP_NONXPRT	0x02	/* dispatch to non transports */
...
extern void fmd_modhash_dispatch(fmd_modhash_t *, fmd_event_t *, int, char *);
