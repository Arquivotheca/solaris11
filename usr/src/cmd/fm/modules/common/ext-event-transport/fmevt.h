...
struct fmevt_ppargs {
	...
	char pp_uuidstr[UUID_PRINTABLE_STRING_LENGTH];	/* for first event */
};
...
extern void fmevt_pp_smf_init(fmd_hdl_t *);
extern void fmevt_pp_smf_fini(fmd_hdl_t *);
...
extern void fmevt_debug(int, const char *, ...);
