...
utmpx_mark_init(pid_t pid, char *prefix)
{
	...
	ut.ut_id[0] = ut.ut_id[1] = ut.ut_id[2] = ut.ut_id[3] =
	    _UTMP_ID_WILDCARD;
...
/*
 * void utmpx_create(void)
 *   At boot and only at boot, create and truncate the utmpx file.
 *   Locks are not needed before it is run early in main.
 */
static void
utmpx_create(void)
{
