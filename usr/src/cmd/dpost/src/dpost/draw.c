...
extern const char	*drawfile;
extern const char	*baselinefile;
extern FILE		*tf;
...
extern int		doglobal(const char *);
extern void		endtext(void);
extern void		getcolor(void);
extern void		hgoto(int);
extern void		reset(void);
extern void		resetpos(void);
extern void		t_sf(void);
extern void		vgoto(int);
extern void		xymove(int, int);
 ...
 * preceded by an "x X NewBaseline" call that defines the current baseline. The
