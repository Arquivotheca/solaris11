...
#define	YPDNSVERS	2L
#define	RESOLV_EXEC_PATH	"/usr/lib/netsvc/yp/ypserv_resolv"
#define	RESOLV_EXEC_ERR	"can't exec /usr/lib/netsvc/yp/ypserv_resolv: %s\n"
			...
			CLIENT **client, char *tp_type, long prognum)
{
	...
	case 0:  /* child  */
		 ...
		 */
		execlp(RESOLV_EXEC_PATH, "ypserv_resolv",
		    "-F",		/* forground  */
		    "-C", fd_str,	/* dont close */
		    "-p", prog_str,	/* prognum    */
		    "-t", tp,	/* tp type    */
