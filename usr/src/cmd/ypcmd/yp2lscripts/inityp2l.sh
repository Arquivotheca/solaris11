...
#
#
# Save the header and reuse it when writing the configuration files.
#
header=\
'#
# CDDL HEADER START
...
#
# Read a separate comment character for a MAP for each domain and
...
#
# List repeated field separators
#
...
# List split fields and repeated fields separators.
create_split_field_and_repeatedfield_seperators
