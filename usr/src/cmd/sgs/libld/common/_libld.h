...
#define	AL_CNT_OFL_MAPASSERT	10	/* ofl_mapassert */
...
#define	AL_CNT_OFL_MAPCLADD	2	/* ofl_mapcladd */
...
/*
 * Define a -z strip-class token descriptor, and indexes into the descriptor
 * array.
 */
typedef struct {
	Msg		class;
...
#define	SC_NONALLOC	0		/* MSG_ARG_STRIP_NONALLOC */
#define	SC_ANNOTATE	1		/* MSG_ARG_STRIP_ANNOTATE */
#define	SC_COMMENT	2		/* MSG_ARG_STRIP_COMMENT */
#define	SC_DEBUG	3		/* MSG_ARG_STRIP_DEBUG */
#define	SC_EXCLUDE	4		/* MSG_ARG_STRIP_EXCLUDE */
#define	SC_NOTE		5		/* MSG_ARG_STRIP_NOTE */
#define	SC_SYMBOL	6		/* MSG_ARG_STRIP_SYMBOL */
#define	SC_NUM		7
...
extern const int	assert_data_symtype[];
extern const Strip_cls	strip_cls_items[];
...
#define	ld_assert_deflib_enter	ld64_assert_deflib_enter
#define	ld_assert_deflib_finish	ld64_assert_deflib_finish
#define	ld_assert_deflib_test	ld64_assert_deflib_test
...
#define	ld_assert_deflib_enter	ld32_assert_deflib_enter
#define	ld_assert_deflib_finish	ld32_assert_deflib_finish
#define	ld_assert_deflib_test	ld32_assert_deflib_test
...
extern void		ld_ar_member(Ar_desc *, Elf_Arsym *, Ar_aux *,
			    Ar_mem *);
extern Ld_ret		ld_assert_deflib_enter(Ofl_desc *, const char *);
extern void		ld_assert_deflib_finish(Ofl_desc *);
extern void		ld_assert_deflib_test(Ofl_desc *, const char *,
			    Boolean);
...
extern Is_desc		*ld_make_mapfile_data(Ofl_desc *, size_t, Boolean,
			    Boolean);
extern Is_desc		*ld_make_mapfile_text(Ofl_desc *, size_t);
extern uintptr_t	ld_make_parexpn_data(Ofl_desc *, size_t, Xword);
extern uintptr_t	ld_make_sunwmove(Ofl_desc *, int);
extern Ld_ret		ld_map_cexp_cmdline(Ofl_desc *, const char *);
...
extern Boolean		ld_map_sym_assert(Ofl_desc *);

extern uintptr_t	ld_open_outfile(Ofl_desc *);

extern Is_desc		*ld_os_first_isdesc(Os_desc *);
extern Is_desc		*ld_os_offset_to_isdesc(Os_desc *osp, Off, Off *);
...
extern Ld_ret		ld_sym_add_u(const char *, Ofl_desc *, Msg,
			    Sym_desc **);
...
extern Ld_ret		ld_wrap_enter(Ofl_desc *, const char *);
