...
extern	void		dump_eh_frame(const char *, const char *, int,
			    uchar_t *, size_t, uint64_t, uint64_t,
			    Half e_machine, uchar_t *e_ident);
extern	void		dump_hex_bytes(const void *, size_t, int, int, int);
extern	uint64_t	elfdump_ehe_extract(const char *, const char *, int,
			    uchar_t *, uchar_t *, uint64_t *, uint_t,
			    uchar_t *, uint64_t, uint64_t);

extern	int		fake_shdr_cache32(const char *, int, Elf *,
			    Elf32_Ehdr *, Cache **, size_t *);
extern	int		fake_shdr_cache64(const char *, int, Elf *,
			    Elf64_Ehdr *, Cache **, size_t *);

extern	void		fake_shdr_cache_free32(Cache *, size_t);
extern	void		fake_shdr_cache_free64(Cache *, size_t);

extern	int		regular32(const char *, int, Elf *, uint_t,
			    const char *, int, uchar_t);
extern	int		regular64(const char *, int, Elf *, uint_t,
			    const char *, int, uchar_t);
