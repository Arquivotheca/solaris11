...
#define	DW_EH_PE_datarel	0x30	/* .eh_frame value is relative to the */
					/*    GOT. .eh_frame_hdr value is */
					/*    relative to .eh_frame_hdr base */
 ...
 */
extern	uint64_t	uleb_extract(uchar_t *, uint64_t *);
extern	int64_t		sleb_extract(uchar_t *, uint64_t *);
extern	uint64_t	dwarf_ehe_extract(uchar_t *, uint64_t *,
			    uint_t, uchar_t *, Boolean *, uint64_t,
			    uint64_t);
