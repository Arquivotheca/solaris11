...
#define	DBG_ARGS_GUIDANCE	1
#define	DBG_ARGS_STRIP_CLASS	2

/*
 * Dbg_sec_gnu_comdat() type values --- Types of GNU COMDAT
 */
#define	DBG_GNUCOMDAT_LINKONCE	0	/* linkonce section names */
#define	DBG_GNUCOMDAT_GROUP	1	/* COMDAT groups */
#define	DBG_GNUCOMDAT_NUM	DBG_GNUCOMDAT_GROUP + 1

/*
 * Dbg_reloc_relax() type values --- Reasons -z relaxreloc can be enabled
 */
#define	DBG_RLXREL_ARG		0	/* set on command line */
#define	DBG_RLXREL_LINKONCE	1	/* GNU linkonce section */
#define	DBG_RLXREL_GASCOMDAT	2	/* GNU as COMDAT section name */
#define	DBG_RLXREL_GRPCMT	3	/* SHT_GROUP and GNU comment */
#define	DBG_RLXREL_NUM		DBG_RLXREL_GNUGRP + 1
...
#define	Dbg_map_stub		Dbg64_map_stub
...
#define	Dbg_reloc_badalign	Dbg64_reloc_badalign
...
#define	Dbg_reloc_ignored	Dbg64_reloc_ignored
...
#define	Dbg_reloc_relax		Dbg64_reloc_relax
...
#define	Dbg_unused_strip	Dbg64_unused_strip
...
#define	Dbg_map_stub		Dbg32_map_stub
...
#define	Dbg_reloc_badalign	Dbg32_reloc_badalign
...
#define	Dbg_reloc_ignored	Dbg32_reloc_ignored
...
#define	Dbg_reloc_relax		Dbg32_reloc_relax
...
#define	Dbg_unused_strip	Dbg32_unused_strip
 ...
 */
extern	void	Dbg_args_file(Lm_list *, int, char *, Boolean);
extern	void	Dbg_args_lib_option(Lm_list *, int, int, char *, Boolean);
extern	void	Dbg_args_option(Lm_list *, int, int, char *);
extern	void	Dbg_args_str2chr(Lm_list *, int, const char *, int);
extern	void	Dbg_args_unknown(Lm_list *, const char *, int);
extern	void	Dbg_args_unused_assert_deflib(Lm_list *, const char *);
...
extern	void	Dbg_cap_id(Lm_list *, const char *, Lineno, const char *,
		    const char *);
extern	void	Dbg_cap_identical(Lm_list *, const char *, const char *);
extern	void	Dbg_cap_mapfile_title(Lm_list *, const char *, Lineno);
...
extern	void	Dbg_file_rejected(Lm_list *, Rej_desc *, Half);
...
extern	void	Dbg_map_cexp_id(Lm_list *, Boolean, const char *, Lineno,
		    const char *);
extern	void	Dbg_map_dv(Lm_list *, const char *, const char *, Lineno);
extern	void	Dbg_map_dv_entry(Lm_list *, const char *, Lineno, int,
		    const char *);
extern	void	Dbg_map_ent(Lm_list *, Ent_desc *, Ofl_desc *, const char *,
		    Lineno);
extern	void	Dbg_map_ent_ord_title(Lm_list *, const char *);
extern	void	Dbg_map_hdr_noalloc(Lm_list *, const char *, Lineno);
...
extern	void	Dbg_map_seg(Ofl_desc *, dbg_state_t, int, Sg_desc *,
		    const char *, Lineno);
...
extern	void	Dbg_map_seg_os_order(Lm_list *, Sg_desc *, const char *,
		    Word, const char *, Lineno);
extern	void	Dbg_map_size_new(Lm_list *, const char *, const char *,
		    const char *, Lineno);
extern	void	Dbg_map_size_old(Ofl_desc *, Sym_desc *, const char *,
		    const char *, Lineno);
extern	void	Dbg_map_sort_title(Lm_list *, Boolean);
extern	void	Dbg_map_sort_seg(Lm_list *, uchar_t, Half, Sg_desc *);
extern	void	Dbg_map_stub(Lm_list *, const char *, Lineno);
...
extern	void	Dbg_reloc_badalign(Lm_list *, const char *, const char *,
		    const char *, uintptr_t, Word);
extern	void	Dbg_reloc_copy(Rt_map *, Rt_map *, const char *, int);
extern	void	Dbg_reloc_discard(Lm_list *, Half, Word, Rel_desc *, uintptr_t,
		    rel_desc_sname_func_t);
extern	void	Dbg_reloc_doact(Lm_list *, int, Half, Word, Rel_desc *,
		    uintptr_t, Xword, rel_desc_sname_func_t, const char *);
...
extern	void	Dbg_reloc_ignored(Lm_list *, Half, Word, Rel_desc *, uintptr_t,
		    rel_desc_sname_func_t);
...
extern	void	Dbg_sec_gnu_comdat(Lm_list *, int, Is_desc *);
...
extern	void	Dbg_unused_strip(Lm_list *, const char *, Ifl_desc *, Word,
		    Xword, const char *);
