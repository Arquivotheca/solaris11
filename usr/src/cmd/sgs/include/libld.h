...
/*
 * Generic function return identifier.
 */
typedef	enum {
	LD_TRUE,			/* true condition */
	LD_FALSE,			/* false condition */
	LD_ERROR			/* fatal condition - abort processing */
} Ld_ret;
...
struct ofl_desc {
	...
	Rlxrel_cache	ofl_sr_cache;	/* Cache last result from */
					/*	sloppy_comdat_reloc() */
	APlist		*ofl_mapbcksec;	/* mapfile added sym backing sections */
	Alist		*ofl_mapassert;	/* list of mapfile ASSERT records */
	APlist		*ofl_mapcladd;	/* list of -z mapfile-add strings */
	avl_tree_t	*ofl_wrap;	/* -z wrap symbols */
	avl_tree_t	*ofl_asdeflib;	/* NULL, or -z assert-deflib names */
	ofl_guideflag_t	ofl_guideflags;	/* -z guidance flags */
	ofl_stripflag_t	ofl_stripflags;	/* -z strip-class flags */
	ofl_stripflag_t	ofl_nstripflags; /* -z strip-class '!' flags */
};
...
#define	FLG_OF_STUBDIR	0x800000000000	/* STUB_OBJECT mapfile directive seen */
...
#define	FLG_OFG_NO_LIBPATH	0x00000040	/* usr correct search path */
 ...
 * Strip class flags.
 */
#define	FLG_SC_NONALLOC		0x0001		/* strip non-allocatable data */
#define	FLG_SC_ANNOTATE		0x0002		/* strip annotate data */
#define	FLG_SC_COMMENT		0x0004		/* strip comment data */
#define	FLG_SC_DEBUG		0x0008		/* strip debug data */
#define	FLG_SC_EXCLUDE		0x0010		/* strip exclude sections */
#define	FLG_SC_NOTE		0x0020		/* strip note data */
#define	FLG_SC_SYMBOL		0x0040		/* strip symbol data */

#define	FLG_OFS_ALL		0xffff

/*
 * Test to determine whether a given class can be stripped.  Providing a
 * non-strip class flag has not been set, and a strip class flag has, the
 * associated class can be removed.
 */
#define	OFL_STRIP(_ofl, _flag) ((((_ofl)->ofl_nstripflags & _flag) == 0) && \
	((_ofl)->ofl_stripflags & _flag))
...
#define	FLG_REL_GETADDR	0x00800000	/* tls_get_addr() reference */
...
struct ifl_desc {			/* input file descriptor */
	...
	time_t		ifl_mtime;	/* modification time */
...
#define	FLG_IF_GNUCMT	0x00200000	/* .comment containing (GNU) seen */
...
#define	FLG_IS_STABS	0x2000		/* section name starts with .stab */
...
#define	FLG_SY_CAP	0x0080000000000	/* symbol is associated with */
					/*    capabilities */
#define	FLG_SY_DEFERRED	0x0100000000000	/* symbol should not be bound to */
					/*	during BIND_NOW relocations */
#define	FLG_SY_LDSTD	0x0200000000000 /* Standard symbols provided by libld */
#define	FLG_SY_MFASDATA	0x0400000000000 /* Symbol has mapfile data ASSERT, or */
					/*    equivalent mapfile declaration */
...
typedef void		*_ld_imgcalloc_func_t(size_t, size_t);
...
extern uintptr_t	ld_ent_setup(Ofl_desc *, Xword, _ld_imgcalloc_func_t);
