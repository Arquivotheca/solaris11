...
struct	Dnode
{
	...
	uint_t		db_uflags;	/* user flags: ELF_F_... */
	uint_t		db_myflags;	/* internal flags: DBF_... */
...
struct	Elf_Scn
{
	...
	uint_t		s_shflags;	/* user shdr flags */
	uint_t		s_uflags;	/* user flags */
	uint_t		s_myflags;	/* SF_... */
...
struct Elf
{
	...
	uint_t		*ed_vm;		/* virtual memory map */
	size_t		ed_vmsz;	/* # regions in vm */
	uint_t		ed_encode;	/* data encoding */
	uint_t		ed_version;	/* file version */
	...
	uint_t		ed_myflags;	/* EDF_... */
	uint_t		ed_ehflags;	/* ehdr flags */
	uint_t		ed_phflags;	/* phdr flags */
	uint_t		ed_uflags;	/* elf descriptor flags */
};
...
extern size_t		_elf32_entsz(Elf *elf, Elf32_Word, uint_t);
extern size_t		_elf64_entsz(Elf *elf, Elf64_Word, uint_t);
extern Okay		_elf_inmap(Elf *);
extern char		*_elf_outmap(Elf *, size_t);
extern size_t		_elf_outsync(Elf *, char *, size_t);
extern size_t		_elf32_msize(Elf_Type, uint_t);
extern size_t		_elf64_msize(Elf_Type, uint_t);
extern Elf_Type		_elf32_mtype(Elf *, Elf32_Word, uint_t);
extern Elf_Type		_elf64_mtype(Elf *, Elf64_Word, uint_t);
...
extern uint_t		_elf_encode;
extern _elf_execfill_func_t *_elf_execfill_func;
extern _elf_imgcalloc_func_t *_elf_imgcalloc_func;
