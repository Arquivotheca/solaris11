...
MACHOBJS=
COMOBJS=	ar.o		begin.o		callback.o	cntl.o \
		cook.o		data.o		end.o		flag.o \
...
FILEOBJS=	elf_file.o	elf_file_machelf.o
FILECLASSOBJS=	elf_file_machelf64.o

OBJECTS=	$(BLTOBJS)  $(MACHOBJS)  $(COMOBJS)  $(CLASSOBJS) $(MISCOBJS) \
		$(FILEOBJS) $(FILECLASSOBJS)
...
CPPFLAGS +=	-I$(SRC)/common/elf_file -I$(SRC)/common/sgsrtcid
...
LIBSRCS=	$(COMOBJS:%.o=../common/%.c)  $(MISCOBJS:%.o=../misc/%.c) \
		$(MACHOBJS:%.o=%.c)  $(FILEOBJS:%.o=../elf_file/%.c) $(BLTSRCS)
