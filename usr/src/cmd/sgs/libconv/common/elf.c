...
ehdr_mach_strings(Conv_fmt_flags_t fmt_flags)
{
	...
	static const Msg mach_0_11_fil[] = {
		MSG_EM_NONE_FIL,	MSG_EM_M32_DMP,
		MSG_EM_SPARC_DMP,	MSG_EM_386_DMP,
		MSG_EM_68K_FIL,		MSG_EM_88K_FIL,
		MSG_EM_486_DMP,		MSG_EM_860_DMP,
		MSG_EM_MIPS_FIL,	MSG_EM_S370_FIL,
		MSG_EM_MIPS_RS3_LE_FIL,	MSG_EM_RS6000_FIL
	};
	...
	static const conv_ds_msg_t ds_mach_0_11_fil = {
	    CONV_DS_MSG_INIT(EM_NONE, mach_0_11_fil) };
	...
	static const Msg mach_15_22_fil[] = {
		MSG_EM_PA_RISC_FIL,	MSG_EM_NCUBE_DMP,
		MSG_EM_VPP500_DMP,	MSG_EM_SPARC32PLUS_DMP,
		MSG_EM_960_FIL,		MSG_EM_PPC_DMP,
		MSG_EM_PPC64_DMP,	MSG_EM_S390_FIL
	};
	...
	static const conv_ds_msg_t ds_mach_15_22_fil = {
	    CONV_DS_MSG_INIT(EM_PA_RISC, mach_15_22_fil) };
	...
	static const Msg mach_36_63_fil[] = {
		MSG_EM_V800_FIL,	MSG_EM_FR20_FIL,
		MSG_EM_RH32_FIL,	MSG_EM_RCE_FIL,
		MSG_EM_ARM_DMP,		MSG_EM_ALPHA_DMP,
		MSG_EM_SH_FIL,		MSG_EM_SPARCV9_DMP,
		MSG_EM_TRICORE_FIL,	MSG_EM_ARC_FIL,
		MSG_EM_H8_300_FIL,	MSG_EM_H8_300H_FIL,
		MSG_EM_H8S_FIL,		MSG_EM_H8_500_FIL,
		MSG_EM_IA_64_FIL,	MSG_EM_MIPS_X_FIL,
		MSG_EM_COLDFIRE_FIL,	MSG_EM_68HC12_FIL,
		MSG_EM_MMA_FIL,		MSG_EM_PCP_FIL,
		MSG_EM_NCPU_FIL,	MSG_EM_NDR1_FIL,
		MSG_EM_STARCORE_FIL,	MSG_EM_ME16_FIL,
		MSG_EM_ST100_FIL,	MSG_EM_TINYJ_FIL,
		MSG_EM_AMD64_DMP,	MSG_EM_PDSP_FIL
	};
	...
	static const conv_ds_msg_t ds_mach_36_63_fil = {
	    CONV_DS_MSG_INIT(EM_V800, mach_36_63_fil) };
	...
	static const Msg mach_66_94_fil[] = {
		MSG_EM_FX66_FIL,	MSG_EM_ST9PLUS_FIL,
		MSG_EM_ST7_FIL,		MSG_EM_68HC16_FIL,
		MSG_EM_68HC11_FIL,	MSG_EM_68HC08_FIL,
		MSG_EM_68HC05_FIL,	MSG_EM_SVX_FIL,
		MSG_EM_ST19_FIL,	MSG_EM_VAX_DMP,
		MSG_EM_CRIS_FIL,	MSG_EM_JAVELIN_FIL,
		MSG_EM_FIREPATH_FIL,	MSG_EM_ZSP_FIL,
		MSG_EM_MMIX_FIL,	MSG_EM_HUANY_FIL,
		MSG_EM_PRISM_FIL,	MSG_EM_AVR_FIL,
		MSG_EM_FR30_FIL,	MSG_EM_D10V_FIL,
		MSG_EM_D30V_FIL,	MSG_EM_V850_FIL,
		MSG_EM_M32R_FIL,	MSG_EM_MN10300_FIL,
		MSG_EM_MN10200_FIL,	MSG_EM_PJ_FIL,
		MSG_EM_OPENRISC_FIL,	MSG_EM_ARC_A5_FIL,
		MSG_EM_XTENSA_FIL
	};
...
#error	"EM_NUM has grown"
	...
	static const conv_ds_msg_t ds_mach_66_94_fil = {
	    CONV_DS_MSG_INIT(EM_FX66, mach_66_94_fil) };
	...
	static const conv_ds_t	*ds_fil[] = {
		CONV_DS_ADDR(ds_mach_0_11_fil), CONV_DS_ADDR(ds_mach_15_22_fil),
		CONV_DS_ADDR(ds_mach_36_63_fil),
		CONV_DS_ADDR(ds_mach_66_94_fil), NULL
	};
...
{
	/*
	 * Special case: For CONV_FMT_ALT_FILE, if the machine exceeds
	 * the known machines, return the string "unknown machine" rather
	 * than producing a hex number. The number looks odd in output
	 * from the file command, since there's no label tied to it.
	 */
	if ((machine >= EM_NUM) && (fmt_flags & CONV_FMT_ALT_FILE))
		return (MSG_ORIG(MSG_EM_NONE_FIL));
    ...
    Half mach)
{
	...
	case SGS_REJ_PLATCAP:
		...
		else if (rej->rej_info)
			return (conv_invalid_val(&reject_desc_buf->inv_buf,
			    rej->rej_info, 0));
		else
			return (MSG_ORIG(MSG_STR_EMPTY));
	case SGS_REJ_ARCHIVE:
		return (MSG_ORIG(MSG_STR_ARCHIVE));
	default:
