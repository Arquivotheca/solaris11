...
#define	LIN	ELFOSABI_LINUX, EM_NONE
	...
	static const Val_desc2 binds_osabi_def[] = {
		{ STB_GNU_UNIQUE,	LIN,	MSG_STB_GNU_UNIQUE_DEF },
		{ 0 }
	};
	static const Val_desc2 binds_osabi_cf[] = {
		{ STB_GNU_UNIQUE,	LIN,	MSG_STB_GNU_UNIQUE_CF },
		{ 0 }
	};
	static const Val_desc2 binds_osabi_cfnp[] = {
		{ STB_GNU_UNIQUE,	LIN,	MSG_STB_GNU_UNIQUE_CFNP },
		{ 0 }
	};
	static const Val_desc2 binds_osabi_nf[] = {
		{ STB_GNU_UNIQUE,	LIN,	MSG_STB_GNU_UNIQUE_NF },
		{ 0 }
	};

	static const conv_ds_vd2_t ds_binds_osabi_def = {
	    CONV_DS_VD2, STB_LOOS, STB_HIOS, binds_osabi_def };
	static const conv_ds_vd2_t ds_binds_osabi_cf = {
	    CONV_DS_VD2, STB_LOOS, STB_HIOS, binds_osabi_cf };
	static const conv_ds_vd2_t ds_binds_osabi_cfnp = {
	    CONV_DS_VD2, STB_LOOS, STB_HIOS, binds_osabi_cfnp };
	static const conv_ds_vd2_t ds_binds_osabi_nf = {
	    CONV_DS_VD2, STB_LOOS, STB_HIOS, binds_osabi_nf };

	/* Build NULL terminated return arrays for each string style */
	static const conv_ds_t	*ds_def[] = {
		CONV_DS_ADDR(ds_binds_def), CONV_DS_ADDR(ds_binds_osabi_def),
		NULL };
	static const conv_ds_t	*ds_cf[] = {
		CONV_DS_ADDR(ds_binds_cf), CONV_DS_ADDR(ds_binds_osabi_cf),
		NULL };
	static const conv_ds_t	*ds_cfnp[] = {
		CONV_DS_ADDR(ds_binds_cfnp), CONV_DS_ADDR(ds_binds_osabi_cfnp),
		NULL };
	static const conv_ds_t	*ds_nf[] = {
		CONV_DS_ADDR(ds_binds_nf), CONV_DS_ADDR(ds_binds_osabi_nf),
		NULL };
...
const char *
conv_sym_info_bind(uchar_t osabi, Half mach, uchar_t bind,
    Conv_fmt_flags_t fmt_flags, Conv_inv_buf_t *inv_buf)
{
	return (conv_map_ds(osabi, mach, bind,
	    conv_sym_info_bind_strings(fmt_flags), fmt_flags, inv_buf));
}

conv_iter_ret_t
conv_iter_sym_info_bind(conv_iter_osabi_t osabi, Half mach,
