    ...
    Conv_inv_buf_t *inv_buf)
{
	static const Msg	sysnumarr[] = {
		...
		MSG_SYS_5,			MSG_SYS_CLOSE,
		MSG_SYS_LINKAT,			MSG_SYS_8,
		MSG_SYS_9,			MSG_SYS_10,
		MSG_SYS_SYMLINKAT,		MSG_SYS_CHDIR,
		MSG_SYS_TIME,			MSG_SYS_14,
		MSG_SYS_15,			MSG_SYS_16,
		MSG_SYS_BRK,			MSG_SYS_18,
		MSG_SYS_LSEEK,			MSG_SYS_GETPID,
		MSG_SYS_MOUNT,			MSG_SYS_READLINKAT,
		MSG_SYS_SETUID,			MSG_SYS_GETUID,
		MSG_SYS_STIME,			MSG_SYS_PCSAMPLE,
		MSG_SYS_ALARM,			MSG_SYS_28,
		MSG_SYS_PAUSE,			MSG_SYS_30,
		MSG_SYS_STTY,			MSG_SYS_GTTY,
		MSG_SYS_33,			MSG_SYS_NICE,
		...
		MSG_SYS_GETGID,			MSG_SYS_MKNODAT,
		...
		MSG_SYS_GETRLIMIT,		MSG_SYS_130,
		MSG_SYS_MEMCNTL,		MSG_SYS_GETPMSG,
		MSG_SYS_PUTPMSG,		MSG_SYS_134,
...
#define	SYSSET_FLAGSZ	CONV_EXPN_FIELD_DEF_PREFIX_SIZE + \
	...
	MSG_SYS_5_SIZE				/* 5 (unused) */ + \
	MSG_SYS_CLOSE_ALT_SIZE			/* 6 */ + \
	MSG_SYS_LINKAT_ALT_SIZE			/* 7 */ + \
	MSG_SYS_8_SIZE				/* 8 (unused) */ + \
	MSG_SYS_9_SIZE				/* 9 (unused) */ + \
	MSG_SYS_10_SIZE				/* 10 (unused) */ + \
	MSG_SYS_SYMLINKAT_ALT_SIZE		/* 11 */ + \
	MSG_SYS_CHDIR_ALT_SIZE			/* 12 */ + \
	MSG_SYS_TIME_ALT_SIZE			/* 13 */ + \
	MSG_SYS_14_SIZE				/* 14 (unused) */ + \
	MSG_SYS_15_SIZE				/* 15 (unused) */ + \
	MSG_SYS_16_SIZE				/* 16 (unused) */ + \
	MSG_SYS_BRK_ALT_SIZE			/* 17 */ + \
	MSG_SYS_18_SIZE				/* 18 (unused) */ + \
	MSG_SYS_LSEEK_ALT_SIZE			/* 19 */ + \
	MSG_SYS_GETPID_ALT_SIZE			/* 20 */ + \
	MSG_SYS_MOUNT_ALT_SIZE			/* 21 */ + \
	MSG_SYS_READLINKAT_ALT_SIZE		/* 22 */ + \
	...
	MSG_SYS_UNLINKAT_ALT_SIZE		/* 76 */ + \
	MSG_SYS_LWP_PARK_ALT_SIZE		/* 77 */ + \
	MSG_SYS_SENDFILEV_ALT_SIZE		/* 78 */ + \
	MSG_SYS_79_SIZE				/* 79 (unused) */ + \
	MSG_SYS_80_SIZE				/* 80 (unused) */ + \
	...
	MSG_SYS_88_SIZE				/* 88 (unused) */ + \
	MSG_SYS_89_SIZE				/* 89 (unused) */ + \
	MSG_SYS_90_SIZE				/* 90 (unused) */ + \
	MSG_SYS_SETGROUPS_ALT_SIZE		/* 91 */ + \
	MSG_SYS_GETGROUPS_ALT_SIZE		/* 92 */ + \
	MSG_SYS_93_SIZE				/* 93 (unused) */ + \
	MSG_SYS_94_SIZE				/* 94 (unused) */ + \
	...
	MSG_SYS_FCHMODAT_ALT_SIZE		/* 101 */ + \
	MSG_SYS_MKDIRAT_ALT_SIZE		/* 102 */ + \
	...
	MSG_SYS_UTIMENSAT_ALT_SIZE		/* 110 */ + \
	...
	MSG_SYS_215_SIZE			/* 215 (unused) */ + \
	MSG_SYS_216_SIZE			/* 216 (unused) */ + \
	MSG_SYS_217_SIZE			/* 217 (unused) */ + \
...
#define	N_MASK 16
	...
	static const Val_desc vda0[] = {	/* System Calls [1 - 32] */
		...
		{ 0x00000010,	MSG_SYS_5 },
		{ 0x00000020,	MSG_SYS_CLOSE_ALT },
		{ 0x00000040,	MSG_SYS_LINKAT_ALT },
		{ 0x00000080,	MSG_SYS_8 },
		{ 0x00000100,	MSG_SYS_9 },
		{ 0x00000200,	MSG_SYS_10 },
		{ 0x00000400,	MSG_SYS_SYMLINKAT_ALT },
		{ 0x00000800,	MSG_SYS_CHDIR_ALT },
		{ 0x00001000,	MSG_SYS_TIME_ALT },
		{ 0x00002000,	MSG_SYS_14 },
		{ 0x00004000,	MSG_SYS_15 },
		{ 0x00008000,	MSG_SYS_16 },
		{ 0x00010000,	MSG_SYS_BRK_ALT },
		{ 0x00020000,	MSG_SYS_18 },
		{ 0x00040000,	MSG_SYS_LSEEK_ALT },
		{ 0x00080000,	MSG_SYS_GETPID_ALT },
		{ 0x00100000,	MSG_SYS_MOUNT_ALT },
		{ 0x00200000,	MSG_SYS_READLINKAT_ALT },
	...
	static const Val_desc vda1[] = {	/* System Calls [33 - 64] */
		...
		{ 0x00008000,	MSG_SYS_MKNODAT_ALT },
	...
	static const Val_desc vda2[] = {	/* System Calls [65 - 96] */
		...
		{ 0x00000800,	MSG_SYS_UNLINKAT_ALT },
		{ 0x00001000,	MSG_SYS_LWP_PARK_ALT },
		{ 0x00002000,	MSG_SYS_SENDFILEV_ALT },
		{ 0x00004000,	MSG_SYS_79 },
		{ 0x00008000,	MSG_SYS_80 },
		...
		{ 0x00800000,	MSG_SYS_88 },
		{ 0x01000000,	MSG_SYS_89 },
		{ 0x02000000,	MSG_SYS_90 },
		{ 0x04000000,	MSG_SYS_SETGROUPS_ALT },
		{ 0x08000000,	MSG_SYS_GETGROUPS_ALT },
		{ 0x10000000,	MSG_SYS_93 },
		{ 0x20000000,	MSG_SYS_94 },
	...
	static const Val_desc vda3[] = {	/* System Calls [97 - 128] */
		...
		{ 0x00000010,	MSG_SYS_FCHMODAT_ALT },
		{ 0x00000020,	MSG_SYS_MKDIRAT_ALT },
		...
		{ 0x00002000,	MSG_SYS_UTIMENSAT_ALT },
	...
	static const Val_desc vda6[] = {	/* System Calls [193 - 224] */
		...
		{ 0x00400000,	MSG_SYS_215 },
		{ 0x00800000,	MSG_SYS_216 },
		{ 0x01000000,	MSG_SYS_217 },
