...
#define	MANIFEST_DIFF	gettext("ERROR: Manifest versions don't match\n")
#define	HASH_DIFF	gettext("ERROR: Manifest hash algorithms don't match\n")
#define	HASH_MISSING	gettext("ERROR: %s Manifest hash algorithm missing\n")
#define	CONTENTS_WARN	gettext("WARNING: Checksum failed: %s\n")
#define	USAGE_MSG gettext("Usage:\n"\
	"\tbart create [-n] [-R root] [ -a md5|sha1|sha256|sha384|sha512]\n"\
	"\t\t[-r rules|-]\n"\
	"\tbart create [-n] [-R root] [ -a md5|sha1|sha256|sha384|sha512]\n"\
	"\t\t[-I | -I filelist]\n"\
