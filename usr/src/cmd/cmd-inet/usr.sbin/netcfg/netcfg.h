...
/*
 * header file for netcfg command
 */
 ...
 *
 * NB: If any *new* properties are added, this list has to be in the same
 * order as the pt_types array in netcfg.c.  Also, add the property name and
 * tokens to netcfg_lex.l and netcfg_grammar.y.
 */
#define	PT_UNKNOWN		0
...
#define	PT_LOC_DNS_SORTLIST	28
#define	PT_LOC_DNS_OPTIONS	29
#define	PT_LOC_NIS_CONFIGSRC	30
#define	PT_LOC_NIS_SERVERS	31
#define	PT_LOC_LDAP_CONFIGSRC	32
#define	PT_LOC_LDAP_SERVERS	33
#define	PT_LOC_DEFAULT_DOMAIN	34
#define	PT_LOC_NFSV4_DOMAIN	35
#define	PT_LOC_IPF_CONFIG	36
#define	PT_LOC_IPF_V6_CONFIG	37
#define	PT_LOC_IPNAT_CONFIG	38
#define	PT_LOC_IPPOOL_CONFIG	39
#define	PT_LOC_IKE_CONFIG	40
#define	PT_LOC_IPSECPOL_CONFIG	41
#define	PT_WLAN_BSSIDS		42
#define	PT_WLAN_PRIORITY	43
#define	PT_WLAN_KEYNAME		44
#define	PT_WLAN_KEYSLOT		45
#define	PT_WLAN_SECURITY_MODE	46
