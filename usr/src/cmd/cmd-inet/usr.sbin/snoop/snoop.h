...
extern void interpret_igmp(int, uchar_t *, int, int);
...
extern int interpret_bpdu(int, char *, int, boolean_t);
extern void interpret_lldp(int, uint8_t *, int);
...
extern int add_transient(int, int (*)(int, char *, int));
extern void del_transient(int);
