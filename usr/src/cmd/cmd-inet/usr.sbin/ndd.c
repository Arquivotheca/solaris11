...
static ndd2ipadm_map_t map[] = {
	...
	{ "icmp_max_buf",		"max_buf",	MOD_PROTO_RAWIP, 0, 0 },
	{ "icmp_recv_hiwat",		"recv_buf",	MOD_PROTO_RAWIP, 0, 0 },
	{ "icmp_xmit_hiwat",		"send_buf",	MOD_PROTO_RAWIP, 0, 0 },
	...
	{ "tcp_largest_anon_port",	"largest_anon_port",	MOD_PROTO_TCP,
	    0, 0 },
	{ "tcp_max_buf",		"max_buf",	MOD_PROTO_TCP, 0, 0 },
	{ "tcp_recv_hiwat",		"recv_buf",	MOD_PROTO_TCP, 0, 0 },
	{ "tcp_sack_permitted",		"sack",		MOD_PROTO_TCP, 0, 0 },
	{ "tcp_xmit_hiwat",		"send_buf",	MOD_PROTO_TCP, 0, 0 },
	...
	{ "udp_largest_anon_port",	"largest_anon_port",    MOD_PROTO_UDP,
	    0, 0 },
	{ "udp_max_buf",		"max_buf",	MOD_PROTO_UDP, 0, 0 },
	{ "udp_recv_hiwat",		"recv_buf",	MOD_PROTO_UDP, 0, 0 },
	{ "udp_xmit_hiwat",		"send_buf",	MOD_PROTO_UDP, 0, 0 },
	...
	{ "sctp_largest_anon_port",	"largest_anon_port",	MOD_PROTO_SCTP,
	    0, 0 },
	{ "sctp_max_buf",		"max_buf",	MOD_PROTO_SCTP, 0, 0 },
	{ "sctp_recv_hiwat",		"recv_buf",	MOD_PROTO_SCTP, 0, 0 },
	{ "sctp_xmit_hiwat",		"send_buf",	MOD_PROTO_SCTP, 0, 0 },
 ...
 * IH_LEGACY flag is used by libipadm for special handling. For some
...
do_ipadm_getset(int cmd, char *buf, int buflen)
{
	...
	if ((status = ipadm_open(&iph, IH_LEGACY)) != IPADM_SUCCESS)
		goto fail;
...
/*
 * gldv3_warning() catches the case of /usr/sbin/ndd abuse to administer
 * ethernet/MII props. Note that /usr/sbin/ndd has not been abused
