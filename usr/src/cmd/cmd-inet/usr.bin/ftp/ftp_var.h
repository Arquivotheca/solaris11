...
/*
 * Maximal size of a macro name, including null-terminating character.
 */
#define	MACRO_NAME_SIZE	9

/*
 * Error message printed to the user, when the user-supplied
 * macro name is too long.
 */
#define	LONG_MACRO_NAME	"Macro name is too long"

struct macel {
	char mac_name[MACRO_NAME_SIZE];	/* macro name */
...
extern void cmd_delete(int argc, char *argv[]);
