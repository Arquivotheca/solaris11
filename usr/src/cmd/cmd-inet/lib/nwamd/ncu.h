...
extern boolean_t nwamd_ignore_link(const char *);
...
extern boolean_t nwamd_plumb_interface(nwamd_ncu_t *, sa_family_t);
...
/* iSCSI functions */
extern void nwamd_get_iscsiboot_hwaddr(void);
