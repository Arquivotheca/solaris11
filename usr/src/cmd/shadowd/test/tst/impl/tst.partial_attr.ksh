...
#
# Another variation on migrating just the metadata for a file.  Create a file
# in a directory with some attributes and content, and do an 'ls -l' in the
# directory.  Then turn off shadow migration.  The resulting file should have a
# full set of attributes but no contents.
#
