...
#
# Verifies that items are removed from the pending list as the corresponding
# extended attributes are removed.  Note that we have to disable shadow
# migration while checking the contents - otherwise looking up the FIDs of the
# affected files and directories will update the list itself.
#
