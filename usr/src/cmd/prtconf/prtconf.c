...
#ifdef	__x86
static const char *usage = "%s [ -V | -x | -abcdlpuvPD ] [ <device_path > ]\n";
#else
static const char *usage =
	"%s [ -F | -V | -x | -abcdlpuvPD ][ <device_path > ]\n";
#endif	/* __x86 */
...
#ifdef	DEBUG
static const char *optstring = "abcdDlvVxpPFf:M:dLuC";
#else
static const char *optstring = "abcdDlvVxpPFf:uC";
#endif	/* DEBUG */
