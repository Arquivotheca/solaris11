...
/*
 * Policy: Unless nscd is enabled, the only fallback is files.
 * Policy is controlled by entirely by SMF and nscd.
 */
#define	NSS_DEFCONF_ALIASES	NSS_FILES_ONLY
#define	NSS_DEFCONF_AUTOMOUNT	NSS_FILES_ONLY
#define	NSS_DEFCONF_BOOTPARAMS	NSS_FILES_ONLY
#define	NSS_DEFCONF_ETHERS	NSS_FILES_ONLY
#define	NSS_DEFCONF_GROUP	NSS_FILES_ONLY
#define	NSS_DEFCONF_HOSTS	NSS_FILES_ONLY
#define	NSS_DEFCONF_IPNODES	NSS_FILES_ONLY
#define	NSS_DEFCONF_NETGROUP	NSS_FILES_ONLY
#define	NSS_DEFCONF_NETMASKS	NSS_FILES_ONLY
#define	NSS_DEFCONF_NETWORKS	NSS_FILES_ONLY
#define	NSS_DEFCONF_PASSWD	NSS_FILES_ONLY
#define	NSS_DEFCONF_PRINTERS	"user files"
#define	NSS_DEFCONF_PROJECT	NSS_FILES_ONLY
#define	NSS_DEFCONF_PROTOCOLS	NSS_FILES_ONLY
#define	NSS_DEFCONF_PUBLICKEY	NSS_FILES_ONLY
#define	NSS_DEFCONF_RPC		NSS_FILES_ONLY
#define	NSS_DEFCONF_SERVICES	NSS_FILES_ONLY	/* speeds up byname() */

#define	NSS_DEFCONF_GROUP_COMPAT	NSS_FILES_ONLY
#define	NSS_DEFCONF_PASSWD_COMPAT	NSS_FILES_ONLY

#define	NSS_DEFCONF_ATTRDB	NSS_FILES_ONLY
...
#define	NSS_DEFCONF_TSOL_TP	NSS_FILES_ONLY
#define	NSS_DEFCONF_TSOL_RH	NSS_FILES_ONLY
#define	NSS_DEFCONF_TSOL_ZC	NSS_FILES_ONLY
...
#define	NSS_BUFLEN_EXECATTR	((NSS_BUFLEN_ATTRDB) * 8)
 ...
 *   information (e.g. the YP netid.byname map) and should instead grind
 *   its way through the group map/table/whatever.
 */
