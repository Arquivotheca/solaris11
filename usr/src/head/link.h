...
#ifndef _ASM
/*
 * ld_support(3ext) library calls.  These are not available within a 32-bit
 * large file aware environment, as libelf(3lib) is not large file capable.
 */
...
#endif /* (defined(_LP64) || defined(_LONGLONG_TYPE) */
#endif /* __STDC__ */
#endif /* !defined(_ILP32) && (_FILE_OFFSET_BITS != 32) */
