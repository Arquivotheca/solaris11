...
#define	USERATTR_DIRNAME		USERATTR_FILENAME ".d"
...
#define	USERATTR_ROLE_AUTH_KW		"roleauth"
#define	USERATTR_ROLE_AUTH_USER		"user"
#define	USERATTR_ROLE_AUTH_ROLE		"role"
